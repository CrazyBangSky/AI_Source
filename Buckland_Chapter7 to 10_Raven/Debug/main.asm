; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	D:\code\AI Source\LATEST vc6-vc10\VS2010\Buckland_Chapter7 to 10_Raven\main.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_BSS	ENDS
_DATA	SEGMENT
?g_szApplicationName@@3PADA DD FLAT:$SG139646		; g_szApplicationName
?g_szWindowClassName@@3PADA DD FLAT:$SG139648		; g_szWindowClassName
_DATA	ENDS
CONST	SEGMENT
...
$SG139709 DB	'map', 00H
_pi	DQ	0400921f9f01b866er		; 3.14159
$SG139646 DB	'Raven', 00H
$SG139721 DB	00H
	ORG $+1
$SG139648 DB	'MyWindowClass', 00H
	ORG $+2
$SG139710 DB	'Raven map file (*.map)', 00H
	ORG $+1
$SG139720 DB	'Filename: ', 00H
	ORG $+1
$SG139773 DB	'Error', 00H
	ORG $+2
$SG139774 DB	'Registration Failed!', 00H
	ORG $+3
$SG139777 DB	'Error!', 00H
	ORG $+1
$SG139778 DB	'CreateWindowEx Failed!', 00H
CONST	ENDS
...
; File d:\code\ai source\latest vc6-vc10\vs2010\buckland_chapter7 to 10_raven\main.cpp
_BSS	SEGMENT
...
$T149462 = -224						; size = 4
$T149461 = -220						; size = 4
_hdc$139748 = -216					; size = 4
_ps$139740 = -208					; size = 64
$T139723 = -140						; size = 32
$T139708 = -108						; size = 32
$T139707 = -76						; size = 32
_hdc$139677 = -44					; size = 4
_rect$139675 = -36					; size = 16
...
; 56   :     switch (msg)
	...
	movzx	eax, BYTE PTR $LN50@WindowProc[edx]
	jmp	DWORD PTR $LN57@WindowProc[eax*4]
$LN45@WindowProc:
...
; 69   : 			   GetClientRect(hwnd, &rect);
	...
	mov	esi, esp
	lea	ecx, DWORD PTR _rect$139675[ebp]
	push	ecx
...
; 84   :          HDC hdc = GetDC(hwnd);
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR _hdc$139677[ebp], eax
...
; 88   :                                           cyClient);
	...
	push	ecx
	mov	edx, DWORD PTR _hdc$139677[ebp]
	push	edx
...
; 98   :          g_pRaven = new Raven_Game();
	...
	add	esp, 4
	mov	DWORD PTR $T149462[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T149462[ebp], 0
	je	SHORT $LN43@WindowProc
	mov	ecx, DWORD PTR $T149462[ebp]
...
$LN44@WindowProc:
	...
	mov	DWORD PTR $T149461[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T149461[ebp]
...
; 120  :         switch(wParam)
	...
	cmp	DWORD PTR tv182[ebp], 61		; 0000003dH
	ja	$LN35@WindowProc
	mov	edx, DWORD PTR tv182[ebp]
	movzx	eax, BYTE PTR $LN51@WindowProc[edx]
	jmp	DWORD PTR $LN58@WindowProc[eax*4]
$LN34@WindowProc:
...
; 198  :      switch(wParam)
	...
	cmp	DWORD PTR tv206[ebp], 16		; 00000010H
	ja	$LN3@WindowProc
	mov	eax, DWORD PTR tv206[ebp]
	jmp	DWORD PTR $LN59@WindowProc[eax*4]
$LN20@WindowProc:
...
; 204  :           FileOpenDlg(hwnd, szFileName, szTitleName, "Raven map file (*.map)", "map");
	...
	push	OFFSET $SG139709
	lea	ecx, DWORD PTR $T139707[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 1
	push	OFFSET $SG139710
	lea	ecx, DWORD PTR $T139708[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	BYTE PTR __$EHRec$[ebp+8], 2
	lea	ecx, DWORD PTR $T139707[ebp]
	push	ecx
	lea	edx, DWORD PTR $T139708[ebp]
	push	edx
...
; 343  :          BeginPaint (hwnd, &ps);
	...
	mov	esi, esp
	lea	eax, DWORD PTR _ps$139740[ebp]
	push	eax
	mov	ecx, DWORD PTR _hwnd$[ebp]
	push	ecx
...
; 365  : 			   BitBlt(ps.hdc, 0, 0, cxClient, cyClient, hdcBackBuffer, 0, 0, SRCCOPY); 
	...
	push	0
	push	0
	mov	ecx, DWORD PTR _ps$139740[ebp]
	push	ecx
	call	DWORD PTR __imp__BitBlt@36
	cmp	esi, esp
	call	__RTC_CheckEsp
...
; 367  :          EndPaint (hwnd, &ps);
	...
	mov	esi, esp
	lea	edx, DWORD PTR _ps$139740[ebp]
	push	edx
	mov	eax, DWORD PTR _hwnd$[ebp]
	push	eax
...
; 378  : 			  cxClient = LOWORD(lParam);
	...
	movzx	edx, cx
	mov	DWORD PTR ?cxClient@?1??WindowProc@@YGJPAUHWND__@@IIJ@Z@4HA, edx
...
; 383  : 			  SelectObject(hdcBackBuffer, hOldBitmap);
	...
	mov	esi, esp
	mov	edx, DWORD PTR ?hOldBitmap@?1??WindowProc@@YGJPAUHWND__@@IIJ@Z@4PAUHBITMAP__@@A
	push	edx
	mov	eax, DWORD PTR ?hdcBackBuffer@?1??WindowProc@@YGJPAUHWND__@@IIJ@Z@4PAUHDC__@@A
	push	eax
	call	DWORD PTR __imp__SelectObject@8
...
; 389  :         HDC hdc = GetDC(hwnd);
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR _hdc$139748[ebp], eax
...
; 395  : 											  cyClient);
	...
	mov	ecx, DWORD PTR ?cxClient@?1??WindowProc@@YGJPAUHWND__@@IIJ@Z@4HA
	push	ecx
	mov	edx, DWORD PTR _hdc$139748[ebp]
	push	edx
	call	DWORD PTR __imp__CreateCompatibleBitmap@12
	cmp	esi, esp
	call	__RTC_CheckEsp
...
; 397  : 			  ReleaseDC(hwnd, hdc);
	...
	mov	esi, esp
	mov	eax, DWORD PTR _hdc$139748[ebp]
	push	eax
	mov	ecx, DWORD PTR _hwnd$[ebp]
	push	ecx
	call	DWORD PTR __imp__ReleaseDC@8
...
; 400  :         SelectObject(hdcBackBuffer, hBitmap);
	...
	mov	esi, esp
	mov	edx, DWORD PTR ?hBitmap@?1??WindowProc@@YGJPAUHWND__@@IIJ@Z@4PAUHBITMAP__@@A
	push	edx
	mov	eax, DWORD PTR ?hdcBackBuffer@?1??WindowProc@@YGJPAUHWND__@@IIJ@Z@4PAUHDC__@@A
	push	eax
	call	DWORD PTR __imp__SelectObject@8
...
; 427  : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN56@WindowProc
...
EXTRN	__time64:PROC
; Function compile flags: /Odtp /RTCsu
; File d:\program files (x86)\vs2010\vc\include\time.inl
_TEXT	SEGMENT
__Time$ = 8						; size = 4
_time	PROC
...
PUBLIC	??_C@_1HI@HHFPIHAO@?$AAD?$AA?3?$AA?2?$AAc?$AAo?$AAd?$AAe?$AA?2?$AAA?$AAI?$AA?5?$AAS?$AAo?$AAu?$AAr?$AAc?$AAe?$AA?2?$AAL?$AAA?$AAT?$AAE?$AAS?$AAT?$AA?5?$AAv?$AAc?$AA6?$AA?9?$AAv?$AAc?$AA1@ ; `string'
...
??_C@_1BM@MMNOPHKK@?$AAm?$AA_?$AAh?$AAd?$AAc?$AA?5?$AA?$DN?$AA?$DN?$AA?5?$AAN?$AAU?$AAL?$AAL?$AA?$AA@ DB 'm'
	...
	DB	00H						; `string'
CONST	ENDS
;	COMDAT ??_C@_1HI@HHFPIHAO@?$AAD?$AA?3?$AA?2?$AAc?$AAo?$AAd?$AAe?$AA?2?$AAA?$AAI?$AA?5?$AAS?$AAo?$AAu?$AAr?$AAc?$AAe?$AA?2?$AAL?$AAA?$AAT?$AAE?$AAS?$AAT?$AA?5?$AAv?$AAc?$AA6?$AA?9?$AAv?$AAc?$AA1@
CONST	SEGMENT
??_C@_1HI@HHFPIHAO@?$AAD?$AA?3?$AA?2?$AAc?$AAo?$AAd?$AAe?$AA?2?$AAA?$AAI?$AA?5?$AAS?$AAo?$AAu?$AAr?$AAc?$AAe?$AA?2?$AAL?$AAA?$AAT?$AAE?$AAS?$AAT?$AA?5?$AAv?$AAc?$AA6?$AA?9?$AAv?$AAc?$AA1@ DB 'D'
...
; 177  :     assert(m_hdc == NULL);
	...
	push	177					; 000000b1H
	push	OFFSET ??_C@_1HI@HHFPIHAO@?$AAD?$AA?3?$AA?2?$AAc?$AAo?$AAd?$AAe?$AA?2?$AAA?$AAI?$AA?5?$AAS?$AAo?$AAu?$AAr?$AAc?$AAe?$AA?2?$AAL?$AAA?$AAT?$AAE?$AAS?$AAT?$AA?5?$AAv?$AAc?$AA6?$AA?9?$AAv?$AAc?$AA1@
...
$T149507 = -280						; size = 4
$T139791 = -276						; size = 32
_err$139790 = -240					; size = 4
_bDone$139780 = -229					; size = 1
_timer$139779 = -224					; size = 104
...
; 463  : 		MessageBox(NULL, "Registration Failed!", "Error", 0);
	...
	mov	esi, esp
	push	0
	push	OFFSET $SG139773
	push	OFFSET $SG139774
	push	0
...
; 498  :     PrecisionTimer timer(FrameRate);
	...
	sub	esp, 8
	fld	QWORD PTR __real@404e000000000000
	fstp	QWORD PTR [esp]
	lea	ecx, DWORD PTR _timer$139779[ebp]
...
; 504  :     bool bDone = false;
	...
	mov	BYTE PTR _bDone$139780[ebp], 0
$LN7@WinMain:

; 505  : 
; 506  :     while(!bDone)

	movzx	ecx, BYTE PTR _bDone$139780[ebp]
	test	ecx, ecx
	jne	$LN6@WinMain
$LN5@WinMain:
...
; 513  : 	        bDone = true;
	...
	mov	BYTE PTR _bDone$139780[ebp], 1
...
; 540  :     ErrorBox(std::string(err.what()));
	...
	mov	esi, esp
	mov	ecx, DWORD PTR _err$139790[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	ecx, DWORD PTR _err$139790[ebp]
...
; 542  :     delete g_pRaven;
	...
	mov	DWORD PTR $T149508[ebp], eax
	mov	ecx, DWORD PTR $T149508[ebp]
	mov	DWORD PTR $T149507[ebp], ecx
	cmp	DWORD PTR $T149507[ebp], 0
...
; 549  :  delete g_pRaven;
	...
	mov	eax, DWORD PTR ?g_pRaven@@3PAVRaven_Game@@A ; g_pRaven
	mov	DWORD PTR $T149513[ebp], eax
	mov	ecx, DWORD PTR $T149513[ebp]
	mov	DWORD PTR $T149512[ebp], ecx
	cmp	DWORD PTR $T149512[ebp], 0
...
; 551  : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN30@WinMain
	call	@_RTC_CheckStackVars@8
	pop	eax
	pop	edx
...
PUBLIC	??_C@_1IM@FIGPOBAG@?$AAD?$AA?3?$AA?2?$AAc?$AAo?$AAd?$AAe?$AA?2?$AAA?$AAI?$AA?5?$AAS?$AAo?$AAu?$AAr?$AAc?$AAe?$AA?2?$AAL?$AAA?$AAT?$AAE?$AAS?$AAT?$AA?5?$AAv?$AAc?$AA6?$AA?9?$AAv?$AAc?$AA1@ ; `string'
...
; File d:\code\ai source\latest vc6-vc10\vs2010\common\time\precisiontimer.h
CONST	SEGMENT
...
CONST	ENDS
;	COMDAT ??_C@_1IM@FIGPOBAG@?$AAD?$AA?3?$AA?2?$AAc?$AAo?$AAd?$AAe?$AA?2?$AAA?$AAI?$AA?5?$AAS?$AAo?$AAu?$AAr?$AAc?$AAe?$AA?2?$AAL?$AAA?$AAT?$AAE?$AAS?$AAT?$AA?5?$AAv?$AAc?$AA6?$AA?9?$AAv?$AAc?$AA1@
CONST	SEGMENT
??_C@_1IM@FIGPOBAG@?$AAD?$AA?3?$AA?2?$AAc?$AAo?$AAd?$AAe?$AA?2?$AAA?$AAI?$AA?5?$AAS?$AAo?$AAu?$AAr?$AAc?$AAe?$AA?2?$AAL?$AAA?$AAT?$AAE?$AAS?$AAT?$AA?5?$AAv?$AAc?$AA6?$AA?9?$AAv?$AAc?$AA1@ DB 'D'
	DB	00H, ':', 00H, '\', 00H, 'c', 00H, 'o', 00H, 'd', 00H, 'e', 00H
	DB	'\', 00H, 'A', 00H, 'I', 00H, ' ', 00H, 'S', 00H, 'o', 00H, 'u'
	DB	00H, 'r', 00H, 'c', 00H, 'e', 00H, '\', 00H, 'L', 00H, 'A', 00H
	DB	'T', 00H, 'E', 00H, 'S', 00H, 'T', 00H, ' ', 00H, 'v', 00H, 'c'
...
$LN4@ReadyForNe:
	push	90					; 0000005aH
	push	OFFSET ??_C@_1IM@FIGPOBAG@?$AAD?$AA?3?$AA?2?$AAc?$AAo?$AAd?$AAe?$AA?2?$AAA?$AAI?$AA?5?$AAS?$AAo?$AAu?$AAr?$AAc?$AAe?$AA?2?$AAL?$AAA?$AAT?$AAE?$AAS?$AAT?$AA?5?$AAv?$AAc?$AA6?$AA?9?$AAv?$AAc?$AA1@
...
; 97   :     m_TimeElapsed = (m_CurrentTime - m_LastTime) * m_TimeScale;
	...
	fild	QWORD PTR tv148[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	fmul	QWORD PTR [ecx+72]
	mov	edx, DWORD PTR _this$[ebp]
...
; Function compile flags: /Odtp /RTCsu
; File d:\code\ai source\latest vc6-vc10\vs2010\common\misc\windowutils.h
...
; 1993 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR __Ptr$141610[ebp], eax
...
; 1995 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$141610[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1996 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$141610[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
_TEXT	SEGMENT
__Pnext$99726 = -20					; size = 4
__Lock$99725 = -12					; size = 4
_this$ = -4						; size = 4
...
; 198  : 		_Lockit _Lock(_LOCK_DEBUG);
	...
	push	3
	lea	ecx, DWORD PTR __Lock$99725[ebp]
...
; 200  : 		for (_Iterator_base12 **_Pnext = &_Myproxy->_Myfirstiter;
	...
	mov	edx, DWORD PTR [ecx]
	add	edx, 4
	mov	DWORD PTR __Pnext$99726[ebp], edx

; 201  : 			*_Pnext != 0; *_Pnext = (*_Pnext)->_Mynextiter)

	jmp	SHORT $LN3@Orphan_all
$LN2@Orphan_all:
	mov	eax, DWORD PTR __Pnext$99726[ebp]
	mov	ecx, DWORD PTR [eax]
	mov	edx, DWORD PTR __Pnext$99726[ebp]
	mov	eax, DWORD PTR [ecx+4]
	mov	DWORD PTR [edx], eax
$LN3@Orphan_all:
	mov	ecx, DWORD PTR __Pnext$99726[ebp]
	cmp	DWORD PTR [ecx], 0
...
; 1954 : 		_Traits::assign(_Myptr()[this->_Mysize = _Newsize], _Elem());
	...
	mov	BYTE PTR $T149622[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+20], ecx
	lea	edx, DWORD PTR $T149622[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Myptr@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEPADXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Myptr
...
; 1118 : 			size_type _Newsize = this->_Mysize - _Count;
	...
	mov	DWORD PTR __Newsize$141589[ebp], eax

; 1119 : 			_Eos(_Newsize);

	mov	ecx, DWORD PTR __Newsize$141589[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase:
...
; File d:\code\ai source\latest vc6-vc10\vs2010\common\debug\debugconsole.h
CONST	SEGMENT
...
; 173  :     return *this;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T149693[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _ss$[ebp]
	call	??_D?$basic_ostringstream@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXXZ
	mov	eax, DWORD PTR $T149693[ebp]
$LN7@operator:
...
; 784  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T149719[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv285[ebp], eax
	mov	edx, DWORD PTR tv285[ebp]
	mov	DWORD PTR $T149720[ebp], edx
	lea	eax, DWORD PTR $T149719[ebp]
	push	eax
	lea	ecx, DWORD PTR $T149720[ebp]
	push	ecx
...
; 797  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T149721[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv292[ebp], eax
	mov	edx, DWORD PTR tv292[ebp]
	mov	DWORD PTR $T149722[ebp], edx
	lea	eax, DWORD PTR $T149721[ebp]
	push	eax
	lea	ecx, DWORD PTR $T149722[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
...
; 807  : 	return (_Ostr);
	...
	mov	eax, DWORD PTR __Ostr$[ebp]
	mov	DWORD PTR $T149723[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+12], -1
	lea	ecx, DWORD PTR __Ok$[ebp]
	call	??1sentry@?$basic_ostream@DU?$char_traits@D@std@@@std@@QAE@XZ ; std::basic_ostream<char,std::char_traits<char> >::sentry::~sentry
	mov	eax, DWORD PTR $T149723[ebp]
...
; 319  : 			_THROW_NCEE(failure, "ios_base::failbit set");
	...
	push	1
	lea	edx, DWORD PTR $T149771[ebp]
	push	edx
	call	?make_error_code@std@@YA?AVerror_code@1@W4io_errc@31@@Z ; std::make_error_code
	add	esp, 8
	push	eax
	push	OFFSET ??_C@_0BG@FMKFHCIL@ios_base?3?3failbit?5set?$AA@
	lea	ecx, DWORD PTR $T149770[ebp]
	call	??0failure@ios_base@std@@QAE@PBDABVerror_code@2@@Z ; std::ios_base::failure::failure
	push	OFFSET __TI4?AVfailure@ios_base@std@@
	lea	eax, DWORD PTR $T149770[ebp]
	push	eax
	call	__CxxThrowException@8
...
; 321  : 			_THROW_NCEE(failure, "ios_base::eofbit set");
	...
	push	1
	lea	ecx, DWORD PTR $T149773[ebp]
	push	ecx
	call	?make_error_code@std@@YA?AVerror_code@1@W4io_errc@31@@Z ; std::make_error_code
	add	esp, 8
	push	eax
	push	OFFSET ??_C@_0BF@OOHOMBOF@ios_base?3?3eofbit?5set?$AA@
	lea	ecx, DWORD PTR $T149772[ebp]
	call	??0failure@ios_base@std@@QAE@PBDABVerror_code@2@@Z ; std::ios_base::failure::failure
	push	OFFSET __TI4?AVfailure@ios_base@std@@
	lea	edx, DWORD PTR $T149772[ebp]
	push	edx
	call	__CxxThrowException@8
$LN10@clear@2:
...
$LN5@sputc:
	...
	mov	DWORD PTR $T149821[ebp], eax
	mov	eax, DWORD PTR $T149821[ebp]
	mov	cl, BYTE PTR __Ch$[ebp]
	mov	BYTE PTR [eax], cl
	mov	edx, DWORD PTR $T149821[ebp]
	push	edx
...
; 166  :     if (ss.str() == ""){flush(); return *this;}
	...
	call	??$?8DU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA_NABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@PBD@Z ; std::operator==<char,std::char_traits<char>,std::allocator<char> >
	add	esp, 8
	mov	BYTE PTR $T149885[ebp], al
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T144609[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	movzx	ecx, BYTE PTR $T149885[ebp]
	test	ecx, ecx
	je	SHORT $LN3@operator@3
	call	?flush@DebugConsole@@SAXXZ		; DebugConsole::flush
	mov	edx, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T149886[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _ss$[ebp]
	call	??_D?$basic_ostringstream@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXXZ
	mov	eax, DWORD PTR $T149886[ebp]
	jmp	$LN7@operator@3
$LN3@operator@3:
...
; 173  :     return *this;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T149887[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _ss$[ebp]
	call	??_D?$basic_ostringstream@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXXZ
	mov	eax, DWORD PTR $T149887[ebp]
$LN7@operator@3:
...
; 174  :   }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN16@operator@3
	call	@_RTC_CheckStackVars@8
	pop	eax
	pop	edx
	mov	ecx, DWORD PTR __$EHRec$[ebp]
...
; 166  :     if (ss.str() == ""){flush(); return *this;}
	...
	call	??$?8DU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA_NABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@PBD@Z ; std::operator==<char,std::char_traits<char>,std::allocator<char> >
	add	esp, 8
	mov	BYTE PTR $T149904[ebp], al
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T144624[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	movzx	ecx, BYTE PTR $T149904[ebp]
	test	ecx, ecx
	je	SHORT $LN3@operator@4
	call	?flush@DebugConsole@@SAXXZ		; DebugConsole::flush
	mov	edx, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T149905[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _ss$[ebp]
	call	??_D?$basic_ostringstream@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXXZ
	mov	eax, DWORD PTR $T149905[ebp]
	jmp	$LN7@operator@4
$LN3@operator@4:
...
; 173  :     return *this;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T149906[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _ss$[ebp]
	call	??_D?$basic_ostringstream@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXXZ
	mov	eax, DWORD PTR $T149906[ebp]
$LN7@operator@4:
...
; 174  :   }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN16@operator@4
	call	@_RTC_CheckStackVars@8
	pop	eax
	pop	edx
	mov	ecx, DWORD PTR __$EHRec$[ebp]
...
; 634  : 			size_type _Idx = _STD addressof(_Val) - this->_Myfirst;
	...
	sar	eax, 5
	mov	DWORD PTR __Idx$145749[ebp], eax
...
; 640  : 				_STD forward<_Ty>(this->_Myfirst[_Idx]));
	...
	mov	eax, DWORD PTR __Idx$145749[ebp]
	shl	eax, 5
	mov	ecx, DWORD PTR _this$[ebp]
	add	eax, DWORD PTR [ecx+4]
	push	eax
...
; 967  : 		return (*(end() - 1));
	...
	push	1
	lea	eax, DWORD PTR $T149988[ebp]
	push	eax
	lea	ecx, DWORD PTR $T149987[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	...
	call	??G?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QBE?AV01@H@Z ; std::_Vector_iterator<std::_Vector_val<std::basic_string<char,std::char_traits<char>,std::allocator<char> >,std::allocator<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > > >::operator-
	mov	DWORD PTR tv82[ebp], eax
	mov	eax, DWORD PTR tv82[ebp]
	...
	mov	DWORD PTR $T149986[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T149988[ebp]
...
; 176  : 			_Iterator_base12 **_Pnext = &_Myproxy->_Myfirstiter;
	...
	mov	edx, DWORD PTR [ecx]
	add	edx, 4
	mov	DWORD PTR __Pnext$99714[ebp], edx
$LN3@Orphan_me:

; 177  : 			while (*_Pnext != 0 && *_Pnext != this)

	mov	eax, DWORD PTR __Pnext$99714[ebp]
	cmp	DWORD PTR [eax], 0
	je	SHORT $LN2@Orphan_me
	mov	ecx, DWORD PTR __Pnext$99714[ebp]
	mov	edx, DWORD PTR [ecx]
...
; 178  : 				_Pnext = &(*_Pnext)->_Mynextiter;
	...
	mov	ecx, DWORD PTR [eax]
	add	ecx, 4
	mov	DWORD PTR __Pnext$99714[ebp], ecx
...
; 180  : 			if (*_Pnext == 0)
	...
	mov	edx, DWORD PTR __Pnext$99714[ebp]
	cmp	DWORD PTR [edx], 0
...
; 792  : 		return (iterator(this->_Mylast, this));
	...
	mov	eax, DWORD PTR $T150023[ebp]
	or	eax, 1
	mov	DWORD PTR $T150023[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
_TEXT	SEGMENT
__Lock$99704 = -28					; size = 4
__Parent_proxy$99702 = -20				; size = 4
_this$ = -16						; size = 4
__$EHRec$ = -12						; size = 12
__Parent$ = 8						; size = 4
...
; 139  : 			_Container_proxy *_Parent_proxy = _Parent->_Myproxy;
	...
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR __Parent_proxy$99702[ebp], ecx
...
; 142  : 			if (_Myproxy != _Parent_proxy)
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx]
	cmp	eax, DWORD PTR __Parent_proxy$99702[ebp]
	je	SHORT $LN3@Adopt
...
; 144  : 				_Lockit _Lock(_LOCK_DEBUG);
	...
	push	3
	lea	ecx, DWORD PTR __Lock$99704[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 146  : 				_Mynextiter = _Parent_proxy->_Myfirstiter;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR __Parent_proxy$99702[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR [ecx+4], eax

; 147  : 				_Parent_proxy->_Myfirstiter = this;

	mov	ecx, DWORD PTR __Parent_proxy$99702[ebp]
	mov	edx, DWORD PTR _this$[ebp]
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	add	esp, 8
	mov	DWORD PTR $T150057[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T150057[ebp], 0
	...
	mov	edx, DWORD PTR [eax]
	mov	eax, DWORD PTR [eax+4]
	mov	ecx, DWORD PTR $T150057[ebp]
	mov	DWORD PTR [ecx], edx
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR $T150057[ebp]
...
; File d:\program files (x86)\vs2010\vc\include\sstream
rdata$r	SEGMENT
...
; 537  : 		{	// construct empty writable character buffer
	...
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	mov	ecx, DWORD PTR $T150075[ebp]
	or	ecx, 1
	mov	DWORD PTR $T150075[ebp], ecx
$LN1@basic_ostr:
	push	0
	push	0
	mov	edx, DWORD PTR _this$[ebp]
...
__unwindfunclet$??0?$basic_ostringstream@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@H@Z$0:
	mov	eax, DWORD PTR $T150075[ebp]
	and	eax, 1
	je	$LN5@basic_ostr
	and	DWORD PTR $T150075[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 80					; 00000050H
...
; 593  : 		return (_Stringbuffer.str());
	...
	mov	ecx, DWORD PTR $T150105[ebp]
	or	ecx, 1
	mov	DWORD PTR $T150105[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 359  : 			? _Traits::eof() : _Traits::to_int_type(*_Gninc()));
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR $T150139[ebp], eax
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T150140[ebp], eax
	lea	ecx, DWORD PTR $T150139[ebp]
	push	ecx
	lea	edx, DWORD PTR $T150140[ebp]
	push	edx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	eax, al
...
; 379  : 			else if (_Traits::eq_int_type(_Traits::eof(), _Meta = uflow()))
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T150145[ebp], eax
	lea	ecx, DWORD PTR __Meta$[ebp]
	push	ecx
	lea	edx, DWORD PTR $T150145[ebp]
	push	edx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	eax, al
...
; 408  : 				overflow(_Traits::to_int_type(*_Ptr))))
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR $T150156[ebp], eax
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T150157[ebp], eax
	lea	ecx, DWORD PTR $T150156[ebp]
	push	ecx
	lea	edx, DWORD PTR $T150157[ebp]
	push	edx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	eax, al
...
; 120  : 			_BEGIN_LOCK(_LOCK_LOCALE)
	...
	push	0
	lea	ecx, DWORD PTR __Lock$104593[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
...
; 123  : 				return (_Refs == 0 ? this : 0);
	...
	mov	DWORD PTR $T150197[ebp], eax
	lea	ecx, DWORD PTR __Lock$104593[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T150197[ebp]
...
tv195 = -32						; size = 4
$T150206 = -28						; size = 4
__Oldptr$145894 = -24					; size = 4
__Newptr$145893 = -20					; size = 4
__Inc$145888 = -16					; size = 4
__Newsize$145887 = -12					; size = 4
__Oldsize$145886 = -8					; size = 4
_this$ = -4						; size = 4
__Meta$ = 8						; size = 4
...
; 125  : 		if (_Traits::eq_int_type(_Traits::eof(), _Meta))
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T150206[ebp], eax
	lea	edx, DWORD PTR __Meta$[ebp]
	push	edx
	lea	eax, DWORD PTR $T150206[ebp]
	push	eax
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	ecx, al
...
$LN22@overflow:
	...
	mov	DWORD PTR __Oldsize$145886[ebp], eax

; 139  : 			size_t _Newsize = _Oldsize;

	mov	ecx, DWORD PTR __Oldsize$145886[ebp]
	mov	DWORD PTR __Newsize$145887[ebp], ecx

; 140  : 			size_t _Inc = _Newsize / 2 < _MINSIZE
; 141  : 				? _MINSIZE : _Newsize / 2;	// grow by 50 per cent

	mov	edx, DWORD PTR __Newsize$145887[ebp]
	shr	edx, 1
...
$LN23@overflow:
	mov	eax, DWORD PTR __Newsize$145887[ebp]
	shr	eax, 1
	mov	DWORD PTR tv199[ebp], eax
$LN24@overflow:
	mov	ecx, DWORD PTR tv199[ebp]
	mov	DWORD PTR __Inc$145888[ebp], ecx
$LN11@overflow:

; 142  : 
; 143  : 			while (0 < _Inc && INT_MAX - _Inc < _Newsize)

	cmp	DWORD PTR __Inc$145888[ebp], 0
	jbe	SHORT $LN10@overflow
	mov	edx, 2147483647				; 7fffffffH
	sub	edx, DWORD PTR __Inc$145888[ebp]
	cmp	edx, DWORD PTR __Newsize$145887[ebp]
	jae	SHORT $LN10@overflow

; 144  : 				_Inc /= 2;	// increment causes overflow, halve it

	mov	eax, DWORD PTR __Inc$145888[ebp]
	shr	eax, 1
	mov	DWORD PTR __Inc$145888[ebp], eax
...
; 148  : 			_Newsize += _Inc;
	...
	mov	ecx, DWORD PTR __Newsize$145887[ebp]
	add	ecx, DWORD PTR __Inc$145888[ebp]
	mov	DWORD PTR __Newsize$145887[ebp], ecx
...
; 150  : 			_Elem *_Newptr = _Al.allocate(_Newsize);
	...
	call	?allocate@?$allocator@D@std@@QAEPADI@Z	; std::allocator<char>::allocate
	mov	DWORD PTR __Newptr$145893[ebp], eax

; 151  : 			_Elem *_Oldptr = _Mysb::eback();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?eback@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IBEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::eback
	mov	DWORD PTR __Oldptr$145894[ebp], eax

; 152  : 
; 153  : 			if (0 < _Oldsize)

	cmp	DWORD PTR __Oldsize$145886[ebp], 0
	jbe	SHORT $LN8@overflow

; 154  : 				_Traits::copy(_Newptr, _Oldptr, _Oldsize);

	mov	eax, DWORD PTR __Oldsize$145886[ebp]
	push	eax
	mov	ecx, DWORD PTR __Oldptr$145894[ebp]
	push	ecx
	mov	edx, DWORD PTR __Newptr$145893[ebp]
	push	edx
	call	?copy@?$char_traits@D@std@@SAPADPADPBDI@Z ; std::char_traits<char>::copy
	add	esp, 12					; 0000000cH
$LN8@overflow:
...
; 158  : 				_Seekhigh = _Newptr;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newptr$145893[ebp]
	mov	DWORD PTR [eax+60], ecx

; 159  : 				_Mysb::setp(_Newptr, _Newptr + _Newsize);

	mov	edx, DWORD PTR __Newptr$145893[ebp]
	add	edx, DWORD PTR __Newsize$145887[ebp]
	push	edx
	mov	eax, DWORD PTR __Newptr$145893[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 167  : 				_Seekhigh = _Newptr + (_Seekhigh - _Oldptr);
	...
	sub	eax, DWORD PTR __Oldptr$145894[ebp]
	add	eax, DWORD PTR __Newptr$145893[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
...
; 180  : 				_Al.deallocate(_Oldptr, _Oldsize);
	...
	mov	ecx, DWORD PTR __Oldsize$145886[ebp]
	push	ecx
	mov	edx, DWORD PTR __Oldptr$145894[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 68					; 00000044H
	call	?deallocate@?$allocator@D@std@@QAEXPADI@Z ; std::allocator<char>::deallocate
...
; 194  : 			&& _Mystate & _Constant)
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T150225[ebp], eax
	lea	eax, DWORD PTR __Meta$[ebp]
	push	eax
	lea	ecx, DWORD PTR $T150225[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	edx, al
	...
	call	?to_char_type@?$char_traits@D@std@@SADABH@Z ; std::char_traits<char>::to_char_type
	add	esp, 4
	mov	BYTE PTR $T150226[ebp], al
	mov	ecx, DWORD PTR _this$[ebp]
	call	?gptr@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IBEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::gptr
	sub	eax, 1
	push	eax
	lea	ecx, DWORD PTR $T150226[ebp]
	push	ecx
...
; 199  : 			if (!_Traits::eq_int_type(_Traits::eof(), _Meta))
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T150227[ebp], eax
	lea	edx, DWORD PTR __Meta$[ebp]
	push	edx
	lea	eax, DWORD PTR $T150227[ebp]
	push	eax
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	ecx, al
...
; 46   : 	explicit __CLR_OR_THIS_CALL basic_ostream(
	...
	call	??0?$basic_ios@DU?$char_traits@D@std@@@std@@IAE@XZ ; std::basic_ios<char,std::char_traits<char> >::basic_ios<char,std::char_traits<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	mov	ecx, DWORD PTR $T150254[ebp]
	or	ecx, 1
	mov	DWORD PTR $T150254[ebp], ecx
$LN1@basic_ostr@2:
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx]
...
__unwindfunclet$??0?$basic_ostream@DU?$char_traits@D@std@@@std@@QAE@PAV?$basic_streambuf@DU?$char_traits@D@std@@@1@_N@Z$0:
	mov	eax, DWORD PTR $T150254[ebp]
	and	eax, 1
	je	$LN5@basic_ostr@2
	and	DWORD PTR $T150254[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 8
	jmp	??1?$basic_ios@DU?$char_traits@D@std@@@std@@UAE@XZ ; std::basic_ios<char,std::char_traits<char> >::~basic_ios<char,std::char_traits<char> >
$LN5@basic_ostr@2:
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__unwindtable$??G?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QBE?AV01@H@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$??G?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QBE?AV01@H@Z$1
	DD	00H
	DD	FLAT:__unwindfunclet$??G?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QBE?AV01@H@Z$0
__ehfuncinfo$??G?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QBE?AV01@H@Z DD 019930522H
	DD	02H
	DD	FLAT:__unwindtable$??G?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QBE?AV01@H@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
; Function compile flags: /Odtp /RTCsu
xdata$x	ENDS
;	COMDAT ??G?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QBE?AV01@H@Z
_TEXT	SEGMENT
$T150284 = -40						; size = 4
__Tmp$ = -32						; size = 12
_this$ = -16						; size = 4
...
; 374  : 		{	// return this - integer
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$??G?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QBE?AV01@H@Z
	mov	eax, DWORD PTR fs:0
	push	eax
	sub	esp, 28					; 0000001cH
	mov	eax, -858993460				; ccccccccH
...
; 376  : 		return (_Tmp -= _Off);
	...
	push	ecx
	lea	ecx, DWORD PTR __Tmp$[ebp]
	call	??Z?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAEAAV01@H@Z ; std::_Vector_iterator<std::_Vector_val<std::basic_string<char,std::char_traits<char>,std::allocator<char> >,std::allocator<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > > >::operator-=
	push	eax
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@ABV01@@Z
	mov	edx, DWORD PTR $T150284[ebp]
	or	edx, 1
	mov	DWORD PTR $T150284[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Tmp$[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$??G?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QBE?AV01@H@Z$0:
	lea	ecx, DWORD PTR __Tmp$[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@XZ
__unwindfunclet$??G?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QBE?AV01@H@Z$1:
	mov	eax, DWORD PTR $T150284[ebp]
	and	eax, 1
	je	$LN5@operator@5
	and	DWORD PTR $T150284[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@XZ
$LN5@operator@5:
	ret	0
__ehhandler$??G?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QBE?AV01@H@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-32]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$??G?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QBE?AV01@H@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
...
tv91 = -148						; size = 4
$T150324 = -144						; size = 4
__Nul$146080 = -136					; size = 32
__Str$146078 = -96					; size = 32
__Str$146075 = -56					; size = 32
_this$ = -20						; size = 4
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
___$ReturnUdt$ = 8					; size = 4
...
$LN8@str:
	...
	call	?pbase@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IBEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::pbase
	push	eax
	lea	ecx, DWORD PTR __Str$146075[ebp]
...
; 98   : 			return (_Str);
	...
	lea	eax, DWORD PTR __Str$146075[ebp]
	push	eax
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	ecx, DWORD PTR $T150324[ebp]
	or	ecx, 1
	mov	DWORD PTR $T150324[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Str$146075[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 102  : 			_Mystr _Str(_Mysb::eback(), _Mysb::egptr() - _Mysb::eback());
	...
	call	?eback@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IBEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::eback
	push	eax
	lea	ecx, DWORD PTR __Str$146078[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBDI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
...
; 103  : 			return (_Str);
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	edx, DWORD PTR $T150324[ebp]
	or	edx, 1
	mov	DWORD PTR $T150324[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Str$146078[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 107  : 			_Mystr _Nul;
	...
	lea	ecx, DWORD PTR __Nul$146080[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 3

; 108  : 			return (_Nul);

	lea	eax, DWORD PTR __Nul$146080[ebp]
	push	eax
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	ecx, DWORD PTR $T150324[ebp]
...
__unwindfunclet$?str@?$basic_stringbuf@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@XZ$1:
	mov	eax, DWORD PTR $T150324[ebp]
	and	eax, 1
	je	$LN11@str
	and	DWORD PTR $T150324[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
$LN11@str:
	ret	0
...
PUBLIC	??_C@_0DC@ONJGAPOJ@D?3?2Program?5Files?5?$CIx86?$CJ?2VS2010?2VC@ ; `string'
...
;	COMDAT ??_C@_0DC@ONJGAPOJ@D?3?2Program?5Files?5?$CIx86?$CJ?2VS2010?2VC@
; File d:\program files (x86)\vs2010\vc\include\xiosbase
CONST	SEGMENT
??_C@_0DC@ONJGAPOJ@D?3?2Program?5Files?5?$CIx86?$CJ?2VS2010?2VC@ DB 'D:\P'
	DB	'rogram Files (x86)\VS2010\VC\include\xiosbase', 00H ; `string'
; Function compile flags: /Odtp /RTCsu
CONST	ENDS
...
; 564  : 		_Ploc = _NEW_CRT locale;
	...
	push	564					; 00000234H
	push	OFFSET ??_C@_0DC@ONJGAPOJ@D?3?2Program?5Files?5?$CIx86?$CJ?2VS2010?2VC@
	...
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T150391[ebp], eax
	cmp	DWORD PTR $T150391[ebp], 0
	je	SHORT $LN3@Init
	mov	ecx, DWORD PTR $T150391[ebp]
...
; 112  : 			_BEGIN_LOCK(_LOCK_LOCALE)
	...
	push	0
	lea	ecx, DWORD PTR __Lock$104588[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
...
PUBLIC	??_C@_0DD@BLKENPAI@D?3?2Program?5Files?5?$CIx86?$CJ?2VS2010?2VC@ ; `string'
EXTRN	??0_Mutex@std@@QAE@XZ:PROC			; std::_Mutex::_Mutex
;	COMDAT ??_C@_0DD@BLKENPAI@D?3?2Program?5Files?5?$CIx86?$CJ?2VS2010?2VC@
; File d:\program files (x86)\vs2010\vc\include\streambuf
CONST	SEGMENT
??_C@_0DD@BLKENPAI@D?3?2Program?5Files?5?$CIx86?$CJ?2VS2010?2VC@ DB 'D:\P'
	DB	'rogram Files (x86)\VS2010\VC\include\streambuf', 00H ; `string'
CONST	ENDS
;	COMDAT xdata$x
xdata$x	SEGMENT
...
; 25   : 		{	// construct with no buffers
	...
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	push	24					; 00000018H
	push	OFFSET ??_C@_0DD@BLKENPAI@D?3?2Program?5Files?5?$CIx86?$CJ?2VS2010?2VC@
	call	?_DebugHeapTag_func@std@@YAABU_DebugHeapTag_t@1@XZ ; std::_DebugHeapTag_func
	push	eax
	push	4
	call	??2@YAPAXIABU_DebugHeapTag_t@std@@PADH@Z ; operator new
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T150406[ebp], eax
	cmp	DWORD PTR $T150406[ebp], 0
	je	SHORT $LN3@basic_stre
	mov	ecx, DWORD PTR $T150406[ebp]
	call	??0locale@std@@QAE@XZ			; std::locale::locale
	mov	DWORD PTR tv79[ebp], eax
...
_TEXT	SEGMENT
__Size$146240 = -28					; size = 4
__Ptr$146233 = -24					; size = 4
_this$ = -20						; size = 4
__$EHRec$ = -16						; size = 16
__Count$ = 8						; size = 4
...
; 751  : 			pointer _Ptr = this->_Alval.allocate(_Count);
	...
	mov	DWORD PTR __Ptr$146233[ebp], eax
...
; 754  : 			_Umove(this->_Myfirst, this->_Mylast, _Ptr);
	...
	mov	ecx, DWORD PTR __Ptr$146233[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+8]
	push	eax
...
; 760  : 			size_type _Size = size();
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?size@?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@QBEIXZ ; std::vector<std::basic_string<char,std::char_traits<char>,std::allocator<char> >,std::allocator<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > >::size
	mov	DWORD PTR __Size$146240[ebp], eax
...
; 769  : 			this->_Myend = _Ptr + _Count;
	...
	mov	eax, DWORD PTR __Count$[ebp]
	shl	eax, 5
	add	eax, DWORD PTR __Ptr$146233[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+12], eax

; 770  : 			this->_Mylast = _Ptr + _Size;

	mov	edx, DWORD PTR __Size$146240[ebp]
	shl	edx, 5
	add	edx, DWORD PTR __Ptr$146233[ebp]
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+8], edx
...
; 771  : 			this->_Myfirst = _Ptr;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR __Ptr$146233[ebp]
	mov	DWORD PTR [ecx+4], edx
$LN7@reserve:
...
; 88   : 	_Destroy_range(_First, _Last, _Al, _Ptr_cat(_First, _Last));
	...
	add	esp, 8
	mov	BYTE PTR $T150437[ebp], al
	movzx	edx, BYTE PTR $T150437[ebp]
	push	edx
...
; Function compile flags: /Odtp /RTCsu
;	COMDAT ??Z?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAEAAV01@H@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
__Off$ = 8						; size = 4
??Z?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAEAAV01@H@Z PROC ; std::_Vector_iterator<std::_Vector_val<std::basic_string<char,std::char_traits<char>,std::allocator<char> >,std::allocator<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > > >::operator-=, COMDAT
; _this$ = ecx
...
; 320  : 			_Elem *_Pnew = _Al.allocate(_Count);
	...
	add	ecx, 68					; 00000044H
	call	?allocate@?$allocator@D@std@@QAEPADI@Z	; std::allocator<char>::allocate
	mov	DWORD PTR __Pnew$146304[ebp], eax
...
; 321  : 			_Traits::copy(_Pnew, _Ptr, _Count);
	...
	mov	ecx, DWORD PTR __Ptr$[ebp]
	push	ecx
	mov	edx, DWORD PTR __Pnew$146304[ebp]
	push	edx
	call	?copy@?$char_traits@D@std@@SAPADPADPBDI@Z ; std::char_traits<char>::copy
	add	esp, 12					; 0000000cH
...
; 322  : 			_Seekhigh = _Pnew + _Count;
	...
	mov	eax, DWORD PTR __Pnew$146304[ebp]
	add	eax, DWORD PTR __Count$[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+60], eax
...
; 326  : 					_Pnew + _Count);	// setup read buffer
	...
	mov	ecx, DWORD PTR __Pnew$146304[ebp]
...
; 452  : 		return (*_Ploc);
	...
	mov	edx, DWORD PTR $T150479[ebp]
	or	edx, 1
	mov	DWORD PTR $T150479[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
$T150486 = -64						; size = 4
$T150485 = -60						; size = 12
__Pfmod$143891 = -48					; size = 4
__Pf$143875 = -44					; size = 4
__Id$143874 = -40					; size = 4
__Psave$143862 = -32					; size = 4
__Lock$143861 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$143861[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$143862[ebp], eax
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$143862[ebp], 0
	je	SHORT $LN4@use_facet

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	edx, DWORD PTR __Psave$143862[ebp]
	mov	DWORD PTR __Pf$143875[ebp], edx
	jmp	SHORT $LN5@use_facet
$LN4@use_facet:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	push	eax
	lea	ecx, DWORD PTR __Psave$143862[ebp]
	push	ecx
...
; 520  : 			_THROW_NCEE(bad_cast, _EMPTY_ARGUMENT);	// lazy disallowed
	...
	lea	ecx, DWORD PTR $T150485[ebp]
	call	??0bad_cast@std@@QAE@PBD@Z		; std::bad_cast::bad_cast
	push	OFFSET __TI2?AVbad_cast@std@@
	lea	edx, DWORD PTR $T150485[ebp]
	push	edx
	call	__CxxThrowException@8
...
; 528  : 			_Pf = _Psave;
	...
	mov	eax, DWORD PTR __Psave$143862[ebp]
	mov	DWORD PTR __Pf$143875[ebp], eax

; 529  : 			_Facetptr<_Facet>::_Psave = _Psave;

	mov	ecx, DWORD PTR __Psave$143862[ebp]
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	edx, DWORD PTR __Psave$143862[ebp]
	mov	DWORD PTR __Pfmod$143891[ebp], edx

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$143891[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$143875[ebp]
	mov	DWORD PTR $T150486[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$143861[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T150486[ebp]
$LN8@use_facet:
...
; 78   : 				_BEGIN_LOCK(_LOCK_LOCALE)
	...
	push	0
	lea	ecx, DWORD PTR __Lock$104582[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
...
; 84   : 			}
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN8@operator@8
	call	@_RTC_CheckStackVars@8
	pop	eax
	pop	edx
	add	esp, 16					; 00000010H
...
$LN5@Getcat:
	...
	mov	DWORD PTR $T150515[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR __Ppf$[ebp]
	mov	ecx, DWORD PTR $T150515[ebp]
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T150522[ebp]
	and	edx, 1
	je	SHORT $LN1@Getcat
	and	DWORD PTR $T150522[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T150518[ebp]
...
; 78   :             _THROW_NCEE(runtime_error, "bad locale name");
	...
	lea	ecx, DWORD PTR $T150534[ebp]
	call	??0runtime_error@std@@QAE@PBD@Z		; std::runtime_error::runtime_error
	push	OFFSET __TI2?AVruntime_error@std@@
	lea	eax, DWORD PTR $T150534[ebp]
	push	eax
	call	__CxxThrowException@8
$LN1@Locinfo:
...
; 118  : 		return (::_Getctype());
	...
	lea	eax, DWORD PTR $T150596[ebp]
	push	eax
	call	__Getctype
	add	esp, 4
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR $T150595[ebp], ecx
	mov	edx, DWORD PTR [eax+4]
	mov	DWORD PTR $T150595[ebp+4], edx
	mov	ecx, DWORD PTR [eax+8]
	mov	DWORD PTR $T150595[ebp+8], ecx
	mov	edx, DWORD PTR [eax+12]
	mov	DWORD PTR $T150595[ebp+12], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	mov	ecx, DWORD PTR $T150595[ebp]
	mov	DWORD PTR [eax], ecx
	mov	edx, DWORD PTR $T150595[ebp+4]
	mov	DWORD PTR [eax+4], edx
	mov	ecx, DWORD PTR $T150595[ebp+8]
	mov	DWORD PTR [eax+8], ecx
	mov	edx, DWORD PTR $T150595[ebp+12]
...
; 2408 : 			delete[] (void *)_Ctype._Table;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+16]
	mov	DWORD PTR $T150626[ebp], edx
	mov	eax, DWORD PTR $T150626[ebp]
	push	eax
...
; Function compile flags: /Odtp /RTCsu
; File d:\program files (x86)\vs2010\vc\include\string
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	call	??2@YAPAXIPAX@Z				; operator new
	add	esp, 8
	mov	DWORD PTR $T150702[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T150702[ebp], 0
