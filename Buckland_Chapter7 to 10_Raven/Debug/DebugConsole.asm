; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	D:\code\AI Source\LATEST vc6-vc10\VS2010\Common\Debug\DebugConsole.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG128103 DB	'DebugLog.txt', 00H
	ORG $+3
$SG128107 DB	'Debug', 00H
	ORG $+2
$SG128109 DB	'Error', 00H
	ORG $+2
$SG128110 DB	'Registration of Debug Console Failed!', 00H
	ORG $+2
$SG128111 DB	'Debug Console', 00H
	ORG $+2
$SG128112 DB	'Debug', 00H
	ORG $+2
$SG128114 DB	'Error!', 00H
	ORG $+1
$SG128115 DB	'CreateWindowEx Failed!', 00H
CONST	ENDS
...
; File d:\code\ai source\latest vc6-vc10\vs2010\common\debug\debugconsole.cpp
_BSS	SEGMENT
...
$T133287 = -289						; size = 1
$T133286 = -288						; size = 12
_line$128074 = -276					; size = 4
_i$128051 = -272					; size = 4
_end$128050 = -264					; size = 12
_beg$128043 = -244					; size = 12
_StartIndex$127899 = -228				; size = 4
_PageSize$127897 = -224					; size = 4
_ps$127889 = -216					; size = 64
_hdc$127864 = -148					; size = 4
_rect$ = -140						; size = 16
_si$ = -116						; size = 28
_tm$ = -80						; size = 56
_iVertPos$ = -20					; size = 4
...
; 48   :       HDC hdc = GetDC(hwnd);
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR _hdc$127864[ebp], eax
...
; 50   :       GetTextMetrics(hdc, &tm);
	...
	push	eax
	mov	ecx, DWORD PTR _hdc$127864[ebp]
	push	ecx
...
; 64   :       ReleaseDC(hwnd, hdc);
	...
	mov	esi, esp
	mov	eax, DWORD PTR _hdc$127864[ebp]
	push	eax
	mov	ecx, DWORD PTR _hwnd$[ebp]
	push	ecx
...
; 96   :       switch (LOWORD (wparam))
	...
	jmp	DWORD PTR $LN57@DebugWindo[eax*4]
$LN25@DebugWindo:
...
; 172  : 		  BeginPaint(hwnd, &ps);
	...
	mov	esi, esp
	lea	edx, DWORD PTR _ps$127889[ebp]
	push	edx
	mov	eax, DWORD PTR _hwnd$[ebp]
	push	eax
...
; 174  :         SetBkMode(ps.hdc, TRANSPARENT);
	...
	mov	esi, esp
	push	1
	mov	ecx, DWORD PTR _ps$127889[ebp]
	push	ecx
...
; 175  :         SetTextColor(ps.hdc, RGB(255,255,255));
	...
	mov	edx, DWORD PTR _ps$127889[ebp]
	push	edx
...
; 187  :           int PageSize = (int)(cyClient / cyChar) - 1;
	...
	idiv	DWORD PTR ?cyChar@?1??DebugWindowProc@DebugConsole@@CGJPAUHWND__@@IIJ@Z@4HA
	sub	eax, 1
	mov	DWORD PTR _PageSize$127897[ebp], eax

; 188  : 
; 189  :           int StartIndex = 0;

	mov	DWORD PTR _StartIndex$127899[ebp], 0

; 190  :       
; 191  :           if (iVertPos > PageSize)

	mov	eax, DWORD PTR _iVertPos$[ebp]
	cmp	eax, DWORD PTR _PageSize$127897[ebp]
...
; 193  :             StartIndex = iVertPos - PageSize;
	...
	mov	ecx, DWORD PTR _iVertPos$[ebp]
	sub	ecx, DWORD PTR _PageSize$127897[ebp]
	mov	DWORD PTR _StartIndex$127899[ebp], ecx
$LN13@DebugWindo:
...
; 196  :           std::vector<std::string>::iterator beg = m_Buffer.begin() + StartIndex;
	...
	mov	edx, DWORD PTR _StartIndex$127899[ebp]
	push	edx
	lea	eax, DWORD PTR _beg$128043[ebp]
	push	eax
	lea	ecx, DWORD PTR $T133286[ebp]
	push	ecx
	mov	ecx, OFFSET ?m_Buffer@DebugConsole@@0V?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@A ; DebugConsole::m_Buffer
...
; 197  : 		  std::vector<std::string>::iterator end = beg;
	...
	lea	eax, DWORD PTR _beg$128043[ebp]
	push	eax
	lea	ecx, DWORD PTR _end$128050[ebp]
...
; 200  : 		  for (int i = 0; i < PageSize + 1; ++i)
	...
	mov	DWORD PTR _i$128051[ebp], 0
	jmp	SHORT $LN12@DebugWindo
$LN11@DebugWindo:
	mov	ecx, DWORD PTR _i$128051[ebp]
	add	ecx, 1
	mov	DWORD PTR _i$128051[ebp], ecx
$LN12@DebugWindo:
	mov	edx, DWORD PTR _PageSize$127897[ebp]
	add	edx, 1
	cmp	DWORD PTR _i$128051[ebp], edx
...
; 203  : 			if (end == m_Buffer.end()) break;
	...
	mov	BYTE PTR $T133287[ebp], al
	mov	BYTE PTR __$EHRec$[ebp+8], 3
	lea	ecx, DWORD PTR $T133288[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@XZ
	movzx	eax, BYTE PTR $T133287[ebp]
	test	eax, eax
...
; 206  :           int line=0;
	...
	mov	DWORD PTR _line$128074[ebp], 0
...
$LN7@DebugWindo:
	lea	ecx, DWORD PTR _beg$128043[ebp]
	call	??E?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAEAAV01@XZ ; std::_Vector_iterator<std::_Vector_val<std::basic_string<char,std::char_traits<char>,std::allocator<char> >,std::allocator<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > > >::operator++
$LN8@DebugWindo:
	lea	ecx, DWORD PTR _end$128050[ebp]
	push	ecx
	...
	mov	edx, DWORD PTR $T133304[ebp]
	or	edx, 1
	mov	DWORD PTR $T133304[ebp], edx
...
$LN39@DebugWindo:
	mov	dl, BYTE PTR tv283[ebp]
	mov	BYTE PTR $T133289[ebp], dl
	mov	DWORD PTR __$EHRec$[ebp+8], 3
	mov	eax, DWORD PTR $T133304[ebp]
	and	eax, 1
	je	SHORT $LN47@DebugWindo
	and	DWORD PTR $T133304[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T133290[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@XZ
$LN47@DebugWindo:
	movzx	ecx, BYTE PTR $T133289[ebp]
	test	ecx, ecx
...
; 210  :             TextOut(ps.hdc, 0, cyChar*line++, (*beg).c_str(), (*beg).size()); 
	...
	mov	edx, DWORD PTR ?cyChar@?1??DebugWindowProc@DebugConsole@@CGJPAUHWND__@@IIJ@Z@4HA
	imul	edx, DWORD PTR _line$128074[ebp]
	mov	DWORD PTR tv300[ebp], edx
	mov	eax, DWORD PTR _line$128074[ebp]
	add	eax, 1
	mov	DWORD PTR _line$128074[ebp], eax
	lea	ecx, DWORD PTR _beg$128043[ebp]
...
; 214  : 			EndPaint(hwnd, &ps);
	...
	mov	esi, esp
	lea	eax, DWORD PTR _ps$127889[ebp]
	push	eax
	mov	ecx, DWORD PTR _hwnd$[ebp]
	push	ecx
...
; 247  : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN56@DebugWindo
...
; 274  : 						           "Debug",
	...
	mov	DWORD PTR _wDebugConsole$[ebp+40], OFFSET $SG128107
...
; 281  :     MessageBox(NULL, "Registration of Debug Console Failed!", "Error", 0);
	...
	mov	esi, esp
	push	0
	push	OFFSET $SG128109
	push	OFFSET $SG128110
	push	0
...
; 303  : 									          NULL );
	...
	push	OFFSET $SG128111
	push	OFFSET $SG128112
	push	0
...
; 308  :     MessageBox(m_hwnd, "CreateWindowEx Failed!", "Error!", 0);
	...
	mov	esi, esp
	push	0
	push	OFFSET $SG128114
	push	OFFSET $SG128115
	mov	eax, DWORD PTR ?m_hwnd@DebugConsole@@0PAUHWND__@@A ; DebugConsole::m_hwnd
	push	eax
	call	DWORD PTR __imp__MessageBoxA@16
	cmp	esi, esp
...
$LN3@WriteAndRe:
	...
	lea	ecx, DWORD PTR _it$[ebp]
	call	??9?$_Vector_const_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QBE_NABV01@@Z ; std::_Vector_const_iterator<std::_Vector_val<std::basic_string<char,std::char_traits<char>,std::allocator<char> >,std::allocator<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > > >::operator!=
	mov	BYTE PTR $T133392[ebp], al
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T133393[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@XZ
	movzx	ecx, BYTE PTR $T133392[ebp]
	test	ecx, ecx
...
; 535  : 				_Myios::rdbuf()->sputc(_Ch)))
	...
	mov	DWORD PTR $T133412[ebp], edx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv153[ebp], eax
	mov	eax, DWORD PTR tv153[ebp]
	mov	DWORD PTR $T133413[ebp], eax
	lea	ecx, DWORD PTR $T133412[ebp]
	push	ecx
	lea	edx, DWORD PTR $T133413[ebp]
	push	edx
...
; 541  : 		return (*this);
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T133414[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+12], -1
	lea	ecx, DWORD PTR __Ok$[ebp]
	call	??1sentry@?$basic_ostream@DU?$char_traits@D@std@@@std@@QAE@XZ ; std::basic_ostream<char,std::char_traits<char> >::sentry::~sentry
	mov	eax, DWORD PTR $T133414[ebp]
...
; 782  : 		return (iterator(this->_Myfirst, this));
	...
	mov	eax, DWORD PTR $T133449[ebp]
	or	eax, 1
	mov	DWORD PTR $T133449[ebp], eax
...
; 792  : 		return (iterator(this->_Mylast, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@PAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@1@PBU_Container_base12@1@@Z ; std::_Vector_iterator<std::_Vector_val<std::basic_string<char,std::char_traits<char>,std::allocator<char> >,std::allocator<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > > >::_Vector_iterator<std::_Vector_val<std::basic_string<char,std::char_traits<char>,std::allocator<char> >,std::allocator<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > > >
	mov	eax, DWORD PTR $T133454[ebp]
	or	eax, 1
	mov	DWORD PTR $T133454[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 1218 : 		erase(begin(), end());
	...
	sub	esp, 12					; 0000000cH
	mov	ecx, esp
	mov	DWORD PTR $T133462[ebp], esp
	mov	eax, DWORD PTR tv151[ebp]
	push	eax
	call	??0?$_Vector_const_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@ABV01@@Z
	mov	DWORD PTR tv154[ebp], eax
	lea	ecx, DWORD PTR $T133464[ebp]
	push	ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 3
	mov	ecx, DWORD PTR _this$[ebp]
...
; Function compile flags: /Odtp /RTCsu
; File d:\program files (x86)\vs2010\vc\include\fstream
...
; 365  : 		return (_Tmp += _Off);
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@ABV01@@Z
	mov	edx, DWORD PTR $T133486[ebp]
	or	edx, 1
	mov	DWORD PTR $T133486[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Tmp$[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??H?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QBE?AV01@H@Z$1:
	mov	eax, DWORD PTR $T133486[ebp]
	and	eax, 1
	je	$LN5@operator@2
	and	DWORD PTR $T133486[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@XZ
$LN5@operator@2:
	ret	0
...
; 319  : 			_THROW_NCEE(failure, "ios_base::failbit set");
	...
	push	1
	lea	edx, DWORD PTR $T133515[ebp]
	push	edx
	call	?make_error_code@std@@YA?AVerror_code@1@W4io_errc@31@@Z ; std::make_error_code
	add	esp, 8
	push	eax
	push	OFFSET ??_C@_0BG@FMKFHCIL@ios_base?3?3failbit?5set?$AA@
	lea	ecx, DWORD PTR $T133514[ebp]
	call	??0failure@ios_base@std@@QAE@PBDABVerror_code@2@@Z ; std::ios_base::failure::failure
	push	OFFSET __TI4?AVfailure@ios_base@std@@
	lea	eax, DWORD PTR $T133514[ebp]
	push	eax
	call	__CxxThrowException@8
...
; 321  : 			_THROW_NCEE(failure, "ios_base::eofbit set");
	...
	push	1
	lea	ecx, DWORD PTR $T133517[ebp]
	push	ecx
	call	?make_error_code@std@@YA?AVerror_code@1@W4io_errc@31@@Z ; std::make_error_code
	add	esp, 8
	push	eax
	push	OFFSET ??_C@_0BF@OOHOMBOF@ios_base?3?3eofbit?5set?$AA@
	lea	ecx, DWORD PTR $T133516[ebp]
	call	??0failure@ios_base@std@@QAE@PBDABVerror_code@2@@Z ; std::ios_base::failure::failure
	push	OFFSET __TI4?AVfailure@ios_base@std@@
	lea	edx, DWORD PTR $T133516[ebp]
	push	edx
	call	__CxxThrowException@8
$LN10@clear@2:
...
$LN5@sputc:
	...
	mov	DWORD PTR $T133567[ebp], eax
	mov	eax, DWORD PTR $T133567[ebp]
	mov	cl, BYTE PTR __Ch$[ebp]
	mov	BYTE PTR [eax], cl
	mov	edx, DWORD PTR $T133567[ebp]
	push	edx
...
; 1202 : 				_VIPTR(_First));
	...
	add	esp, 12					; 0000000cH
	mov	DWORD PTR __Ptr$129966[ebp], eax
...
; 1210 : 			_Destroy(_Ptr, this->_Mylast);
	...
	mov	edx, DWORD PTR [ecx+8]
	push	edx
	mov	eax, DWORD PTR __Ptr$129966[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1211 : 			this->_Mylast = _Ptr;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR __Ptr$129966[ebp]
...
; 1213 : 		return (_First);
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@ABV01@@Z
	mov	ecx, DWORD PTR $T133590[ebp]
	or	ecx, 1
	mov	DWORD PTR $T133590[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 3
	lea	ecx, DWORD PTR __Last$[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@XZ
	mov	BYTE PTR __$EHRec$[ebp+8], 2
...
__unwindfunclet$?erase@?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@QAE?AV?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@2@V?$_Vector_const_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@2@0@Z$5:
	...
	jmp	??1?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@XZ
__unwindfunclet$?erase@?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@QAE?AV?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@2@V?$_Vector_const_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@2@0@Z$6:
	mov	eax, DWORD PTR $T133590[ebp]
	and	eax, 1
	je	$LN13@erase
	and	DWORD PTR $T133590[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@XZ
$LN13@erase:
	ret	0
...
; 120  : 			_BEGIN_LOCK(_LOCK_LOCALE)
	...
	push	0
	lea	ecx, DWORD PTR __Lock$117028[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
...
; 123  : 				return (_Refs == 0 ? this : 0);
	...
	mov	DWORD PTR $T133620[ebp], eax
	lea	ecx, DWORD PTR __Lock$117028[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T133620[ebp]
...
_TEXT	SEGMENT
__Nw$130047 = -20					; size = 4
__Nr$130045 = -16					; size = 4
__Pn$130043 = -12					; size = 4
__Pb$130041 = -8					; size = 4
_this$ = -4						; size = 4
__File$ = 8						; size = 4
__Which$ = 12						; size = 4
...
; 574  : 			_Elem **_Pb = (_Elem **)&_File->_IOBASE;
	...
	mov	ecx, DWORD PTR __File$[ebp]
	add	ecx, 8
	mov	DWORD PTR __Pb$130041[ebp], ecx

; 575  : 			_Elem **_Pn = (_Elem **)&_File->_IOPTR;

	mov	edx, DWORD PTR __File$[ebp]
	mov	DWORD PTR __Pn$130043[ebp], edx

; 576  : 			int *_Nr = (int *)&_File->_IORCNT;

	mov	eax, DWORD PTR __File$[ebp]
	add	eax, 4
	mov	DWORD PTR __Nr$130045[ebp], eax

; 577  : 			int *_Nw = (int *)&_File->_IOWCNT;

	mov	ecx, DWORD PTR __File$[ebp]
	add	ecx, 4
	mov	DWORD PTR __Nw$130047[ebp], ecx

; 578  : 			_Mysb::_Init(_Pb, _Pn, _Nr, _Pb, _Pn, _Nw);

	mov	edx, DWORD PTR __Nw$130047[ebp]
	push	edx
	mov	eax, DWORD PTR __Pn$130043[ebp]
	push	eax
	mov	ecx, DWORD PTR __Pb$130041[ebp]
	push	ecx
	mov	edx, DWORD PTR __Nr$130045[ebp]
	push	edx
	mov	eax, DWORD PTR __Pn$130043[ebp]
	push	eax
	mov	ecx, DWORD PTR __Pb$130041[ebp]
...
; 130  : 		return (*_Plocale);
	...
	mov	edx, DWORD PTR $T133692[ebp]
	or	edx, 1
	mov	DWORD PTR $T133692[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 802  : 		return (iterator(_Where._Ptr, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@PAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@1@PBU_Container_base12@1@@Z ; std::_Vector_iterator<std::_Vector_val<std::basic_string<char,std::char_traits<char>,std::allocator<char> >,std::allocator<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > > >::_Vector_iterator<std::_Vector_val<std::basic_string<char,std::char_traits<char>,std::allocator<char> >,std::allocator<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > > >
	mov	edx, DWORD PTR $T133712[ebp]
	or	edx, 1
	mov	DWORD PTR $T133712[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
...
__unwindfunclet$?_Make_iter@?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@QBE?AV?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@2@V?$_Vector_const_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@2@@Z$0:
	...
	jmp	??1?$_Vector_const_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@XZ
__unwindfunclet$?_Make_iter@?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@QBE?AV?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@2@V?$_Vector_const_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@2@@Z$1:
	mov	eax, DWORD PTR $T133712[ebp]
	and	eax, 1
	je	$LN5@Make_iter
	and	DWORD PTR $T133712[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@XZ
$LN5@Make_iter:
	ret	0
...
; 511  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T133774[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv289[ebp], eax
	mov	edx, DWORD PTR tv289[ebp]
	mov	DWORD PTR $T133775[ebp], edx
	lea	eax, DWORD PTR $T133774[ebp]
	push	eax
	lea	ecx, DWORD PTR $T133775[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
...
; 523  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T133776[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv297[ebp], eax
	mov	edx, DWORD PTR tv297[ebp]
	mov	DWORD PTR $T133777[ebp], edx
	lea	eax, DWORD PTR $T133776[ebp]
	push	eax
	lea	ecx, DWORD PTR $T133777[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
...
; 533  : 	return (_Ostr);
	...
	mov	eax, DWORD PTR __Ostr$[ebp]
	mov	DWORD PTR $T133778[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+12], -1
	lea	ecx, DWORD PTR __Ok$[ebp]
	call	??1sentry@?$basic_ostream@DU?$char_traits@D@std@@@std@@QAE@XZ ; std::basic_ostream<char,std::char_traits<char> >::sentry::~sentry
	mov	eax, DWORD PTR $T133778[ebp]
...
$T133807 = -64						; size = 4
$T133806 = -60						; size = 12
__Pfmod$131069 = -48					; size = 4
__Pf$131058 = -44					; size = 4
__Id$131057 = -40					; size = 4
__Psave$131045 = -32					; size = 4
__Lock$131044 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$131044[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$131045[ebp], eax
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$131045[ebp], 0
	je	SHORT $LN4@use_facet

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	edx, DWORD PTR __Psave$131045[ebp]
	mov	DWORD PTR __Pf$131058[ebp], edx
	jmp	SHORT $LN5@use_facet
$LN4@use_facet:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	push	eax
	lea	ecx, DWORD PTR __Psave$131045[ebp]
	push	ecx
...
; 520  : 			_THROW_NCEE(bad_cast, _EMPTY_ARGUMENT);	// lazy disallowed
	...
	lea	ecx, DWORD PTR $T133806[ebp]
	call	??0bad_cast@std@@QAE@PBD@Z		; std::bad_cast::bad_cast
	push	OFFSET __TI2?AVbad_cast@std@@
	lea	edx, DWORD PTR $T133806[ebp]
	push	edx
	call	__CxxThrowException@8
...
; 528  : 			_Pf = _Psave;
	...
	mov	eax, DWORD PTR __Psave$131045[ebp]
	mov	DWORD PTR __Pf$131058[ebp], eax

; 529  : 			_Facetptr<_Facet>::_Psave = _Psave;

	mov	ecx, DWORD PTR __Psave$131045[ebp]
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	edx, DWORD PTR __Psave$131045[ebp]
	mov	DWORD PTR __Pfmod$131069[ebp], edx

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$131069[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$131058[ebp]
	mov	DWORD PTR $T133807[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$131044[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T133807[ebp]
$LN8@use_facet:
...
; 78   : 				_BEGIN_LOCK(_LOCK_LOCALE)
	...
	push	0
	lea	ecx, DWORD PTR __Lock$117017[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
...
; 2535 : 		_Dest, _Ptr_cat(_First, _Dest)));
	...
	add	esp, 8
	mov	BYTE PTR $T133836[ebp], al
	movzx	edx, BYTE PTR $T133836[ebp]
	push	edx
	mov	eax, DWORD PTR __Dest$[ebp]
	push	eax
	mov	ecx, DWORD PTR __Last$[ebp]
...
; 88   : 	_Destroy_range(_First, _Last, _Al, _Ptr_cat(_First, _Last));
	...
	call	??$_Ptr_cat@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V12@@std@@YA?AU_Nonscalar_ptr_iterator_tag@0@PAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@0@Z ; std::_Ptr_cat<std::basic_string<char,std::char_traits<char>,std::allocator<char> >,std::basic_string<char,std::char_traits<char>,std::allocator<char> > >
	add	esp, 8
	mov	BYTE PTR $T133839[ebp], al
	movzx	edx, BYTE PTR $T133839[ebp]
	push	edx
...
$LN5@Getcat:
	...
	mov	DWORD PTR $T133846[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR __Ppf$[ebp]
	mov	ecx, DWORD PTR $T133846[ebp]
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T133853[ebp]
	and	edx, 1
	je	SHORT $LN1@Getcat
	and	DWORD PTR $T133853[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T133849[ebp]
...
; 1993 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR __Ptr$129512[ebp], eax
...
; 1995 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$129512[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1996 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$129512[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 28					; 0000001cH
...
; 1954 : 		_Traits::assign(_Myptr()[this->_Mysize = _Newsize], _Elem());
	...
	mov	BYTE PTR $T133983[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+20], ecx
	lea	edx, DWORD PTR $T133983[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1118 : 			size_type _Newsize = this->_Mysize - _Count;
	...
	mov	DWORD PTR __Newsize$129491[ebp], eax

; 1119 : 			_Eos(_Newsize);

	mov	ecx, DWORD PTR __Newsize$129491[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase@2:
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	add	esp, 8
	mov	DWORD PTR $T134182[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T134182[ebp], 0
	...
	mov	ecx, DWORD PTR $T134182[ebp]
	mov	DWORD PTR [ecx], edx
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR $T134182[ebp]
...
; 933  : 		{	// construct unopened
	...
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	mov	ecx, DWORD PTR $T134202[ebp]
	or	ecx, 1
	mov	DWORD PTR $T134202[ebp], ecx
$LN1@basic_ofst:
	push	0
	push	0
	mov	edx, DWORD PTR _this$[ebp]
...
__unwindfunclet$??0?$basic_ofstream@DU?$char_traits@D@std@@@std@@QAE@XZ$0:
	mov	eax, DWORD PTR $T134202[ebp]
	and	eax, 1
	je	$LN5@basic_ofst
	and	DWORD PTR $T134202[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 96					; 00000060H
...
; 359  : 			? _Traits::eof() : _Traits::to_int_type(*_Gninc()));
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR $T134272[ebp], eax
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T134273[ebp], eax
	lea	ecx, DWORD PTR $T134272[ebp]
	push	ecx
	lea	edx, DWORD PTR $T134273[ebp]
	push	edx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	eax, al
...
; 379  : 			else if (_Traits::eq_int_type(_Traits::eof(), _Meta = uflow()))
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T134278[ebp], eax
	lea	ecx, DWORD PTR __Meta$[ebp]
	push	ecx
	lea	edx, DWORD PTR $T134278[ebp]
	push	edx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	eax, al
...
; 408  : 				overflow(_Traits::to_int_type(*_Ptr))))
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR $T134289[ebp], eax
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T134290[ebp], eax
	lea	ecx, DWORD PTR $T134289[ebp]
	push	ecx
	lea	edx, DWORD PTR $T134290[ebp]
	push	edx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	eax, al
...
$T134314 = -112						; size = 4
$T134311 = -108						; size = 4
__Count$129188 = -104					; size = 4
__Str$129093 = -96					; size = 32
__Dest$129092 = -56					; size = 4
__Src$129091 = -44					; size = 4
__Ch$129090 = -29					; size = 1
__STRING_INC$129089 = -24				; size = 4
_this$ = -20						; size = 4
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
__Meta$ = 8						; size = 4
...
; 322  : 		{	// put an element to stream
	...
	mov	DWORD PTR fs:0, eax
	mov	DWORD PTR _this$[ebp], ecx
	mov	DWORD PTR $T134333[ebp], 0

; 323  : 		if (_Traits::eq_int_type(_Traits::eof(), _Meta))

	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T134311[ebp], eax
	lea	eax, DWORD PTR __Meta$[ebp]
	push	eax
	lea	ecx, DWORD PTR $T134311[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	edx, al
...
; 339  : 			const int _STRING_INC = 8;
	...
	mov	DWORD PTR __STRING_INC$129089[ebp], 8
...
; 340  : 			const _Elem _Ch = _Traits::to_char_type(_Meta);
	...
	call	?to_char_type@?$char_traits@D@std@@SADABH@Z ; std::char_traits<char>::to_char_type
	add	esp, 4
	mov	BYTE PTR __Ch$129090[ebp], al
...
; 344  : 			string _Str(_STRING_INC, '\0');
	...
	push	0
	push	8
	lea	ecx, DWORD PTR __Str$129093[ebp]
...
; 348  : 					&*_Str.begin(), &*_Str.begin() + _Str.size(), _Dest))
	...
	lea	edx, DWORD PTR __Dest$129092[ebp]
	push	edx
	lea	eax, DWORD PTR $T134315[ebp]
	push	eax
	lea	ecx, DWORD PTR __Str$129093[ebp]
	...
	call	??D?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEAADXZ ; std::_String_iterator<char,std::char_traits<char>,std::allocator<char> >::operator*
	push	eax
	lea	ecx, DWORD PTR __Src$129091[ebp]
	push	ecx
	lea	edx, DWORD PTR __Ch$129090[ebp+1]
	push	edx
	lea	eax, DWORD PTR __Ch$129090[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	...
	mov	DWORD PTR $T134314[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	lea	ecx, DWORD PTR $T134316[ebp]
	call	??1?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T134315[ebp]
	call	??1?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	mov	eax, DWORD PTR $T134314[ebp]
	mov	DWORD PTR tv184[ebp], eax
...
; 353  : 					size_t _Count = _Dest - &*_Str.begin();
	...
	call	??D?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEAADXZ ; std::_String_iterator<char,std::char_traits<char>,std::allocator<char> >::operator*
	mov	ecx, DWORD PTR __Dest$129092[ebp]
	sub	ecx, eax
	mov	DWORD PTR __Count$129188[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T134317[ebp]
	call	??1?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
; 355  : 						fwrite(&*_Str.begin(), 1, _Count, _Myfile))
	...
	cmp	DWORD PTR __Count$129188[ebp], 0
	jbe	SHORT $LN25@overflow
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+84]
	push	eax
	mov	ecx, DWORD PTR __Count$129188[ebp]
	push	ecx
	push	1
	lea	edx, DWORD PTR $T134319[ebp]
	push	edx
	lea	ecx, DWORD PTR __Str$129093[ebp]
	call	?begin@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE?AV?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@2@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::begin
	...
	mov	BYTE PTR __$EHRec$[ebp+8], 4
	mov	ecx, DWORD PTR $T134333[ebp]
	or	ecx, 1
	mov	DWORD PTR $T134333[ebp], ecx
	mov	ecx, DWORD PTR tv246[ebp]
	call	??D?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEAADXZ ; std::_String_iterator<char,std::char_traits<char>,std::allocator<char> >::operator*
	push	eax
	call	_fwrite
	add	esp, 16					; 00000010H
	cmp	DWORD PTR __Count$129188[ebp], eax
...
$LN26@overflow:
	...
	mov	BYTE PTR $T134318[ebp], dl
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	mov	eax, DWORD PTR $T134333[ebp]
	and	eax, 1
	je	SHORT $LN35@overflow
	and	DWORD PTR $T134333[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T134319[ebp]
	call	??1?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
$LN35@overflow:
	movzx	ecx, BYTE PTR $T134318[ebp]
	test	ecx, ecx
...
; 356  : 						return (_Traits::eof());	// write failed
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T134322[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$129093[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T134322[ebp]
	jmp	$LN21@overflow
$LN8@overflow:
...
; 359  : 					if (_Src != &_Ch)
	...
	mov	eax, DWORD PTR __Src$129091[ebp]
	lea	ecx, DWORD PTR __Ch$129090[ebp]
	cmp	eax, ecx
...
; 360  : 						return (_Meta);	// converted whole element
	...
	mov	DWORD PTR $T134323[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$129093[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T134323[ebp]
	jmp	$LN21@overflow
$LN7@overflow:
...
; 367  : 						return (_Traits::eof());	// conversion failed
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T134324[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$129093[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T134324[ebp]
	jmp	$LN21@overflow
$LN5@overflow:
...
; 373  : 						: _Traits::eof());	// no conversion, put as is
	...
	push	ecx
	movzx	edx, BYTE PTR __Ch$129090[ebp]
	push	edx
	call	??$_Fputc@D@std@@YA_NDPAU_iobuf@@@Z	; std::_Fputc<char>
	add	esp, 8
	movzx	eax, al
...
$LN28@overflow:
	...
	mov	DWORD PTR $T134325[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$129093[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T134325[ebp]
...
; 376  : 					return (_Traits::eof());	// conversion failed
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T134328[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$129093[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T134328[ebp]
	jmp	SHORT $LN21@overflow
$LN10@overflow:
...
; 388  : 				_Meta)))
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T134357[ebp], eax
	lea	eax, DWORD PTR __Meta$[ebp]
	push	eax
	lea	ecx, DWORD PTR $T134357[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	edx, al
	...
	call	?to_int_type@?$char_traits@D@std@@SAHABD@Z ; std::char_traits<char>::to_int_type
	add	esp, 4
	mov	DWORD PTR $T134358[ebp], eax
	lea	eax, DWORD PTR __Meta$[ebp]
	push	eax
	lea	ecx, DWORD PTR $T134358[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	edx, al
...
; 393  : 		else if (_Myfile == 0 || _Traits::eq_int_type(_Traits::eof(), _Meta))
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T134359[ebp], eax
	lea	edx, DWORD PTR __Meta$[ebp]
	push	edx
	lea	eax, DWORD PTR $T134359[ebp]
	push	eax
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	ecx, al
...
; 395  : 		else if (_Pcvt == 0 && _Ungetc(_Traits::to_char_type(_Meta), _Myfile))
	...
	call	?to_char_type@?$char_traits@D@std@@SADABH@Z ; std::char_traits<char>::to_char_type
	add	esp, 4
	mov	BYTE PTR $T134360[ebp], al
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+84]
	push	edx
	lea	eax, DWORD PTR $T134360[ebp]
	push	eax
...
; 413  : 		else if (_Traits::eq_int_type(_Traits::eof(), _Meta = uflow()))
	...
	mov	DWORD PTR __Meta$[ebp], eax
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T134365[ebp], eax
	lea	ecx, DWORD PTR __Meta$[ebp]
	push	ecx
	lea	edx, DWORD PTR $T134365[ebp]
	push	edx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	eax, al
...
$T134375 = -124						; size = 4
$T134374 = -120						; size = 4
__Meta$129245 = -116					; size = 4
__Nleft$129244 = -112					; size = 4
__Src$129243 = -104					; size = 4
__Dest$129242 = -92					; size = 4
__Ch$129241 = -77					; size = 1
__Str$129237 = -68					; size = 32
__Ch$129235 = -25					; size = 1
_this$ = -20						; size = 4
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
...
; 433  : 			_Elem _Ch = 0;
	...
	mov	BYTE PTR __Ch$129235[ebp], 0
...
; 435  : 				: _Traits::eof());
	...
	mov	eax, DWORD PTR [edx+84]
	push	eax
	lea	ecx, DWORD PTR __Ch$129235[ebp]
	push	ecx
	...
	lea	eax, DWORD PTR __Ch$129235[ebp]
	push	eax
	call	?to_int_type@?$char_traits@D@std@@SAHABD@Z ; std::char_traits<char>::to_int_type
	add	esp, 4
...
; 439  : 			string _Str;
	...
	lea	ecx, DWORD PTR __Str$129237[ebp]
...
; 446  : 				int _Meta = fgetc(_Myfile);
	...
	call	_fgetc
	add	esp, 4
	mov	DWORD PTR __Meta$129245[ebp], eax

; 447  : 
; 448  : 				if (_Meta == EOF)

	cmp	DWORD PTR __Meta$129245[ebp], -1
	jne	SHORT $LN11@uflow@2

; 449  : 					return (_Traits::eof());	// partial char?

	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T134374[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$129237[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T134374[ebp]
	jmp	$LN19@uflow@2
$LN11@uflow@2:
...
; 451  : 				_Str.append(1, (char)_Meta);	// append byte and convert
	...
	movzx	eax, BYTE PTR __Meta$129245[ebp]
	push	eax
	push	1
	lea	ecx, DWORD PTR __Str$129237[ebp]
	call	?append@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@ID@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::append
...
; 454  : 					&_Ch, &_Ch + 1, _Dest))
	...
	lea	ecx, DWORD PTR __Dest$129242[ebp]
	push	ecx
	lea	edx, DWORD PTR __Ch$129241[ebp+1]
	push	edx
	lea	eax, DWORD PTR __Ch$129241[ebp]
	push	eax
	lea	ecx, DWORD PTR __Src$129243[ebp]
	push	ecx
	lea	edx, DWORD PTR $T134376[ebp]
	push	edx
	lea	ecx, DWORD PTR __Str$129237[ebp]
	call	?begin@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE?AV?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@2@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::begin
	...
	mov	DWORD PTR $T134375[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	lea	ecx, DWORD PTR $T134377[ebp]
	call	??1?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T134376[ebp]
	call	??1?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	mov	edx, DWORD PTR $T134375[ebp]
...
; 458  : 					if (_Dest != &_Ch)
	...
	mov	eax, DWORD PTR __Dest$129242[ebp]
	lea	ecx, DWORD PTR __Ch$129241[ebp]
	cmp	eax, ecx
	je	$LN7@uflow@2
...
; 460  : 						_Nleft = (int)(&*_Str.begin() + _Str.size() - _Src);
	...
	call	?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::size
	add	esi, eax
	sub	esi, DWORD PTR __Src$129243[ebp]
	mov	DWORD PTR __Nleft$129244[ebp], esi
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T134378[ebp]
	call	??1?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
$LN6@uflow@2:

; 461  : 						for (; 0 < _Nleft; )

	cmp	DWORD PTR __Nleft$129244[ebp], 0
	jle	SHORT $LN5@uflow@2

; 462  : 							ungetc(_Src[--_Nleft], _Myfile);

	mov	ecx, DWORD PTR __Nleft$129244[ebp]
	sub	ecx, 1
	mov	DWORD PTR __Nleft$129244[ebp], ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+84]
	push	eax
	mov	ecx, DWORD PTR __Src$129243[ebp]
	add	ecx, DWORD PTR __Nleft$129244[ebp]
...
; 463  : 						return (_Traits::to_int_type(_Ch));
	...
	call	?to_int_type@?$char_traits@D@std@@SAHABD@Z ; std::char_traits<char>::to_int_type
	add	esp, 4
	mov	DWORD PTR $T134379[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$129237[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T134379[ebp]
	jmp	$LN19@uflow@2
...
; 477  : 					return (_Traits::to_int_type(_Ch));	// return result
	...
	lea	edx, DWORD PTR __Ch$129241[ebp]
	push	edx
	call	?to_int_type@?$char_traits@D@std@@SAHABD@Z ; std::char_traits<char>::to_int_type
	add	esp, 4
	mov	DWORD PTR $T134382[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$129237[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T134382[ebp]
...
; 480  : 					return (_Traits::eof());	// conversion failed
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T134383[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$129237[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T134383[ebp]
	jmp	SHORT $LN19@uflow@2
$LN9@uflow@2:
...
; 546  : 			|| 0 <= fflush(_Myfile) ? 0 : -1);
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR $T134431[ebp], eax
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T134432[ebp], eax
	lea	ecx, DWORD PTR $T134431[ebp]
	push	ecx
	lea	edx, DWORD PTR $T134432[ebp]
	push	edx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	eax, al
...
; 1352 : 		return (_STRING_ITERATOR(_Myptr()));
	...
	mov	ecx, DWORD PTR $T134467[ebp]
	or	ecx, 1
	mov	DWORD PTR $T134467[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 46   : 	explicit __CLR_OR_THIS_CALL basic_ostream(
	...
	call	??0?$basic_ios@DU?$char_traits@D@std@@@std@@IAE@XZ ; std::basic_ios<char,std::char_traits<char> >::basic_ios<char,std::char_traits<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	mov	ecx, DWORD PTR $T134486[ebp]
	or	ecx, 1
	mov	DWORD PTR $T134486[ebp], ecx
$LN1@basic_ostr:
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx]
	mov	ecx, DWORD PTR [eax+4]
...
__unwindfunclet$??0?$basic_ostream@DU?$char_traits@D@std@@@std@@QAE@PAV?$basic_streambuf@DU?$char_traits@D@std@@@1@_N@Z$0:
	mov	eax, DWORD PTR $T134486[ebp]
	and	eax, 1
	je	$LN5@basic_ostr
	and	DWORD PTR $T134486[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 8
	jmp	??1?$basic_ios@DU?$char_traits@D@std@@@std@@UAE@XZ ; std::basic_ios<char,std::char_traits<char> >::~basic_ios<char,std::char_traits<char> >
$LN5@basic_ostr:
...
$T134537 = -88						; size = 4
$T134536 = -84						; size = 4
__Count$130072 = -80					; size = 4
__Str$130059 = -72					; size = 32
__Dest$130055 = -32					; size = 4
__STRING_INC$130054 = -24				; size = 4
_this$ = -20						; size = 4
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
...
; 592  : 			const int _STRING_INC = 8;
	...
	mov	DWORD PTR __STRING_INC$130054[ebp], 8
...
; 594  : 			if (_Traits::eq_int_type(_Traits::eof(), overflow()))
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR $T134536[ebp], eax
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T134537[ebp], eax
	lea	ecx, DWORD PTR $T134536[ebp]
	push	ecx
	lea	edx, DWORD PTR $T134537[ebp]
	push	edx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	eax, al
...
; 597  : 			string _Str(_STRING_INC, '\0');
	...
	push	0
	push	8
	lea	ecx, DWORD PTR __Str$130059[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ID@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 0
$LN11@Endwrite:
...
; 600  : 					&*_Str.begin(), &*_Str.begin() + _Str.size(), _Dest))
	...
	lea	ecx, DWORD PTR __Dest$130055[ebp]
	push	ecx
	lea	edx, DWORD PTR $T134539[ebp]
	push	edx
	lea	ecx, DWORD PTR __Str$130059[ebp]
	call	?begin@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE?AV?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@2@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::begin
	...
	mov	DWORD PTR $T134538[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	lea	ecx, DWORD PTR $T134540[ebp]
	call	??1?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T134539[ebp]
	call	??1?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	mov	edx, DWORD PTR $T134538[ebp]
...
; 607  : 					size_t _Count = _Dest - &*_Str.begin();
	...
	call	??D?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEAADXZ ; std::_String_iterator<char,std::char_traits<char>,std::allocator<char> >::operator*
	mov	ecx, DWORD PTR __Dest$130055[ebp]
	sub	ecx, eax
	mov	DWORD PTR __Count$130072[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T134541[ebp]
	call	??1?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
; 609  : 						fwrite(&*_Str.begin(), 1, _Count, _Myfile))
	...
	cmp	DWORD PTR __Count$130072[ebp], 0
	jbe	SHORT $LN18@Endwrite
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+84]
	push	eax
	mov	ecx, DWORD PTR __Count$130072[ebp]
	push	ecx
	push	1
	lea	edx, DWORD PTR $T134543[ebp]
	push	edx
	lea	ecx, DWORD PTR __Str$130059[ebp]
	call	?begin@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE?AV?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@2@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::begin
	...
	mov	BYTE PTR __$EHRec$[ebp+8], 4
	mov	ecx, DWORD PTR $T134554[ebp]
	or	ecx, 1
	mov	DWORD PTR $T134554[ebp], ecx
	mov	ecx, DWORD PTR tv197[ebp]
	call	??D?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEAADXZ ; std::_String_iterator<char,std::char_traits<char>,std::allocator<char> >::operator*
	push	eax
	call	_fwrite
	add	esp, 16					; 00000010H
	cmp	DWORD PTR __Count$130072[ebp], eax
...
$LN19@Endwrite:
	...
	mov	BYTE PTR $T134542[ebp], dl
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	mov	eax, DWORD PTR $T134554[ebp]
	and	eax, 1
	je	SHORT $LN26@Endwrite
	and	DWORD PTR $T134554[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T134543[ebp]
	call	??1?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
$LN26@Endwrite:
	movzx	ecx, BYTE PTR $T134542[ebp]
	test	ecx, ecx
	je	SHORT $LN5@Endwrite

; 610  : 						return (false);	// write failed

	mov	BYTE PTR $T134546[ebp], 0
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$130059[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	al, BYTE PTR $T134546[ebp]
	jmp	$LN16@Endwrite
$LN5@Endwrite:
...
; 612  : 						return (true);
	...
	mov	BYTE PTR $T134547[ebp], 1
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$130059[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	al, BYTE PTR $T134547[ebp]
...
; 619  : 					return (true);	// nothing to do
	...
	mov	BYTE PTR $T134548[ebp], 1
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$130059[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	al, BYTE PTR $T134548[ebp]
	jmp	SHORT $LN16@Endwrite
$LN1@Endwrite:
...
; 622  : 					return (false);	// conversion failed
	...
	mov	BYTE PTR $T134549[ebp], 0
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$130059[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	al, BYTE PTR $T134549[ebp]
	jmp	SHORT $LN16@Endwrite
$LN8@Endwrite:
...
; 564  : 		_Ploc = _NEW_CRT locale;
	...
	call	??2@YAPAXIABU_DebugHeapTag_t@std@@PADH@Z ; operator new
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T134598[ebp], eax
	cmp	DWORD PTR $T134598[ebp], 0
	je	SHORT $LN3@Init@2
	mov	ecx, DWORD PTR $T134598[ebp]
...
; 25   : 		{	// construct with no buffers
	...
	call	??2@YAPAXIABU_DebugHeapTag_t@std@@PADH@Z ; operator new
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T134607[ebp], eax
	cmp	DWORD PTR $T134607[ebp], 0
	je	SHORT $LN3@basic_stre
	mov	ecx, DWORD PTR $T134607[ebp]
	call	??0locale@std@@QAE@XZ			; std::locale::locale
	mov	DWORD PTR tv79[ebp], eax
...
; 452  : 		return (*_Ploc);
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0locale@std@@QAE@ABV01@@Z		; std::locale::locale
	mov	edx, DWORD PTR $T134641[ebp]
	or	edx, 1
	mov	DWORD PTR $T134641[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
$T134658 = -64						; size = 4
$T134657 = -60						; size = 12
__Pfmod$130834 = -48					; size = 4
__Pf$130818 = -44					; size = 4
__Id$130817 = -40					; size = 4
__Psave$130805 = -32					; size = 4
__Lock$130804 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$130804[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$130805[ebp], eax
...
; 509  : 		size_t _Id = _Facet::id;
	...
	call	??Bid@locale@std@@QAEIXZ		; std::locale::id::operator unsigned int
	mov	DWORD PTR __Id$130817[ebp], eax

; 510  : 		const locale::facet *_Pf = _Loc._Getfacet(_Id);

	mov	ecx, DWORD PTR __Id$130817[ebp]
	push	ecx
	mov	ecx, DWORD PTR __Loc$[ebp]
	call	?_Getfacet@locale@std@@QBEPBVfacet@12@I@Z ; std::locale::_Getfacet
	mov	DWORD PTR __Pf$130818[ebp], eax

; 511  : 
; 512  : 		if (_Pf != 0)

	cmp	DWORD PTR __Pf$130818[ebp], 0
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$130805[ebp], 0
	je	SHORT $LN4@use_facet@2

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	edx, DWORD PTR __Psave$130805[ebp]
	mov	DWORD PTR __Pf$130818[ebp], edx
	jmp	SHORT $LN5@use_facet@2
$LN4@use_facet@2:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	mov	eax, DWORD PTR __Loc$[ebp]
	push	eax
	lea	ecx, DWORD PTR __Psave$130805[ebp]
	push	ecx
...
; 520  : 			_THROW_NCEE(bad_cast, _EMPTY_ARGUMENT);	// lazy disallowed
	...
	push	OFFSET ??_C@_08EPJLHIJG@bad?5cast?$AA@
	lea	ecx, DWORD PTR $T134657[ebp]
	call	??0bad_cast@std@@QAE@PBD@Z		; std::bad_cast::bad_cast
	push	OFFSET __TI2?AVbad_cast@std@@
	lea	edx, DWORD PTR $T134657[ebp]
	push	edx
	call	__CxxThrowException@8
...
; 528  : 			_Pf = _Psave;
	...
	mov	eax, DWORD PTR __Psave$130805[ebp]
	mov	DWORD PTR __Pf$130818[ebp], eax

; 529  : 			_Facetptr<_Facet>::_Psave = _Psave;

	mov	ecx, DWORD PTR __Psave$130805[ebp]
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	edx, DWORD PTR __Psave$130805[ebp]
	mov	DWORD PTR __Pfmod$130834[ebp], edx

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$130834[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$130818[ebp]
	mov	DWORD PTR $T134658[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$130804[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T134658[ebp]
$LN8@use_facet@2:
...
; 2374 : 				_Locinfo(_Ploc->c_str()));
	...
	call	?_DebugHeapTag_func@std@@YAABU_DebugHeapTag_t@1@XZ ; std::_DebugHeapTag_func
	mov	DWORD PTR $T134675[ebp], eax
	push	2373					; 00000945H
	push	OFFSET ??_C@_0DB@CHHJGNBI@D?3?2Program?5Files?5?$CIx86?$CJ?2VS2010?2VC@
	mov	ecx, DWORD PTR $T134675[ebp]
	push	ecx
	push	24					; 00000018H
	call	??2facet@locale@std@@SAPAXIABU_DebugHeapTag_t@2@PADH@Z ; std::locale::facet::operator new
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T134674[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T134674[ebp], 0
	je	SHORT $LN4@Getcat@2
	push	0
	mov	ecx, DWORD PTR __Ploc$[ebp]
	call	?c_str@locale@std@@QBEPBDXZ		; std::locale::c_str
	push	eax
	lea	ecx, DWORD PTR $T134676[ebp]
	call	??0_Locinfo@std@@QAE@PBD@Z		; std::_Locinfo::_Locinfo
	mov	DWORD PTR tv138[ebp], eax
	mov	edx, DWORD PTR tv138[ebp]
	mov	DWORD PTR tv133[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	mov	eax, DWORD PTR $T134680[ebp]
	or	eax, 1
	mov	DWORD PTR $T134680[ebp], eax
	mov	ecx, DWORD PTR tv133[ebp]
	push	ecx
	mov	ecx, DWORD PTR $T134674[ebp]
...
$LN5@Getcat@2:
	mov	edx, DWORD PTR tv92[ebp]
	mov	DWORD PTR $T134673[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR __Ppf$[ebp]
	mov	ecx, DWORD PTR $T134673[ebp]
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T134680[ebp]
	and	edx, 1
	je	SHORT $LN1@Getcat@2
	and	DWORD PTR $T134680[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T134676[ebp]
	call	??1_Locinfo@std@@QAE@XZ			; std::_Locinfo::~_Locinfo
$LN1@Getcat@2:
...
; 118  : 		return (::_Getctype());
	...
	lea	eax, DWORD PTR $T134713[ebp]
	push	eax
	call	__Getctype
	add	esp, 4
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR $T134712[ebp], ecx
	mov	edx, DWORD PTR [eax+4]
	mov	DWORD PTR $T134712[ebp+4], edx
	mov	ecx, DWORD PTR [eax+8]
	mov	DWORD PTR $T134712[ebp+8], ecx
	mov	edx, DWORD PTR [eax+12]
	mov	DWORD PTR $T134712[ebp+12], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	mov	ecx, DWORD PTR $T134712[ebp]
	mov	DWORD PTR [eax], ecx
	mov	edx, DWORD PTR $T134712[ebp+4]
	mov	DWORD PTR [eax+4], edx
	mov	ecx, DWORD PTR $T134712[ebp+8]
	mov	DWORD PTR [eax+8], ecx
	mov	edx, DWORD PTR $T134712[ebp+12]
