; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	D:\code\AI Source\LATEST vc6-vc10\VS2010\Buckland_Chapter7 to 10_Raven\goals\Raven_Feature.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_colors	DD	0ffH
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG143712 DB	'RailGun_MaxRoundsCarried', 00H
	ORG $+3
$SG143714 DB	'RocketLauncher_MaxRoundsCarried', 00H
$SG143716 DB	'ShotGun_MaxRoundsCarried', 00H
	ORG $+3
$SG143720 DB	'trying to calculate  of unknown weapon', 00H
CONST	ENDS
...
; File d:\code\ai source\latest vc6-vc10\vs2010\buckland_chapter7 to 10_raven\goals\raven_feature.cpp
CONST	SEGMENT
...
; 17   :   if (DistanceToItem < 0 ) return 1;
	...
	fldz
	fcomp	QWORD PTR _DistanceToItem$[ebp]
	fnstsw	ax
	test	ah, 65					; 00000041H
	jne	SHORT $LN1@DistanceTo
	fld1
...
; 22   :   const double MinDistance = 50.0;
	...
	fstp	QWORD PTR _MinDistance$[ebp]
...
; 26   :   return DistanceToItem / MaxDistance;
	...
	fld	QWORD PTR _DistanceToItem$[ebp]
	fdiv	QWORD PTR _MaxDistance$[ebp]
$LN2@DistanceTo:
...
; 53   :     throw std::runtime_error("trying to calculate  of unknown weapon");
	...
	push	OFFSET $SG143720
	lea	ecx, DWORD PTR $T154985[ebp]
...
; Function compile flags: /Odtp /RTCsu
; File d:\code\ai source\latest vc6-vc10\vs2010\buckland_chapter7 to 10_raven\armory\raven_weapon.h
_TEXT	ENDS
...
; 85   :   const double TotalRoundsCarryable = MaxRoundsForShotgun + MaxRoundsForRailgun + MaxRoundsForRocketLauncher;
	...
	fld	QWORD PTR _MaxRoundsForShotgun$[ebp]
	fadd	QWORD PTR _MaxRoundsForRailgun$[ebp]
	fadd	QWORD PTR _MaxRoundsForRocketLauncher$[ebp]
	fstp	QWORD PTR _TotalRoundsCarryable$[ebp]
...
; 88   :   double NumCartridges = (double)pBot->GetWeaponSys()->GetAmmoRemainingForWeapon(type_shotgun);
	...
	fstp	QWORD PTR _NumCartridges$[ebp]
...
; 89   :   double NumRockets    = (double)pBot->GetWeaponSys()->GetAmmoRemainingForWeapon(type_rocket_launcher);
	...
	fstp	QWORD PTR _NumRockets$[ebp]
...
; 96   :   return Tweaker + (1-Tweaker)*(NumSlugs + NumCartridges + NumRockets)/(MaxRoundsForShotgun + MaxRoundsForRailgun + MaxRoundsForRocketLauncher);
	...
	fld1
	fsub	QWORD PTR _Tweaker$[ebp]
	fld	QWORD PTR _NumSlugs$[ebp]
	fadd	QWORD PTR _NumCartridges$[ebp]
	fadd	QWORD PTR _NumRockets$[ebp]
	fmulp	ST(1), ST(0)
	fld	QWORD PTR _MaxRoundsForShotgun$[ebp]
	fadd	QWORD PTR _MaxRoundsForRailgun$[ebp]
	fadd	QWORD PTR _MaxRoundsForRocketLauncher$[ebp]
	fdivp	ST(1), ST(0)
	fadd	QWORD PTR _Tweaker$[ebp]
...
; 64   :     std::string err("<PopLuaNumber> Cannot retrieve: ");
	...
	lea	ecx, DWORD PTR _err$150023[ebp]
...
; 66   :     throw std::runtime_error(err + name);
	...
	mov	ecx, DWORD PTR _name$[ebp]
	push	ecx
	lea	edx, DWORD PTR _err$150023[ebp]
	push	edx
	lea	eax, DWORD PTR $T150024[ebp]
	push	eax
...
; 165  : 		{	// construct from message string
	...
	mov	DWORD PTR $T155034[ebp], eax
	lea	eax, DWORD PTR $T155034[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	??0exception@std@@QAE@ABQBD@Z		; std::exception::exception
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1993 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	DWORD PTR __Ptr$146011[ebp], eax
...
; 1995 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$146011[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1996 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$146011[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
_TEXT	SEGMENT
__Pnext$15181 = -20					; size = 4
__Lock$15180 = -12					; size = 4
_this$ = -4						; size = 4
...
; 198  : 		_Lockit _Lock(_LOCK_DEBUG);
	...
	push	3
	lea	ecx, DWORD PTR __Lock$15180[ebp]
...
; 200  : 		for (_Iterator_base12 **_Pnext = &_Myproxy->_Myfirstiter;
	...
	mov	edx, DWORD PTR [ecx]
	add	edx, 4
	mov	DWORD PTR __Pnext$15181[ebp], edx

; 201  : 			*_Pnext != 0; *_Pnext = (*_Pnext)->_Mynextiter)

	jmp	SHORT $LN3@Orphan_all
$LN2@Orphan_all:
	mov	eax, DWORD PTR __Pnext$15181[ebp]
	mov	ecx, DWORD PTR [eax]
	mov	edx, DWORD PTR __Pnext$15181[ebp]
	mov	eax, DWORD PTR [ecx+4]
	mov	DWORD PTR [edx], eax
$LN3@Orphan_all:
	mov	ecx, DWORD PTR __Pnext$15181[ebp]
	cmp	DWORD PTR [ecx], 0
...
; 1954 : 		_Traits::assign(_Myptr()[this->_Mysize = _Newsize], _Elem());
	...
	mov	BYTE PTR $T155114[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+20], ecx
	lea	edx, DWORD PTR $T155114[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Myptr@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEPADXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Myptr
...
; 1118 : 			size_type _Newsize = this->_Mysize - _Count;
	...
	mov	DWORD PTR __Newsize$145990[ebp], eax

; 1119 : 			_Eos(_Newsize);

	mov	ecx, DWORD PTR __Newsize$145990[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase:
...
; 69   : 	return (_Ans);
	...
	mov	ecx, DWORD PTR $T155180[ebp]
	or	ecx, 1
	mov	DWORD PTR $T155180[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Ans$[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
...
__unwindfunclet$??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@PBD@Z$1:
	mov	eax, DWORD PTR $T155180[ebp]
	and	eax, 1
	je	$LN5@operator
	and	DWORD PTR $T155180[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
$LN5@operator:
	ret	0
...
; 1543 : 			size_type _Size = this->_Mysize;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+20]
	mov	DWORD PTR __Size$150997[ebp], edx
...
; 1545 : 				_Eos(_Size);
	...
	mov	edx, DWORD PTR __Size$150997[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN3@reserve:
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	add	esp, 8
	mov	DWORD PTR $T155271[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T155271[ebp], 0
	...
	mov	ecx, DWORD PTR $T155271[ebp]
	mov	DWORD PTR [ecx], edx
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR $T155271[ebp]
