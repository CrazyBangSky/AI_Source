; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	D:\code\AI Source\LATEST vc6-vc10\VS2010\Buckland_Chapter7 to 10_Raven\goals\Raven_Goal_Types.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG27974 DB	'explore', 00H
$SG27976 DB	'think', 00H
	ORG $+2
$SG27978 DB	'arrive_at_position', 00H
	ORG $+1
$SG27980 DB	'seek_to_position', 00H
	ORG $+3
$SG27982 DB	'follow_path', 00H
$SG27984 DB	'traverse_edge', 00H
	ORG $+2
$SG27986 DB	'move_to_position', 00H
	ORG $+3
$SG27988 DB	'get_health', 00H
	ORG $+1
$SG27990 DB	'get_shotgun', 00H
$SG27992 DB	'get_railgun', 00H
$SG27994 DB	'get_rocket_launcher', 00H
$SG27996 DB	'wander', 00H
	ORG $+1
$SG27998 DB	'negotiate_door', 00H
	ORG $+1
$SG28000 DB	'attack_target', 00H
	ORG $+2
$SG28002 DB	'hunt_target', 00H
$SG28004 DB	'strafe', 00H
	ORG $+1
$SG28006 DB	'adjust_range', 00H
	ORG $+3
$SG28008 DB	'say_phrase', 00H
	ORG $+1
$SG28010 DB	'UNKNOWN GOAL TYPE!', 00H
CONST	ENDS
...
; File d:\code\ai source\latest vc6-vc10\vs2010\buckland_chapter7 to 10_raven\goals\raven_goal_types.cpp
_BSS	SEGMENT
...
; File d:\code\ai source\latest vc6-vc10\vs2010\buckland_chapter7 to 10_raven\goals\raven_goal_types.h
rdata$r	SEGMENT
...
; 16   :     return "explore";
	...
	mov	edx, DWORD PTR $T31639[ebp]
	or	edx, 1
	mov	DWORD PTR $T31639[ebp], edx
...
; 20   :     return "think";
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T31639[ebp]
	or	eax, 1
	mov	DWORD PTR $T31639[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	$LN22@Convert
$LN17@Convert:
...
; 24   :     return "arrive_at_position";
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	ecx, DWORD PTR $T31639[ebp]
	or	ecx, 1
	mov	DWORD PTR $T31639[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	$LN22@Convert
$LN16@Convert:
...
; 1993 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	DWORD PTR __Ptr$28861[ebp], eax
...
; 1995 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$28861[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1996 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$28861[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
_TEXT	SEGMENT
__Pnext$15177 = -20					; size = 4
__Lock$15176 = -12					; size = 4
_this$ = -4						; size = 4
...
; 198  : 		_Lockit _Lock(_LOCK_DEBUG);
	...
	push	3
	lea	ecx, DWORD PTR __Lock$15176[ebp]
...
; 200  : 		for (_Iterator_base12 **_Pnext = &_Myproxy->_Myfirstiter;
	...
	add	edx, 4
	mov	DWORD PTR __Pnext$15177[ebp], edx

; 201  : 			*_Pnext != 0; *_Pnext = (*_Pnext)->_Mynextiter)

	jmp	SHORT $LN3@Orphan_all
$LN2@Orphan_all:
	mov	eax, DWORD PTR __Pnext$15177[ebp]
	mov	ecx, DWORD PTR [eax]
	mov	edx, DWORD PTR __Pnext$15177[ebp]
	mov	eax, DWORD PTR [ecx+4]
	mov	DWORD PTR [edx], eax
$LN3@Orphan_all:
	mov	ecx, DWORD PTR __Pnext$15177[ebp]
	cmp	DWORD PTR [ecx], 0
...
; 1954 : 		_Traits::assign(_Myptr()[this->_Mysize = _Newsize], _Elem());
	...
	mov	BYTE PTR $T31705[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+20], ecx
	lea	edx, DWORD PTR $T31705[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Myptr@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEPADXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Myptr
...
; 1118 : 			size_type _Newsize = this->_Mysize - _Count;
	...
	mov	DWORD PTR __Newsize$29503[ebp], eax

; 1119 : 			_Eos(_Newsize);

	mov	ecx, DWORD PTR __Newsize$29503[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase:
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	add	esp, 8
	mov	DWORD PTR $T31797[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T31797[ebp], 0
	...
	mov	ecx, DWORD PTR $T31797[ebp]
	mov	DWORD PTR [ecx], edx
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR $T31797[ebp]
