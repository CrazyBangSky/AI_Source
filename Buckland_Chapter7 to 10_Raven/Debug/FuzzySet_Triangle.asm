; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	D:\code\AI Source\LATEST vc6-vc10\VS2010\Common\fuzzy\FuzzySet_Triangle.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File d:\code\ai source\latest vc6-vc10\vs2010\common\fuzzy\fuzzyset_triangle.cpp
CONST	SEGMENT
...
rtc$IMZ	ENDS
_TEXT	SEGMENT
_grad$41813 = -20					; size = 8
_grad$41810 = -12					; size = 8
_this$ = -4						; size = 4
_val$ = 8						; size = 8
...
; 17   :     double grad = 1.0 / m_dLeftOffset;
	...
	mov	edx, DWORD PTR _this$[ebp]
	fld1
	fdiv	QWORD PTR [edx+32]
	fstp	QWORD PTR _grad$41810[ebp]
...
; 19   :     return grad * (val - (m_dPeakPoint - m_dLeftOffset));
	...
	fld	QWORD PTR [eax+24]
	fsub	QWORD PTR [ecx+32]
	fsubr	QWORD PTR _val$[ebp]
	fmul	QWORD PTR _grad$41810[ebp]
...
; 24   :     double grad = 1.0 / -m_dRightOffset;
	...
	fld1
	fdivrp	ST(1), ST(0)
	fstp	QWORD PTR _grad$41813[ebp]
...
; 26   :     return grad * (val - m_dPeakPoint) + 1.0;
	...
	fmul	QWORD PTR _grad$41813[ebp]
