; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	D:\code\AI Source\LATEST vc6-vc10\VS2010\Buckland_Chapter7 to 10_Raven\Raven_Door.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?Read@Raven_Door@@UAEXAAV?$basic_ifstream@DU?$char_traits@D@std@@@std@@@Z ; Raven_Door::Read
...
PUBLIC	??_7Raven_Door@@6B@				; Raven_Door::`vftable'
PUBLIC	??$GetValueFromStream@H@@YAHAAV?$basic_ifstream@DU?$char_traits@D@std@@@std@@@Z ; GetValueFromStream<int>
PUBLIC	??0Raven_Door@@QAE@PAVRaven_Map@@AAV?$basic_ifstream@DU?$char_traits@D@std@@@std@@@Z ; Raven_Door::Raven_Door
PUBLIC	??_R4Raven_Door@@6B@				; Raven_Door::`RTTI Complete Object Locator'
PUBLIC	??_R0?AVRaven_Door@@@8				; Raven_Door `RTTI Type Descriptor'
PUBLIC	??_R3Raven_Door@@8				; Raven_Door::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2Raven_Door@@8				; Raven_Door::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@Raven_Door@@8			; Raven_Door::`RTTI Base Class Descriptor at (0,-1,0,64)'
...
PUBLIC	?Update@Raven_Door@@UAEXXZ			; Raven_Door::Update
PUBLIC	?Render@Raven_Door@@UAEXXZ			; Raven_Door::Render
PUBLIC	?HandleMessage@Raven_Door@@UAE_NABUTelegram@@@Z	; Raven_Door::HandleMessage
PUBLIC	?Write@BaseGameEntity@@UBEXAAV?$basic_ostream@DU?$char_traits@D@std@@@std@@@Z ; BaseGameEntity::Write
EXTRN	?AddWall@Raven_Map@@QAEPAVWall2D@@UVector2D@@0@Z:PROC ; Raven_Map::AddWall
...
EXTRN	??_ERaven_Door@@UAEPAXI@Z:PROC			; Raven_Door::`vector deleting destructor'
;	COMDAT ??_R2BaseGameEntity@@8
; File d:\code\ai source\latest vc6-vc10\vs2010\buckland_chapter7 to 10_raven\raven_door.cpp
rdata$r	SEGMENT
...
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@Raven_Door@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@Raven_Door@@8 DD FLAT:??_R0?AVRaven_Door@@@8 ; Raven_Door::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	01H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3Raven_Door@@8
rdata$r	ENDS
;	COMDAT ??_R2Raven_Door@@8
rdata$r	SEGMENT
??_R2Raven_Door@@8 DD FLAT:??_R1A@?0A@EA@Raven_Door@@8	; Raven_Door::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@BaseGameEntity@@8
rdata$r	ENDS
;	COMDAT ??_R3Raven_Door@@8
rdata$r	SEGMENT
??_R3Raven_Door@@8 DD 00H				; Raven_Door::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	02H
	DD	FLAT:??_R2Raven_Door@@8
rdata$r	ENDS
;	COMDAT ??_R0?AVRaven_Door@@@8
_DATA	SEGMENT
??_R0?AVRaven_Door@@@8 DD FLAT:??_7type_info@@6B@	; Raven_Door `RTTI Type Descriptor'
	DD	00H
	DB	'.?AVRaven_Door@@', 00H
_DATA	ENDS
;	COMDAT ??_R4Raven_Door@@6B@
rdata$r	SEGMENT
??_R4Raven_Door@@6B@ DD 00H				; Raven_Door::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AVRaven_Door@@@8
	DD	FLAT:??_R3Raven_Door@@8
rdata$r	ENDS
;	COMDAT ??_7Raven_Door@@6B@
CONST	SEGMENT
??_7Raven_Door@@6B@ DD FLAT:??_R4Raven_Door@@6B@	; Raven_Door::`vftable'
	DD	FLAT:??_ERaven_Door@@UAEPAXI@Z
	DD	FLAT:?Update@Raven_Door@@UAEXXZ
	DD	FLAT:?Render@Raven_Door@@UAEXXZ
	DD	FLAT:?HandleMessage@Raven_Door@@UAE_NABUTelegram@@@Z
	DD	FLAT:?Write@BaseGameEntity@@UBEXAAV?$basic_ostream@DU?$char_traits@D@std@@@std@@@Z
	DD	FLAT:?Read@Raven_Door@@UAEXAAV?$basic_ifstream@DU?$char_traits@D@std@@@std@@@Z
CONST	ENDS
xdata$x	SEGMENT
__unwindtable$??0Raven_Door@@QAE@PAVRaven_Map@@AAV?$basic_ifstream@DU?$char_traits@D@std@@@std@@@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$??0Raven_Door@@QAE@PAVRaven_Map@@AAV?$basic_ifstream@DU?$char_traits@D@std@@@std@@@Z$0
	DD	00H
	DD	FLAT:__unwindfunclet$??0Raven_Door@@QAE@PAVRaven_Map@@AAV?$basic_ifstream@DU?$char_traits@D@std@@@std@@@Z$1
__ehfuncinfo$??0Raven_Door@@QAE@PAVRaven_Map@@AAV?$basic_ifstream@DU?$char_traits@D@std@@@std@@@Z DD 019930522H
	DD	02H
	DD	FLAT:__unwindtable$??0Raven_Door@@QAE@PAVRaven_Map@@AAV?$basic_ifstream@DU?$char_traits@D@std@@@std@@@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
...
_pMap$ = 8						; size = 4
_is$ = 12						; size = 4
??0Raven_Door@@QAE@PAVRaven_Map@@AAV?$basic_ifstream@DU?$char_traits@D@std@@@std@@@Z PROC ; Raven_Door::Raven_Door
; _this$ = ecx
...
; 17   : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$??0Raven_Door@@QAE@PAVRaven_Map@@AAV?$basic_ifstream@DU?$char_traits@D@std@@@std@@@Z
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx], OFFSET ??_7Raven_Door@@6B@
	...
	mov	DWORD PTR [eax+96], 60			; 0000003cH
	mov	ecx, DWORD PTR _this$[ebp]
...
; 18   :   Read(is);
	...
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Read@Raven_Door@@UAEXAAV?$basic_ifstream@DU?$char_traits@D@std@@@std@@@Z ; Raven_Door::Read

; 19   : 
; 20   :   m_vtoP2Norm =  Vec2DNormalize(m_vP2 - m_vP1);
...
; 21   :   m_dCurrentSize = m_dSize = Vec2DDistance(m_vP2, m_vP1);
...
; 22   : 
; 23   :   Vector2D perp = m_vtoP2Norm.Perp();

	lea	edx, DWORD PTR _perp$[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 144				; 00000090H
...
; 24   :   
; 25   :   //create the walls that make up the door's geometry
; 26   :   m_pWall1 = pMap->AddWall(m_vP1+perp, m_vP2+perp);

	lea	eax, DWORD PTR _perp$[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 120				; 00000078H
	push	ecx
	lea	edx, DWORD PTR $T146829[ebp]
	push	edx
	...
	mov	eax, DWORD PTR [eax+12]
	mov	DWORD PTR [ecx+12], eax
	lea	ecx, DWORD PTR _perp$[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	add	edx, 104				; 00000068H
	push	edx
	lea	eax, DWORD PTR $T146830[ebp]
	push	eax
	call	??H@YA?AUVector2D@@ABU0@0@Z		; operator+
	add	esp, -4					; fffffffcH
	mov	ecx, esp
	...
	call	?AddWall@Raven_Map@@QAEPAVWall2D@@UVector2D@@0@Z ; Raven_Map::AddWall
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+68], eax

; 27   :   m_pWall2 = pMap->AddWall(m_vP2-perp, m_vP1-perp);
...
; 28   : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN8@Raven_Door
...
_TEXT	ENDS
text$x	SEGMENT
__unwindfunclet$??0Raven_Door@@QAE@PAVRaven_Map@@AAV?$basic_ifstream@DU?$char_traits@D@std@@@std@@@Z$0:
	mov	ecx, DWORD PTR _this$[ebp]
	jmp	??1BaseGameEntity@@UAE@XZ		; BaseGameEntity::~BaseGameEntity
__unwindfunclet$??0Raven_Door@@QAE@PAVRaven_Map@@AAV?$basic_ifstream@DU?$char_traits@D@std@@@std@@@Z$1:
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 76					; 0000004cH
...
__ehhandler$??0Raven_Door@@QAE@PAVRaven_Map@@AAV?$basic_ifstream@DU?$char_traits@D@std@@@std@@@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-140]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$??0Raven_Door@@QAE@PAVRaven_Map@@AAV?$basic_ifstream@DU?$char_traits@D@std@@@std@@@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
??0Raven_Door@@QAE@PAVRaven_Map@@AAV?$basic_ifstream@DU?$char_traits@D@std@@@std@@@Z ENDP ; Raven_Door::Raven_Door
PUBLIC	__real@0000000000000000
;	COMDAT __real@0000000000000000
; File d:\code\ai source\latest vc6-vc10\vs2010\common\2d\vector2d.h
CONST	SEGMENT
...
; File d:\program files (x86)\vs2010\vc\include\limits
CONST	SEGMENT
...
; File d:\code\ai source\latest vc6-vc10\vs2010\common\game\basegameentity.h
rdata$r	SEGMENT
...
_TEXT	ENDS
PUBLIC	??1Raven_Door@@UAE@XZ				; Raven_Door::~Raven_Door
; Function compile flags: /Odtp /RTCsu
;	COMDAT ??_GRaven_Door@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_GRaven_Door@@UAEPAXI@Z PROC				; Raven_Door::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	push	ecx
	...
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	??1Raven_Door@@UAE@XZ			; Raven_Door::~Raven_Door
	mov	eax, DWORD PTR ___flags$[ebp]
	and	eax, 1
...
$LN1@scalar@2:
	...
	pop	ebp
	ret	4
??_GRaven_Door@@UAEPAXI@Z ENDP				; Raven_Door::`scalar deleting destructor'
_TEXT	ENDS
xdata$x	SEGMENT
__unwindtable$??1Raven_Door@@UAE@XZ DD 0ffffffffH
	DD	FLAT:__unwindfunclet$??1Raven_Door@@UAE@XZ$0
__ehfuncinfo$??1Raven_Door@@UAE@XZ DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$??1Raven_Door@@UAE@XZ
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
...
_this$ = -16						; size = 4
__$EHRec$ = -12						; size = 12
??1Raven_Door@@UAE@XZ PROC				; Raven_Door::~Raven_Door
; _this$ = ecx
...
; 33   : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$??1Raven_Door@@UAE@XZ
	mov	eax, DWORD PTR fs:0
	push	eax
	push	ecx
	...
	mov	DWORD PTR _this$[ebp], ecx
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7Raven_Door@@6B@
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
_TEXT	ENDS
text$x	SEGMENT
__unwindfunclet$??1Raven_Door@@UAE@XZ$0:
	mov	ecx, DWORD PTR _this$[ebp]
	jmp	??1BaseGameEntity@@UAE@XZ		; BaseGameEntity::~BaseGameEntity
__ehhandler$??1Raven_Door@@UAE@XZ:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-8]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$??1Raven_Door@@UAE@XZ
	jmp	___CxxFrameHandler3
text$x	ENDS
??1Raven_Door@@UAE@XZ ENDP				; Raven_Door::~Raven_Door
PUBLIC	?Close@Raven_Door@@IAEXXZ			; Raven_Door::Close
PUBLIC	?Open@Raven_Door@@IAEXXZ			; Raven_Door::Open
; Function compile flags: /Odtp /RTCsu
_TEXT	SEGMENT
tv73 = -12						; size = 4
tv65 = -8						; size = 4
_this$ = -4						; size = 4
?Update@Raven_Door@@UAEXXZ PROC				; Raven_Door::Update
; _this$ = ecx
...
; 44   :       Open(); break;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Open@Raven_Door@@IAEXXZ		; Raven_Door::Open
	jmp	SHORT $LN7@Update
$LN3@Update:
...
; 48   :       Close(); break;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Close@Raven_Door@@IAEXXZ		; Raven_Door::Close
	jmp	SHORT $LN7@Update
$LN2@Update:
...
; 50   :   case open:
; 51   :     {
; 52   :       if (m_iNumTicksCurrentlyOpen-- < 0)
...
; 60   : }
	...
	pop	ebp
	ret	0
?Update@Raven_Door@@UAEXXZ ENDP				; Raven_Door::Update
_TEXT	ENDS
PUBLIC	?SetTo@Wall2D@@QAEXUVector2D@@@Z		; Wall2D::SetTo
PUBLIC	?SetFrom@Wall2D@@QAEXUVector2D@@@Z		; Wall2D::SetFrom
PUBLIC	?ChangePosition@Raven_Door@@IAEXUVector2D@@0@Z	; Raven_Door::ChangePosition
; Function compile flags: /Odtp /RTCsu
_TEXT	SEGMENT
$T146919 = -132						; size = 16
$T146918 = -116						; size = 16
...
_newP1$ = 8						; size = 16
_newP2$ = 24						; size = 16
?ChangePosition@Raven_Door@@IAEXUVector2D@@0@Z PROC	; Raven_Door::ChangePosition
; _this$ = ecx
...
; 65   :   m_vP1 = newP1;
	...
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 104				; 00000068H
	mov	ecx, DWORD PTR _newP1$[ebp]
	mov	DWORD PTR [eax], ecx
	mov	edx, DWORD PTR _newP1$[ebp+4]
	mov	DWORD PTR [eax+4], edx
	mov	ecx, DWORD PTR _newP1$[ebp+8]
	mov	DWORD PTR [eax+8], ecx
	mov	edx, DWORD PTR _newP1$[ebp+12]
...
; 66   :   m_vP2 = newP2;
	...
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 120				; 00000078H
	mov	ecx, DWORD PTR _newP2$[ebp]
	mov	DWORD PTR [eax], ecx
	mov	edx, DWORD PTR _newP2$[ebp+4]
	mov	DWORD PTR [eax+4], edx
	mov	ecx, DWORD PTR _newP2$[ebp+8]
	mov	DWORD PTR [eax+8], ecx
	mov	edx, DWORD PTR _newP2$[ebp+12]
	mov	DWORD PTR [eax+12], edx

; 67   : 
; 68   :   m_pWall1->SetFrom(m_vP1 + m_vtoP2Norm.Perp());

	lea	eax, DWORD PTR $T146912[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 144				; 00000090H
	call	?Perp@Vector2D@@QBE?AU1@XZ		; Vector2D::Perp
	...
	call	?SetFrom@Wall2D@@QAEXUVector2D@@@Z	; Wall2D::SetFrom

; 69   :   m_pWall1->SetTo(m_vP2 + m_vtoP2Norm.Perp());
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [ecx+68]
	call	?SetTo@Wall2D@@QAEXUVector2D@@@Z	; Wall2D::SetTo

; 70   : 
; 71   :   m_pWall2->SetFrom(m_vP2 - m_vtoP2Norm.Perp());

	lea	edx, DWORD PTR $T146916[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 144				; 00000090H
	call	?Perp@Vector2D@@QBE?AU1@XZ		; Vector2D::Perp
...
; 72   :   m_pWall2->SetTo(m_vP1 - m_vtoP2Norm.Perp());

	lea	edx, DWORD PTR $T146918[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 144				; 00000090H
	call	?Perp@Vector2D@@QBE?AU1@XZ		; Vector2D::Perp
...
; 73   : }
	...
	pop	ebp
	ret	32					; 00000020H
?ChangePosition@Raven_Door@@IAEXUVector2D@@0@Z ENDP	; Raven_Door::ChangePosition
_TEXT	ENDS
PUBLIC	?CalculateNormal@Wall2D@@IAEXXZ			; Wall2D::CalculateNormal
; Function compile flags: /Odtp /RTCsu
; File d:\code\ai source\latest vc6-vc10\vs2010\common\2d\wall2d.h
;	COMDAT ?SetFrom@Wall2D@@QAEXUVector2D@@@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_v$ = 8							; size = 16
?SetFrom@Wall2D@@QAEXUVector2D@@@Z PROC			; Wall2D::SetFrom, COMDAT
; _this$ = ecx

; 64   :   void     SetFrom(Vector2D v){m_vA = v; CalculateNormal();}
	...
	mov	DWORD PTR [eax+12], edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?CalculateNormal@Wall2D@@IAEXXZ		; Wall2D::CalculateNormal
	add	esp, 4
	cmp	ebp, esp
	call	__RTC_CheckEsp
	mov	esp, ebp
	pop	ebp
	ret	16					; 00000010H
?SetFrom@Wall2D@@QAEXUVector2D@@@Z ENDP			; Wall2D::SetFrom
; Function compile flags: /Odtp /RTCsu
_TEXT	ENDS
;	COMDAT ?CalculateNormal@Wall2D@@IAEXXZ
_TEXT	SEGMENT
$T146923 = -44						; size = 16
_temp$ = -24						; size = 16
_this$ = -4						; size = 4
?CalculateNormal@Wall2D@@IAEXXZ PROC			; Wall2D::CalculateNormal, COMDAT
; _this$ = ecx
...
; 29   :     Vector2D temp = Vec2DNormalize(m_vB - m_vA);
...
; 33   :   }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN5@CalculateN
	call	@_RTC_CheckStackVars@8
	pop	eax
	pop	edx
	pop	edi
...
$LN3@CalculateN:
	...
	DB	112					; 00000070H
	DB	0
?CalculateNormal@Wall2D@@IAEXXZ ENDP			; Wall2D::CalculateNormal
; Function compile flags: /Odtp /RTCsu
_TEXT	ENDS
;	COMDAT ?SetTo@Wall2D@@QAEXUVector2D@@@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_v$ = 8							; size = 16
?SetTo@Wall2D@@QAEXUVector2D@@@Z PROC			; Wall2D::SetTo, COMDAT
; _this$ = ecx

; 67   :   void     SetTo(Vector2D v){m_vB = v; CalculateNormal();}
	...
	pop	ebp
	ret	16					; 00000010H
?SetTo@Wall2D@@QAEXUVector2D@@@Z ENDP			; Wall2D::SetTo
_TEXT	ENDS
PUBLIC	??D@YA?AUVector2D@@ABU0@N@Z			; operator*
PUBLIC	??$Clamp@NHN@@YAXAANABHABN@Z			; Clamp<double,int,double>
...
$T146931 = -8						; size = 4
_this$ = -4						; size = 4
?Open@Raven_Door@@IAEXXZ PROC				; Raven_Door::Open
; _this$ = ecx
...
; 79   :   {
; 80   :     if (m_dCurrentSize < 2)

	mov	ecx, DWORD PTR _this$[ebp]
	fld	QWORD PTR __real@4000000000000000
	fcomp	QWORD PTR [ecx+160]
	fnstsw	ax
...
; 83   : 
; 84   :       m_iNumTicksCurrentlyOpen = m_iNumTicksStayOpen;
...
; 92   : 
; 93   :     Clamp(m_dCurrentSize, 0, m_dSize);

	mov	DWORD PTR $T146931[ebp], 0
	mov	edx, DWORD PTR _this$[ebp]
	add	edx, 136				; 00000088H
	push	edx
	lea	eax, DWORD PTR $T146931[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 160				; 000000a0H
	push	ecx
	call	??$Clamp@NHN@@YAXAANABHABN@Z		; Clamp<double,int,double>
	add	esp, 12					; 0000000cH

; 94   : 
; 95   :     ChangePosition(m_vP1, m_vP1 + m_vtoP2Norm * m_dCurrentSize);
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?ChangePosition@Raven_Door@@IAEXUVector2D@@0@Z ; Raven_Door::ChangePosition
$LN2@Open:
$LN3@Open:
...
; 98   : }
	...
	pop	ebp
	ret	0
?Open@Raven_Door@@IAEXXZ ENDP				; Raven_Door::Open
_TEXT	ENDS
...
$T146946 = -8						; size = 4
_this$ = -4						; size = 4
?Close@Raven_Door@@IAEXXZ PROC				; Raven_Door::Close
; _this$ = ecx
...
; 111  :     }
; 112  : 
; 113  :     //reduce the current size
; 114  :     m_dCurrentSize += 1;

	mov	ecx, DWORD PTR _this$[ebp]
	fld	QWORD PTR [ecx+160]
	fadd	QWORD PTR __real@3ff0000000000000
	mov	edx, DWORD PTR _this$[ebp]
	fstp	QWORD PTR [edx+160]

; 115  : 
; 116  :     Clamp(m_dCurrentSize, 0, m_dSize);

	mov	DWORD PTR $T146946[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 136				; 00000088H
	push	eax
	lea	ecx, DWORD PTR $T146946[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
...
; 117  : 
; 118  :     ChangePosition(m_vP1, m_vP1 + m_vtoP2Norm * m_dCurrentSize);
...
; 121  : }
	...
	pop	ebp
	ret	0
?Close@Raven_Door@@IAEXXZ ENDP				; Raven_Door::Close
_TEXT	ENDS
...
PUBLIC	??$find@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@I@std@@YA?AV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@V10@0ABI@Z ; std::find<std::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > >,unsigned int>
...
PUBLIC	?AddSwitch@Raven_Door@@QAEXI@Z			; Raven_Door::AddSwitch
xdata$x	SEGMENT
__unwindtable$?AddSwitch@Raven_Door@@QAEXI@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?AddSwitch@Raven_Door@@QAEXI@Z$0
	DD	00H
	DD	FLAT:__unwindfunclet$?AddSwitch@Raven_Door@@QAEXI@Z$1
	DD	00H
	DD	FLAT:__unwindfunclet$?AddSwitch@Raven_Door@@QAEXI@Z$3
__ehfuncinfo$?AddSwitch@Raven_Door@@QAEXI@Z DD 019930522H
	DD	03H
	DD	FLAT:__unwindtable$?AddSwitch@Raven_Door@@QAEXI@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
...
__$EHRec$ = -12						; size = 12
_id$ = 8						; size = 4
?AddSwitch@Raven_Door@@QAEXI@Z PROC			; Raven_Door::AddSwitch
; _this$ = ecx
...
; 128  : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$?AddSwitch@Raven_Door@@QAEXI@Z
	mov	eax, DWORD PTR fs:0
	push	eax
...
; 129  :   //only add the trigger if it isn't already present
; 130  :   if (std::find(m_Switches.begin(),
; 131  :                 m_Switches.end(),
; 132  :                 id) == m_Switches.end())

	lea	eax, DWORD PTR $T146954[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 76					; 0000004cH
	...
	lea	ecx, DWORD PTR $T146953[ebp]
	push	ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	call	??$find@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@I@std@@YA?AV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@V10@0ABI@Z ; std::find<std::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > >,unsigned int>
	add	esp, 32					; 00000020H
	...
	mov	BYTE PTR $T146950[ebp], al
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T146953[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAE@XZ
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR $T146954[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAE@XZ
	movzx	eax, BYTE PTR $T146950[ebp]
	test	eax, eax
	je	SHORT $LN2@AddSwitch

; 133  :   {
; 134  :     m_Switches.push_back(id);
...
_TEXT	ENDS
text$x	SEGMENT
__unwindfunclet$?AddSwitch@Raven_Door@@QAEXI@Z$0:
	lea	ecx, DWORD PTR $T146954[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAE@XZ
__unwindfunclet$?AddSwitch@Raven_Door@@QAEXI@Z$1:
	mov	ecx, DWORD PTR $T146951[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAE@XZ
__unwindfunclet$?AddSwitch@Raven_Door@@QAEXI@Z$3:
	lea	ecx, DWORD PTR $T146953[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAE@XZ
__ehhandler$?AddSwitch@Raven_Door@@QAEXI@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-76]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?AddSwitch@Raven_Door@@QAEXI@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
?AddSwitch@Raven_Door@@QAEXI@Z ENDP			; Raven_Door::AddSwitch
...
;	COMDAT xdata$x
; File d:\program files (x86)\vs2010\vc\include\xutility
xdata$x	SEGMENT
...
PUBLIC	??_C@_1GE@LJIHIIPK@?$AAD?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAV?$AAS?$AA2?$AA0?$AA1?$AA0?$AA?2?$AAV?$AAC@ ; `string'
...
CONST	ENDS
;	COMDAT ??_C@_1GE@LJIHIIPK@?$AAD?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAV?$AAS?$AA2?$AA0?$AA1?$AA0?$AA?2?$AAV?$AAC@
CONST	SEGMENT
??_C@_1GE@LJIHIIPK@?$AAD?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAV?$AAS?$AA2?$AA0?$AA1?$AA0?$AA?2?$AAV?$AAC@ DB 'D'
	DB	00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H, 'g', 00H
	DB	'r', 00H, 'a', 00H, 'm', 00H, ' ', 00H, 'F', 00H, 'i', 00H, 'l'
	DB	00H, 'e', 00H, 's', 00H, ' ', 00H, '(', 00H, 'x', 00H, '8', 00H
	DB	'6', 00H, ')', 00H, '\', 00H, 'V', 00H, 'S', 00H, '2', 00H, '0'
	DB	00H, '1', 00H, '0', 00H, '\', 00H, 'V', 00H, 'C', 00H, '\', 00H
...
; 181  : 				_DEBUG_ERROR("ITERATOR LIST CORRUPTED!");
	...
	push	181					; 000000b5H
	push	OFFSET ??_C@_1GE@LJIHIIPK@?$AAD?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAV?$AAS?$AA2?$AA0?$AA1?$AA0?$AA?2?$AAV?$AAC@
...
_this$ = -4						; size = 4
_os$ = 8						; size = 4
?Read@Raven_Door@@UAEXAAV?$basic_ifstream@DU?$char_traits@D@std@@@std@@@Z PROC ; Raven_Door::Read
; _this$ = ecx
...
; 150  : 
; 151  :   //grab the number of triggers
; 152  :   int num, trig;
; 153  : 
; 154  :   os >> num;
...
; 155  : 
; 156  :   //save the trigger IDs
; 157  :   for (int i=0; i<num; ++i)

	mov	DWORD PTR _i$137846[ebp], 0
	jmp	SHORT $LN3@Read
$LN2@Read:
	mov	edx, DWORD PTR _i$137846[ebp]
	add	edx, 1
	mov	DWORD PTR _i$137846[ebp], edx
$LN3@Read:
	mov	eax, DWORD PTR _i$137846[ebp]
...
; 160  : 
; 161  :     m_Switches.push_back(trig);

	mov	edx, DWORD PTR _trig$[ebp]
	mov	DWORD PTR $T146989[ebp], edx
	lea	eax, DWORD PTR $T146989[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 76					; 0000004cH
	call	?push_back@?$vector@IV?$allocator@I@std@@@std@@QAEXABI@Z ; std::vector<unsigned int,std::allocator<unsigned int> >::push_back
...
$LN6@Read:
	DB	120					; 00000078H
	DB	0
?Read@Raven_Door@@UAEXAAV?$basic_ifstream@DU?$char_traits@D@std@@@std@@@Z ENDP ; Raven_Door::Read
; Function compile flags: /Odtp /RTCsu
_this$ = -4						; size = 4
_msg$ = 8						; size = 4
?HandleMessage@Raven_Door@@UAE_NABUTelegram@@@Z PROC	; Raven_Door::HandleMessage
; _this$ = ecx
...
; 180  : }
	...
	pop	ebp
	ret	4
?HandleMessage@Raven_Door@@UAE_NABUTelegram@@@Z ENDP	; Raven_Door::HandleMessage
_TEXT	ENDS
...
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Render@Raven_Door@@UAEXXZ PROC				; Raven_Door::Render
; _this$ = ecx
...
; 189  : }
	...
	pop	ebp
	ret	0
?Render@Raven_Door@@UAEXXZ ENDP				; Raven_Door::Render
_TEXT	ENDS
EXTRN	__imp__SelectObject@8:PROC
; Function compile flags: /Odtp /RTCsu
; File d:\code\ai source\latest vc6-vc10\vs2010\common\misc\cgdi.h
...
;	COMDAT xdata$x
; File d:\program files (x86)\vs2010\vc\include\istream
xdata$x	SEGMENT
...
$T147007 = -76						; size = 8
$T147004 = -68						; size = 4
__Nget_fac$138567 = -64					; size = 4
__Tmp$138566 = -56					; size = 4
__Ok$ = -44						; size = 8
__State$ = -28						; size = 4
_this$ = -20						; size = 4
__$EHRec$ = -16						; size = 16
...
; 279  : 			long _Tmp = 0;
	...
	mov	DWORD PTR __Tmp$138566[ebp], 0

; 280  : 			const _Nget& _Nget_fac = _USE(ios_base::getloc(), _Nget);

	lea	ecx, DWORD PTR $T147004[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	...
	add	esp, 4
	mov	DWORD PTR __Nget_fac$138567[ebp], eax
...
$LN9@operator@4:
	...
	lea	eax, DWORD PTR __Tmp$138566[ebp]
	push	eax
	...
	push	eax
	lea	ecx, DWORD PTR $T147008[ebp]
	call	??0?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@QAE@PAV?$basic_streambuf@DU?$char_traits@D@std@@@1@@Z ; std::istreambuf_iterator<char,std::char_traits<char> >::istreambuf_iterator<char,std::char_traits<char> >
	mov	ecx, DWORD PTR [eax+4]
	push	ecx
	mov	edx, DWORD PTR [eax]
	push	edx
	lea	eax, DWORD PTR $T147009[ebp]
	push	eax
	mov	ecx, DWORD PTR __Nget_fac$138567[ebp]
...
; 288  : 				|| _Tmp < INT_MIN || INT_MAX < _Tmp)
	...
	cmp	DWORD PTR __Tmp$138566[ebp], -2147483648 ; 80000000H
	jl	SHORT $LN2@operator@4
	cmp	DWORD PTR __Tmp$138566[ebp], 2147483647	; 7fffffffH
	jle	SHORT $LN3@operator@4
$LN2@operator@4:
...
; 291  : 				_Val = _Tmp;
	...
	mov	eax, DWORD PTR __Tmp$138566[ebp]
	mov	DWORD PTR [edx], eax
$LN5@operator@4:
...
; Function compile flags: /Odtp /RTCsu
; File d:\program files (x86)\vs2010\vc\include\xlocale
...
; 120  : 			_BEGIN_LOCK(_LOCK_LOCALE)
	...
	push	0
	lea	ecx, DWORD PTR __Lock$117034[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
...
; 123  : 				return (_Refs == 0 ? this : 0);
	...
	mov	DWORD PTR $T147035[ebp], eax
	lea	ecx, DWORD PTR __Lock$117034[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T147035[ebp]
...
; Function compile flags: /Odtp /RTCsu
; File d:\program files (x86)\vs2010\vc\include\xiosbase
...
; 452  : 		return (*_Ploc);
	...
	mov	edx, DWORD PTR $T147043[ebp]
	or	edx, 1
	mov	DWORD PTR $T147043[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 112  : 			_BEGIN_LOCK(_LOCK_LOCALE)
	...
	push	0
	lea	ecx, DWORD PTR __Lock$117029[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
...
; Function compile flags: /Odtp /RTCsu
; File d:\program files (x86)\vs2010\vc\include\ios
...
; 417  : 			const _Nget& _Nget_fac = _USE(ios_base::getloc(), _Nget);
	...
	call	??$use_facet@V?$num_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@@std@@YAABV?$num_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@0@ABVlocale@0@@Z ; std::use_facet<std::num_get<char,std::istreambuf_iterator<char,std::char_traits<char> > > >
	add	esp, 4
	mov	DWORD PTR __Nget_fac$138838[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+12], 0
	lea	ecx, DWORD PTR $T147064[ebp]
	call	??1locale@std@@QAE@XZ			; std::locale::~locale
...
$LN6@operator@5:
	...
	push	eax
	lea	ecx, DWORD PTR $T147068[ebp]
	call	??0?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@QAE@PAV?$basic_streambuf@DU?$char_traits@D@std@@@1@@Z ; std::istreambuf_iterator<char,std::char_traits<char> >::istreambuf_iterator<char,std::char_traits<char> >
	mov	ecx, DWORD PTR [eax+4]
	push	ecx
	mov	edx, DWORD PTR [eax]
	push	edx
	lea	eax, DWORD PTR $T147069[ebp]
	push	eax
	mov	ecx, DWORD PTR __Nget_fac$138838[ebp]
...
; 426  : 		return (*this);
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T147070[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+12], -1
	lea	ecx, DWORD PTR __Ok$[ebp]
	call	??1sentry@?$basic_istream@DU?$char_traits@D@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR $T147070[ebp]
...
; Function compile flags: /Odtp /RTCsu
; File d:\program files (x86)\vs2010\vc\include\vector
...
; 782  : 		return (iterator(this->_Myfirst, this));
	...
	mov	eax, DWORD PTR $T147119[ebp]
	or	eax, 1
	mov	DWORD PTR $T147119[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 792  : 		return (iterator(this->_Mylast, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAE@PAIPBU_Container_base12@1@@Z ; std::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > >::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > >
	mov	eax, DWORD PTR $T147124[ebp]
	or	eax, 1
	mov	DWORD PTR $T147124[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
PUBLIC	??$_Cons_val@V?$allocator@I@std@@IAAI@std@@YAXAAV?$allocator@I@0@PAIAAI@Z ; std::_Cons_val<std::allocator<unsigned int>,unsigned int,unsigned int &>
...
; 979  : 			size_type _Idx = _STD addressof(_Val) - this->_Myfirst;
	...
	sar	eax, 2
	mov	DWORD PTR __Idx$139362[ebp], eax
...
; 985  : 				this->_Myfirst[_Idx]);
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+4]
	mov	edx, DWORD PTR __Idx$139362[ebp]
	...
	push	eax
	call	??$_Cons_val@V?$allocator@I@std@@IAAI@std@@YAXAAV?$allocator@I@0@PAIAAI@Z ; std::_Cons_val<std::allocator<unsigned int>,unsigned int,unsigned int &>
	add	esp, 12					; 0000000cH
...
; 319  : 			_THROW_NCEE(failure, "ios_base::failbit set");
	...
	push	1
	lea	edx, DWORD PTR $T147140[ebp]
	push	edx
	call	?make_error_code@std@@YA?AVerror_code@1@W4io_errc@31@@Z ; std::make_error_code
	add	esp, 8
	push	eax
	push	OFFSET ??_C@_0BG@FMKFHCIL@ios_base?3?3failbit?5set?$AA@
	lea	ecx, DWORD PTR $T147139[ebp]
	call	??0failure@ios_base@std@@QAE@PBDABVerror_code@2@@Z ; std::ios_base::failure::failure
	push	OFFSET __TI4?AVfailure@ios_base@std@@
	lea	eax, DWORD PTR $T147139[ebp]
	push	eax
	call	__CxxThrowException@8
...
; 321  : 			_THROW_NCEE(failure, "ios_base::eofbit set");
	...
	push	1
	lea	ecx, DWORD PTR $T147142[ebp]
	push	ecx
	call	?make_error_code@std@@YA?AVerror_code@1@W4io_errc@31@@Z ; std::make_error_code
	add	esp, 8
	push	eax
	push	OFFSET ??_C@_0BF@OOHOMBOF@ios_base?3?3eofbit?5set?$AA@
	lea	ecx, DWORD PTR $T147141[ebp]
	call	??0failure@ios_base@std@@QAE@PBDABVerror_code@2@@Z ; std::ios_base::failure::failure
	push	OFFSET __TI4?AVfailure@ios_base@std@@
	lea	edx, DWORD PTR $T147141[ebp]
	push	edx
	call	__CxxThrowException@8
$LN10@clear@2:
...
; Function compile flags: /Odtp /RTCsu
; File d:\program files (x86)\vs2010\vc\include\system_error
...
; Function compile flags: /Odtp /RTCsu
; File d:\program files (x86)\vs2010\vc\include\stdexcept
...
$T147191 = -44						; size = 4
$T147190 = -40						; size = 4
__Meta$140107 = -32					; size = 4
__Ctype_fac$140103 = -24				; size = 4
_this$ = -20						; size = 4
__$EHRec$ = -16						; size = 16
__Noskip$ = 8						; size = 1
...
; 124  : 				const _Ctype& _Ctype_fac = _USE(ios_base::getloc(), _Ctype);
	...
	add	esp, 4
	mov	DWORD PTR __Ctype_fac$140103[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+12], -1
	lea	ecx, DWORD PTR $T147190[ebp]
	call	??1locale@std@@QAE@XZ			; std::locale::~locale
...
; 127  : 				int_type _Meta = _Myios::rdbuf()->sgetc();
	...
	mov	DWORD PTR __Meta$140107[ebp], ecx
	jmp	SHORT $LN7@Ipfx
$LN6@Ipfx:
...
; 130  : 					if (_Traits::eq_int_type(_Traits::eof(), _Meta))
	...
	mov	DWORD PTR $T147191[ebp], edx
	lea	eax, DWORD PTR __Meta$140107[ebp]
	push	eax
	lea	ecx, DWORD PTR $T147191[ebp]
	push	ecx
...
; 136  : 						_Traits::to_char_type(_Meta)))
	...
	push	ecx
	push	72					; 00000048H
	mov	ecx, DWORD PTR __Ctype_fac$140103[ebp]
...
; Function compile flags: /Odtp /RTCsu
; File d:\program files (x86)\vs2010\vc\include\iosfwd
...
; Function compile flags: /Odtp /RTCsu
; File d:\program files (x86)\vs2010\vc\include\ostream
...
; Function compile flags: /Odtp /RTCsu
; File d:\program files (x86)\vs2010\vc\include\streambuf
...
$LN5@snextc:
	...
	mov	DWORD PTR $T147234[ebp], eax
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T147235[ebp], eax
	lea	eax, DWORD PTR $T147234[ebp]
	push	eax
	lea	ecx, DWORD PTR $T147235[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	edx, al
...
; Function compile flags: /Odtp /RTCsu
; File d:\program files (x86)\vs2010\vc\include\xmemory
...
PUBLIC	??_C@_1GA@JFAPKHCO@?$AAD?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAV?$AAS?$AA2?$AA0?$AA1?$AA0?$AA?2?$AAV?$AAC@ ; `string'
...
CONST	ENDS
;	COMDAT ??_C@_1GA@JFAPKHCO@?$AAD?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAV?$AAS?$AA2?$AA0?$AA1?$AA0?$AA?2?$AAV?$AAC@
CONST	SEGMENT
??_C@_1GA@JFAPKHCO@?$AAD?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAV?$AAS?$AA2?$AA0?$AA1?$AA0?$AA?2?$AAV?$AAC@ DB 'D'
	DB	00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H, 'g', 00H
	DB	'r', 00H, 'a', 00H, 'm', 00H, ' ', 00H, 'F', 00H, 'i', 00H, 'l'
	DB	00H, 'e', 00H, 's', 00H, ' ', 00H, '(', 00H, 'x', 00H, '8', 00H
	DB	'6', 00H, ')', 00H, '\', 00H, 'V', 00H, 'S', 00H, '2', 00H, '0'
...
; 238  : 			_DEBUG_ERROR("vector iterators incompatible");
	...
	push	238					; 000000eeH
	push	OFFSET ??_C@_1GA@JFAPKHCO@?$AAD?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAV?$AAS?$AA2?$AA0?$AA1?$AA0?$AA?2?$AAV?$AAC@
...
; Function compile flags: /Odtp /RTCsu
; File d:\program files (x86)\vs2010\vc\include\xlocnum
_TEXT	ENDS
...
_TEXT	SEGMENT
__Size$141228 = -28					; size = 4
__Ptr$141221 = -24					; size = 4
_this$ = -20						; size = 4
__$EHRec$ = -16						; size = 16
__Count$ = 8						; size = 4
...
; 751  : 			pointer _Ptr = this->_Alval.allocate(_Count);
	...
	mov	DWORD PTR __Ptr$141221[ebp], eax
...
; 754  : 			_Umove(this->_Myfirst, this->_Mylast, _Ptr);
	...
	mov	ecx, DWORD PTR __Ptr$141221[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+8]
	push	eax
...
; 760  : 			size_type _Size = size();
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?size@?$vector@IV?$allocator@I@std@@@std@@QBEIXZ ; std::vector<unsigned int,std::allocator<unsigned int> >::size
	mov	DWORD PTR __Size$141228[ebp], eax
...
; 770  : 			this->_Mylast = _Ptr + _Size;
	...
	mov	ecx, DWORD PTR __Size$141228[ebp]
	mov	edx, DWORD PTR __Ptr$141221[ebp]
...
; 771  : 			this->_Myfirst = _Ptr;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR __Ptr$141221[ebp]
	mov	DWORD PTR [edx+4], eax
$LN7@reserve:
...
EXTRN	_free:PROC
; Function compile flags: /Odtp /RTCsu
; File d:\program files (x86)\vs2010\vc\include\xdebug
...
$T147420 = -64						; size = 4
$T147419 = -60						; size = 12
__Pfmod$142407 = -48					; size = 4
__Pf$142391 = -44					; size = 4
__Id$142390 = -40					; size = 4
__Psave$142378 = -32					; size = 4
__Lock$142377 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$142377[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$142378[ebp], eax
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$142378[ebp], 0
	je	SHORT $LN4@use_facet

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	edx, DWORD PTR __Psave$142378[ebp]
	mov	DWORD PTR __Pf$142391[ebp], edx
	jmp	SHORT $LN5@use_facet
$LN4@use_facet:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	push	eax
	lea	ecx, DWORD PTR __Psave$142378[ebp]
	push	ecx
...
; 520  : 			_THROW_NCEE(bad_cast, _EMPTY_ARGUMENT);	// lazy disallowed
	...
	lea	ecx, DWORD PTR $T147419[ebp]
	call	??0bad_cast@std@@QAE@PBD@Z		; std::bad_cast::bad_cast
	push	OFFSET __TI2?AVbad_cast@std@@
	lea	edx, DWORD PTR $T147419[ebp]
	push	edx
	call	__CxxThrowException@8
...
; 528  : 			_Pf = _Psave;
	...
	mov	eax, DWORD PTR __Psave$142378[ebp]
	mov	DWORD PTR __Pf$142391[ebp], eax

; 529  : 			_Facetptr<_Facet>::_Psave = _Psave;

	mov	ecx, DWORD PTR __Psave$142378[ebp]
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	edx, DWORD PTR __Psave$142378[ebp]
	mov	DWORD PTR __Pfmod$142407[ebp], edx

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$142407[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$142391[ebp]
	mov	DWORD PTR $T147420[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$142377[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T147420[ebp]
$LN8@use_facet:
...
; 78   : 				_BEGIN_LOCK(_LOCK_LOCALE)
	...
	push	0
	lea	ecx, DWORD PTR __Lock$117023[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
...
PUBLIC	??_C@_0DB@CHHJGNBI@D?3?2Program?5Files?5?$CIx86?$CJ?2VS2010?2VC@ ; `string'
EXTRN	?_DebugHeapTag_func@std@@YAABU_DebugHeapTag_t@1@XZ:PROC ; std::_DebugHeapTag_func
;	COMDAT ??_C@_0DB@CHHJGNBI@D?3?2Program?5Files?5?$CIx86?$CJ?2VS2010?2VC@
CONST	SEGMENT
??_C@_0DB@CHHJGNBI@D?3?2Program?5Files?5?$CIx86?$CJ?2VS2010?2VC@ DB 'D:\P'
	DB	'rogram Files (x86)\VS2010\VC\include\xlocale', 00H ; `string'
CONST	ENDS
;	COMDAT xdata$x
xdata$x	SEGMENT
...
; 2374 : 				_Locinfo(_Ploc->c_str()));
	...
	push	2373					; 00000945H
	push	OFFSET ??_C@_0DB@CHHJGNBI@D?3?2Program?5Files?5?$CIx86?$CJ?2VS2010?2VC@
	...
	push	eax
	lea	ecx, DWORD PTR $T147452[ebp]
	call	??0_Locinfo@std@@QAE@PBD@Z		; std::_Locinfo::_Locinfo
	mov	DWORD PTR tv138[ebp], eax
	mov	edx, DWORD PTR tv138[ebp]
	mov	DWORD PTR tv133[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	mov	eax, DWORD PTR $T147456[ebp]
	or	eax, 1
	mov	DWORD PTR $T147456[ebp], eax
...
$LN5@Getcat:
	...
	mov	DWORD PTR $T147449[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR __Ppf$[ebp]
	mov	ecx, DWORD PTR $T147449[ebp]
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T147456[ebp]
	and	edx, 1
	je	SHORT $LN1@Getcat
	and	DWORD PTR $T147456[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T147452[ebp]
...
; File d:\program files (x86)\vs2010\vc\include\xlocinfo
xdata$x	SEGMENT
...
; 78   :             _THROW_NCEE(runtime_error, "bad locale name");
	...
	lea	ecx, DWORD PTR $T147468[ebp]
	call	??0runtime_error@std@@QAE@PBD@Z		; std::runtime_error::runtime_error
	push	OFFSET __TI2?AVruntime_error@std@@
	lea	eax, DWORD PTR $T147468[ebp]
	push	eax
	call	__CxxThrowException@8
$LN1@Locinfo:
...
; 118  : 		return (::_Getctype());
	...
	lea	eax, DWORD PTR $T147530[ebp]
	push	eax
	call	__Getctype
	add	esp, 4
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR $T147529[ebp], ecx
	mov	edx, DWORD PTR [eax+4]
	mov	DWORD PTR $T147529[ebp+4], edx
	mov	ecx, DWORD PTR [eax+8]
	mov	DWORD PTR $T147529[ebp+8], ecx
	mov	edx, DWORD PTR [eax+12]
	mov	DWORD PTR $T147529[ebp+12], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	mov	ecx, DWORD PTR $T147529[ebp]
	mov	DWORD PTR [eax], ecx
	mov	edx, DWORD PTR $T147529[ebp+4]
	mov	DWORD PTR [eax+4], edx
	mov	ecx, DWORD PTR $T147529[ebp+8]
	mov	DWORD PTR [eax+8], ecx
	mov	edx, DWORD PTR $T147529[ebp+12]
	mov	DWORD PTR [eax+12], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
PUBLIC	??_C@_1GC@CNLHACHL@?$AAD?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAV?$AAS?$AA2?$AA0?$AA1?$AA0?$AA?2?$AAV?$AAC@ ; `string'
;	COMDAT ??_C@_1GC@CNLHACHL@?$AAD?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAV?$AAS?$AA2?$AA0?$AA1?$AA0?$AA?2?$AAV?$AAC@
CONST	SEGMENT
??_C@_1GC@CNLHACHL@?$AAD?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAV?$AAS?$AA2?$AA0?$AA1?$AA0?$AA?2?$AAV?$AAC@ DB 'D'
	DB	00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H, 'g', 00H
	DB	'r', 00H, 'a', 00H, 'm', 00H, ' ', 00H, 'F', 00H, 'i', 00H, 'l'
	DB	00H, 'e', 00H, 's', 00H, ' ', 00H, '(', 00H, 'x', 00H, '8', 00H
	DB	'6', 00H, ')', 00H, '\', 00H, 'V', 00H, 'S', 00H, '2', 00H, '0'
	DB	00H, '1', 00H, '0', 00H, '\', 00H, 'V', 00H, 'C', 00H, '\', 00H
	DB	'i', 00H, 'n', 00H, 'c', 00H, 'l', 00H, 'u', 00H, 'd', 00H, 'e'
	DB	00H, '\', 00H, 'x', 00H, 'l', 00H, 'o', 00H, 'c', 00H, 'a', 00H
...
; 2419 : 		_DEBUG_RANGE((const _Elem *)_First, _Last);
	...
	push	2419					; 00000973H
	push	OFFSET ??_C@_1GC@CNLHACHL@?$AAD?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAV?$AAS?$AA2?$AA0?$AA1?$AA0?$AA?2?$AAV?$AAC@
	mov	eax, DWORD PTR __Last$[ebp]
	push	eax
...
; 2408 : 			delete[] (void *)_Ctype._Table;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+16]
	mov	DWORD PTR $T147560[ebp], edx
	mov	eax, DWORD PTR $T147560[ebp]
	push	eax
...
; File d:\code\ai source\latest vc6-vc10\vs2010\common\misc\stream_utility_functions.h
CONST	SEGMENT
...
PUBLIC	??_C@_1HK@MEDDGDMC@?$AAD?$AA?3?$AA?2?$AAc?$AAo?$AAd?$AAe?$AA?2?$AAA?$AAI?$AA?5?$AAS?$AAo?$AAu?$AAr?$AAc?$AAe?$AA?2?$AAL?$AAA?$AAT?$AAE?$AAS?$AAT?$AA?5?$AAv?$AAc?$AA6?$AA?9?$AAv?$AAc?$AA1@ ; `string'
...
; File d:\code\ai source\latest vc6-vc10\vs2010\common\misc\utils.h
CONST	SEGMENT
...
CONST	ENDS
;	COMDAT ??_C@_1HK@MEDDGDMC@?$AAD?$AA?3?$AA?2?$AAc?$AAo?$AAd?$AAe?$AA?2?$AAA?$AAI?$AA?5?$AAS?$AAo?$AAu?$AAr?$AAc?$AAe?$AA?2?$AAL?$AAA?$AAT?$AAE?$AAS?$AAT?$AA?5?$AAv?$AAc?$AA6?$AA?9?$AAv?$AAc?$AA1@
CONST	SEGMENT
??_C@_1HK@MEDDGDMC@?$AAD?$AA?3?$AA?2?$AAc?$AAo?$AAd?$AAe?$AA?2?$AAA?$AAI?$AA?5?$AAS?$AAo?$AAu?$AAr?$AAc?$AAe?$AA?2?$AAL?$AAA?$AAT?$AAE?$AAS?$AAT?$AA?5?$AAv?$AAc?$AA6?$AA?9?$AAv?$AAc?$AA1@ DB 'D'
	DB	00H, ':', 00H, '\', 00H, 'c', 00H, 'o', 00H, 'd', 00H, 'e', 00H
	DB	'\', 00H, 'A', 00H, 'I', 00H, ' ', 00H, 'S', 00H, 'o', 00H, 'u'
	DB	00H, 'r', 00H, 'c', 00H, 'e', 00H, '\', 00H, 'L', 00H, 'A', 00H
	DB	'T', 00H, 'E', 00H, 'S', 00H, 'T', 00H, ' ', 00H, 'v', 00H, 'c'
	DB	00H, '6', 00H, '-', 00H, 'v', 00H, 'c', 00H, '1', 00H, '0', 00H
...
; Function compile flags: /Odtp /RTCsu
CONST	ENDS
;	COMDAT ??$Clamp@NHN@@YAXAANABHABN@Z
_TEXT	SEGMENT
_arg$ = 8						; size = 4
_minVal$ = 12						; size = 4
_maxVal$ = 16						; size = 4
??$Clamp@NHN@@YAXAANABHABN@Z PROC			; Clamp<double,int,double>, COMDAT
...
$LN5@Clamp:
	push	175					; 000000afH
	push	OFFSET ??_C@_1HK@MEDDGDMC@?$AAD?$AA?3?$AA?2?$AAc?$AAo?$AAd?$AAe?$AA?2?$AAA?$AAI?$AA?5?$AAS?$AAo?$AAu?$AAr?$AAc?$AAe?$AA?2?$AAL?$AAA?$AAT?$AAE?$AAS?$AAT?$AA?5?$AAv?$AAc?$AA6?$AA?9?$AAv?$AAc?$AA1@
...
; 186  : }
	...
	pop	ebp
	ret	0
??$Clamp@NHN@@YAXAANABHABN@Z ENDP			; Clamp<double,int,double>
_TEXT	ENDS
PUBLIC	??$_Rechecked@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@YAAAV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@AAV10@PAI@Z ; std::_Rechecked<std::_Vector_val<unsigned int,std::allocator<unsigned int> > >
PUBLIC	??$_Find@PAII@std@@YAPAIPAI0ABI@Z		; std::_Find<unsigned int *,unsigned int>
PUBLIC	??$_Unchecked@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@YAPAIV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@@Z ; std::_Unchecked<std::_Vector_val<unsigned int,std::allocator<unsigned int> > >
PUBLIC	??$_Debug_range@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@0PB_WI@Z ; std::_Debug_range<std::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > > >
PUBLIC	??0?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAE@ABV01@@Z ; std::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > >::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > >
PUBLIC	??_C@_1GG@BACILIFO@?$AAD?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAV?$AAS?$AA2?$AA0?$AA1?$AA0?$AA?2?$AAV?$AAC@ ; `string'
;	COMDAT ??_C@_1GG@BACILIFO@?$AAD?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAV?$AAS?$AA2?$AA0?$AA1?$AA0?$AA?2?$AAV?$AAC@
; File d:\program files (x86)\vs2010\vc\include\algorithm
CONST	SEGMENT
??_C@_1GG@BACILIFO@?$AAD?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAV?$AAS?$AA2?$AA0?$AA1?$AA0?$AA?2?$AAV?$AAC@ DB 'D'
	DB	00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H, 'g', 00H
	DB	'r', 00H, 'a', 00H, 'm', 00H, ' ', 00H, 'F', 00H, 'i', 00H, 'l'
	DB	00H, 'e', 00H, 's', 00H, ' ', 00H, '(', 00H, 'x', 00H, '8', 00H
	DB	'6', 00H, ')', 00H, '\', 00H, 'V', 00H, 'S', 00H, '2', 00H, '0'
	DB	00H, '1', 00H, '0', 00H, '\', 00H, 'V', 00H, 'C', 00H, '\', 00H
	DB	'i', 00H, 'n', 00H, 'c', 00H, 'l', 00H, 'u', 00H, 'd', 00H, 'e'
	DB	00H, '\', 00H, 'a', 00H, 'l', 00H, 'g', 00H, 'o', 00H, 'r', 00H
	DB	'i', 00H, 't', 00H, 'h', 00H, 'm', 00H, 00H, 00H ; `string'
CONST	ENDS
;	COMDAT xdata$x
xdata$x	SEGMENT
__unwindtable$??$find@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@I@std@@YA?AV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@V10@0ABI@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$??$find@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@I@std@@YA?AV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@V10@0ABI@Z$6
	DD	00H
	DD	FLAT:__unwindfunclet$??$find@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@I@std@@YA?AV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@V10@0ABI@Z$0
	DD	01H
	DD	FLAT:__unwindfunclet$??$find@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@I@std@@YA?AV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@V10@0ABI@Z$1
	DD	02H
	DD	FLAT:__unwindfunclet$??$find@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@I@std@@YA?AV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@V10@0ABI@Z$2
__ehfuncinfo$??$find@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@I@std@@YA?AV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@V10@0ABI@Z DD 019930522H
	DD	04H
	DD	FLAT:__unwindtable$??$find@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@I@std@@YA?AV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@V10@0ABI@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
; Function compile flags: /Odtp /RTCsu
xdata$x	ENDS
;	COMDAT ??$find@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@I@std@@YA?AV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@V10@0ABI@Z
_TEXT	SEGMENT
tv184 = -60						; size = 4
tv183 = -56						; size = 4
tv180 = -52						; size = 4
...
__Last$ = 24						; size = 12
__Val$ = 36						; size = 4
??$find@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@I@std@@YA?AV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@V10@0ABI@Z PROC ; std::find<std::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > >,unsigned int>, COMDAT
...
; 71   : 	{	// find first matching _Val
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$??$find@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@I@std@@YA?AV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@V10@0ABI@Z
	mov	eax, DWORD PTR fs:0
	push	eax
	...
	lea	eax, DWORD PTR __$EHRec$[ebp]
	mov	DWORD PTR fs:0, eax
	mov	DWORD PTR $T147601[ebp], 0
	mov	DWORD PTR __$EHRec$[ebp+8], 2

; 72   : 	_DEBUG_RANGE(_First, _Last);

	push	72					; 00000048H
	push	OFFSET ??_C@_1GG@BACILIFO@?$AAD?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAV?$AAS?$AA2?$AA0?$AA1?$AA0?$AA?2?$AAV?$AAC@
	sub	esp, 12					; 0000000cH
	mov	ecx, esp
	mov	DWORD PTR $T147590[ebp], esp
	lea	eax, DWORD PTR __Last$[ebp]
	push	eax
	call	??0?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAE@ABV01@@Z
	...
	sub	esp, 12					; 0000000cH
	mov	ecx, esp
	mov	DWORD PTR $T147591[ebp], esp
	lea	edx, DWORD PTR __First$[ebp]
	push	edx
	call	??0?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAE@ABV01@@Z
	mov	DWORD PTR tv176[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 2
	call	??$_Debug_range@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@0PB_WI@Z ; std::_Debug_range<std::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > > >
	add	esp, 32					; 00000020H
...
; 74   : 		_Find(_Unchecked(_First), _Unchecked(_Last), _Val)));
	...
	sub	esp, 12					; 0000000cH
	mov	ecx, esp
	mov	DWORD PTR $T147592[ebp], esp
	lea	edx, DWORD PTR __Last$[ebp]
	push	edx
	call	??0?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAE@ABV01@@Z
	mov	DWORD PTR tv179[ebp], eax
	call	??$_Unchecked@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@YAPAIV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@@Z ; std::_Unchecked<std::_Vector_val<unsigned int,std::allocator<unsigned int> > >
	add	esp, 12					; 0000000cH
	...
	mov	eax, DWORD PTR tv184[ebp]
	push	eax
	call	??$_Find@PAII@std@@YAPAIPAI0ABI@Z	; std::_Find<unsigned int *,unsigned int>
	add	esp, 12					; 0000000cH
	push	eax
	lea	ecx, DWORD PTR __First$[ebp]
	push	ecx
	call	??$_Rechecked@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@YAAAV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@AAV10@PAI@Z ; std::_Rechecked<std::_Vector_val<unsigned int,std::allocator<unsigned int> > >
	add	esp, 8
	push	eax
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAE@ABV01@@Z
	mov	edx, DWORD PTR $T147601[ebp]
	or	edx, 1
	mov	DWORD PTR $T147601[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	lea	ecx, DWORD PTR __First$[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAE@XZ
	mov	BYTE PTR __$EHRec$[ebp+8], 0
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$??$find@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@I@std@@YA?AV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@V10@0ABI@Z$0:
	lea	ecx, DWORD PTR __Last$[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAE@XZ
__unwindfunclet$??$find@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@I@std@@YA?AV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@V10@0ABI@Z$1:
	lea	ecx, DWORD PTR __First$[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAE@XZ
__unwindfunclet$??$find@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@I@std@@YA?AV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@V10@0ABI@Z$2:
	mov	ecx, DWORD PTR $T147590[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAE@XZ
__unwindfunclet$??$find@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@I@std@@YA?AV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@V10@0ABI@Z$6:
	mov	eax, DWORD PTR $T147601[ebp]
	and	eax, 1
	je	$LN10@find
	and	DWORD PTR $T147601[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAE@XZ
$LN10@find:
	ret	0
__ehhandler$??$find@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@I@std@@YA?AV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@V10@0ABI@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-56]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$??$find@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@I@std@@YA?AV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@V10@0ABI@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
??$find@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@I@std@@YA?AV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@V10@0ABI@Z ENDP ; std::find<std::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > >,unsigned int>
...
$T147612 = -64						; size = 4
$T147611 = -60						; size = 12
__Pfmod$142782 = -48					; size = 4
__Pf$142771 = -44					; size = 4
__Id$142770 = -40					; size = 4
__Psave$142758 = -32					; size = 4
__Lock$142757 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$142757[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$142758[ebp], eax
...
; 509  : 		size_t _Id = _Facet::id;
	...
	call	??Bid@locale@std@@QAEIXZ		; std::locale::id::operator unsigned int
	mov	DWORD PTR __Id$142770[ebp], eax

; 510  : 		const locale::facet *_Pf = _Loc._Getfacet(_Id);

	mov	ecx, DWORD PTR __Id$142770[ebp]
	push	ecx
	mov	ecx, DWORD PTR __Loc$[ebp]
	call	?_Getfacet@locale@std@@QBEPBVfacet@12@I@Z ; std::locale::_Getfacet
	mov	DWORD PTR __Pf$142771[ebp], eax

; 511  : 
; 512  : 		if (_Pf != 0)

	cmp	DWORD PTR __Pf$142771[ebp], 0
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$142758[ebp], 0
	je	SHORT $LN4@use_facet@2

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	edx, DWORD PTR __Psave$142758[ebp]
	mov	DWORD PTR __Pf$142771[ebp], edx
	jmp	SHORT $LN5@use_facet@2
$LN4@use_facet@2:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	mov	eax, DWORD PTR __Loc$[ebp]
	push	eax
	lea	ecx, DWORD PTR __Psave$142758[ebp]
	push	ecx
...
; 520  : 			_THROW_NCEE(bad_cast, _EMPTY_ARGUMENT);	// lazy disallowed
	...
	push	OFFSET ??_C@_08EPJLHIJG@bad?5cast?$AA@
	lea	ecx, DWORD PTR $T147611[ebp]
	call	??0bad_cast@std@@QAE@PBD@Z		; std::bad_cast::bad_cast
	push	OFFSET __TI2?AVbad_cast@std@@
	lea	edx, DWORD PTR $T147611[ebp]
	push	edx
	call	__CxxThrowException@8
...
; 528  : 			_Pf = _Psave;
	...
	mov	eax, DWORD PTR __Psave$142758[ebp]
	mov	DWORD PTR __Pf$142771[ebp], eax

; 529  : 			_Facetptr<_Facet>::_Psave = _Psave;

	mov	ecx, DWORD PTR __Psave$142758[ebp]
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	edx, DWORD PTR __Psave$142758[ebp]
	mov	DWORD PTR __Pfmod$142782[ebp], edx

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$142782[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$142771[ebp]
	mov	DWORD PTR $T147612[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$142757[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T147612[ebp]
$LN8@use_facet@2:
...
_TEXT	ENDS
PUBLIC	??$construct@AAI@?$allocator@I@std@@QAEXPAIAAI@Z ; std::allocator<unsigned int>::construct<unsigned int &>
PUBLIC	??$forward@AAI@std@@YAAAIAAI@Z			; std::forward<unsigned int &>
; Function compile flags: /Odtp /RTCsu
;	COMDAT ??$_Cons_val@V?$allocator@I@std@@IAAI@std@@YAXAAV?$allocator@I@0@PAIAAI@Z
_TEXT	SEGMENT
__Alval$ = 8						; size = 4
__Pdest$ = 12						; size = 4
__Src$ = 16						; size = 4
??$_Cons_val@V?$allocator@I@std@@IAAI@std@@YAXAAV?$allocator@I@0@PAIAAI@Z PROC ; std::_Cons_val<std::allocator<unsigned int>,unsigned int,unsigned int &>, COMDAT
...
; 280  : 	_Alval.construct(_Pdest, _STD forward<_Ty2>(_Src));
	...
	call	??$construct@AAI@?$allocator@I@std@@QAEXPAIAAI@Z ; std::allocator<unsigned int>::construct<unsigned int &>
...
; 281  : 	}
	...
	pop	ebp
	ret	0
??$_Cons_val@V?$allocator@I@std@@IAAI@std@@YAXAAV?$allocator@I@0@PAIAAI@Z ENDP ; std::_Cons_val<std::allocator<unsigned int>,unsigned int,unsigned int &>
_TEXT	ENDS
...
; 88   : 	_Destroy_range(_First, _Last, _Al, _Ptr_cat(_First, _Last));
	...
	add	esp, 8
	mov	BYTE PTR $T147641[ebp], al
	movzx	edx, BYTE PTR $T147641[ebp]
	push	edx
...
; File d:\program files (x86)\vs2010\vc\include\exception
rdata$r	SEGMENT
...
; Function compile flags: /Odtp /RTCsu
;	COMDAT ??0?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAE@ABV01@@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___that$ = 8						; size = 4
??0?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAE@ABV01@@Z PROC ; std::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > >::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > >, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	push	ecx
	...
	pop	ebp
	ret	4
??0?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAE@ABV01@@Z ENDP ; std::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > >::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > >
_TEXT	ENDS
...
PUBLIC	??_C@_0DB@KEDEGPLJ@D?3?2Program?5Files?5?$CIx86?$CJ?2VS2010?2VC@ ; `string'
;	COMDAT ??_C@_0DB@KEDEGPLJ@D?3?2Program?5Files?5?$CIx86?$CJ?2VS2010?2VC@
; File d:\program files (x86)\vs2010\vc\include\xlocnum
CONST	SEGMENT
??_C@_0DB@KEDEGPLJ@D?3?2Program?5Files?5?$CIx86?$CJ?2VS2010?2VC@ DB 'D:\P'
	DB	'rogram Files (x86)\VS2010\VC\include\xlocnum', 00H ; `string'
CONST	ENDS
;	COMDAT xdata$x
xdata$x	SEGMENT
...
; 246  : 				_Locinfo(_Ploc->c_str()));
	...
	call	?_DebugHeapTag_func@std@@YAABU_DebugHeapTag_t@1@XZ ; std::_DebugHeapTag_func
	mov	DWORD PTR $T147676[ebp], eax
	push	245					; 000000f5H
	push	OFFSET ??_C@_0DB@KEDEGPLJ@D?3?2Program?5Files?5?$CIx86?$CJ?2VS2010?2VC@
	mov	ecx, DWORD PTR $T147676[ebp]
	push	ecx
	push	16					; 00000010H
	call	??2facet@locale@std@@SAPAXIABU_DebugHeapTag_t@2@PADH@Z ; std::locale::facet::operator new
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T147675[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T147675[ebp], 0
	je	SHORT $LN4@Getcat@2
	push	0
	mov	ecx, DWORD PTR __Ploc$[ebp]
	call	?c_str@locale@std@@QBEPBDXZ		; std::locale::c_str
	push	eax
	lea	ecx, DWORD PTR $T147677[ebp]
	call	??0_Locinfo@std@@QAE@PBD@Z		; std::_Locinfo::_Locinfo
	mov	DWORD PTR tv138[ebp], eax
	mov	edx, DWORD PTR tv138[ebp]
	mov	DWORD PTR tv133[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	mov	eax, DWORD PTR $T147681[ebp]
	or	eax, 1
	mov	DWORD PTR $T147681[ebp], eax
	mov	ecx, DWORD PTR tv133[ebp]
	push	ecx
	mov	ecx, DWORD PTR $T147675[ebp]
...
$LN5@Getcat@2:
	mov	edx, DWORD PTR tv92[ebp]
	mov	DWORD PTR $T147674[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR __Ppf$[ebp]
	mov	ecx, DWORD PTR $T147674[ebp]
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T147681[ebp]
	and	edx, 1
	je	SHORT $LN1@Getcat@2
	and	DWORD PTR $T147681[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T147677[ebp]
	call	??1_Locinfo@std@@QAE@XZ			; std::_Locinfo::~_Locinfo
$LN1@Getcat@2:
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	add	esp, 8
	mov	DWORD PTR $T147694[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T147694[ebp], 0
	...
	mov	ecx, DWORD PTR $T147694[ebp]
	mov	DWORD PTR [ecx], edx
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR $T147694[ebp]
...
; Function compile flags: /Odtp /RTCsu
; File d:\program files (x86)\vs2010\vc\include\new
...
PUBLIC	??_C@_1GC@BFPKGLGL@?$AAD?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAV?$AAS?$AA2?$AA0?$AA1?$AA0?$AA?2?$AAV?$AAC@ ; `string'
PUBLIC	__$ArrayPad$
EXTRN	__Stoulx:PROC
;	COMDAT ??_C@_1GC@BFPKGLGL@?$AAD?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAV?$AAS?$AA2?$AA0?$AA1?$AA0?$AA?2?$AAV?$AAC@
CONST	SEGMENT
??_C@_1GC@BFPKGLGL@?$AAD?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAV?$AAS?$AA2?$AA0?$AA1?$AA0?$AA?2?$AAV?$AAC@ DB 'D'
	DB	00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H, 'g', 00H
	DB	'r', 00H, 'a', 00H, 'm', 00H, ' ', 00H, 'F', 00H, 'i', 00H, 'l'
	DB	00H, 'e', 00H, 's', 00H, ' ', 00H, '(', 00H, 'x', 00H, '8', 00H
	DB	'6', 00H, ')', 00H, '\', 00H, 'V', 00H, 'S', 00H, '2', 00H, '0'
	DB	00H, '1', 00H, '0', 00H, '\', 00H, 'V', 00H, 'C', 00H, '\', 00H
	DB	'i', 00H, 'n', 00H, 'c', 00H, 'l', 00H, 'u', 00H, 'd', 00H, 'e'
	DB	00H, '\', 00H, 'x', 00H, 'l', 00H, 'o', 00H, 'c', 00H, 'n', 00H
...
$T147723 = -208						; size = 4
$T147722 = -204						; size = 4
__Ulo$140836 = -200					; size = 4
__Errno$140835 = -192					; size = 4
__Ep$140834 = -180					; size = 4
__Ac$140833 = -168					; size = 32
$T140822 = -132						; size = 32
$T140820 = -100						; size = 32
__Str$140819 = -64					; size = 32
__Punct_fac$140814 = -28				; size = 4
__Ans$ = -24						; size = 4
_this$ = -20						; size = 4
...
; 366  : 		_DEBUG_RANGE(_First, _Last);
	...
	push	366					; 0000016eH
	push	OFFSET ??_C@_1GC@BFPKGLGL@?$AAD?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAV?$AAS?$AA2?$AA0?$AA1?$AA0?$AA?2?$AAV?$AAC@
	mov	eax, DWORD PTR __Last$[ebp+4]
	push	eax
	mov	ecx, DWORD PTR __Last$[ebp]
	push	ecx
...
; 372  : 			const _Mypunct& _Punct_fac = _USE(_Iosbase.getloc(), _Mypunct);
	...
	add	esp, 4
	mov	DWORD PTR __Punct_fac$140814[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR $T147722[ebp]
	call	??1locale@std@@QAE@XZ			; std::locale::~locale
...
; 373  : 			_Mystr _Str((_Mystrsize)1, (char_type)0);
	...
	push	0
	push	1
	lea	ecx, DWORD PTR __Str$140819[ebp]
...
; 374  : 			_Str += _Punct_fac.falsename();
	...
	lea	ecx, DWORD PTR $T140820[ebp]
	push	ecx
	mov	ecx, DWORD PTR __Punct_fac$140814[ebp]
...
; 385  : 					_Iosbase.getloc()), &_Errno);
	...
	lea	edx, DWORD PTR __First$[ebp]
	push	edx
	lea	eax, DWORD PTR __Ac$140833[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	push	ecx
	...
	add	esp, 24					; 00000018H
	push	eax
	lea	edx, DWORD PTR __Ep$140834[ebp]
	push	edx
	lea	eax, DWORD PTR __Ac$140833[ebp]
	push	eax
	call	__Stoulx
	add	esp, 16					; 00000010H
	mov	DWORD PTR __Ulo$140836[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR $T147723[ebp]
	call	??1locale@std@@QAE@XZ			; std::locale::~locale
...
; 386  : 			if (_Ep != _Ac && _Errno == 0 && _Ulo <= 1)
	...
	mov	ecx, DWORD PTR __Ep$140834[ebp]
	lea	edx, DWORD PTR __Ac$140833[ebp]
	cmp	ecx, edx
	je	SHORT $LN5@do_get
	cmp	DWORD PTR __Errno$140835[ebp], 0
	jne	SHORT $LN5@do_get
	cmp	DWORD PTR __Ulo$140836[ebp], 1
	ja	SHORT $LN5@do_get

; 387  : 				_Ans = _Ulo;

	mov	eax, DWORD PTR __Ulo$140836[ebp]
	mov	DWORD PTR __Ans$[ebp], eax
$LN5@do_get:
...
;	COMDAT xdata$x
; File d:\program files (x86)\vs2010\vc\include\xstring
xdata$x	SEGMENT
...
; 1993 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR __Ptr$139806[ebp], eax
...
; 1995 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$139806[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1996 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$139806[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 28					; 0000001cH
...
EXTRN	_ldexp:PROC
; Function compile flags: /Odtp /RTCsu
; File d:\program files (x86)\vs2010\vc\include\math.h
;	COMDAT _ldexpf
_TEXT	SEGMENT
tv75 = -4						; size = 4
__X$ = 8						; size = 4
...
; 1954 : 		_Traits::assign(_Myptr()[this->_Mysize = _Newsize], _Elem());
	...
	mov	BYTE PTR $T147973[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+20], ecx
	lea	edx, DWORD PTR $T147973[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Myptr@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEPADXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Myptr
...
tv75 = -137						; size = 1
$T147997 = -136						; size = 4
__Pg$141491 = -132					; size = 4
__Pe$141465 = -128					; size = 4
__Group$ = -124						; size = 4
...
; 672  : 		for (char *const _Pe = &_Ac[_MAX_INT_DIG - 1];
	...
	mov	DWORD PTR __Pe$141465[ebp], edx
...
$LN22@Getifld:
	mov	eax, DWORD PTR __Ptr$[ebp]
	cmp	eax, DWORD PTR __Pe$141465[ebp]
...
; 700  : 		for (const char *_Pg = _Grouping.c_str(); _Seendigit && 0 < _Group; )
	...
	lea	ecx, DWORD PTR __Grouping$[ebp]
	call	?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::c_str
	mov	DWORD PTR __Pg$141491[ebp], eax
$LN12@Getifld:
...
; 701  : 			if (*_Pg == CHAR_MAX)
	...
	mov	eax, DWORD PTR __Pg$141491[ebp]
...
; 707  : 				++_Pg;	// group size okay, advance to next test
	...
	mov	edx, DWORD PTR __Pg$141491[ebp]
	add	edx, 1
	mov	DWORD PTR __Pg$141491[ebp], edx
$LN9@Getifld:
...
$T148018 = -140						; size = 4
$T148015 = -136						; size = 4
__Pg$141564 = -132					; size = 4
__Group$141543 = -128					; size = 4
__Groups$141542 = -120					; size = 32
__Kseparator$141539 = -81				; size = 1
__Pten$ = -80						; size = 4
...
$LN73@Getffld:
	...
	mov	BYTE PTR __Kseparator$141539[ebp], al

; 759  : 			string _Groups((size_t)1, '\0');

	push	0
	push	1
	lea	ecx, DWORD PTR __Groups$141542[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ID@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	BYTE PTR __$EHRec$[ebp+8], 2

; 760  : 			size_t _Group = 0;

	mov	DWORD PTR __Group$141543[ebp], 0
...
; 775  : 					if (_Groups[_Group] != CHAR_MAX)
	...
	mov	eax, DWORD PTR __Group$141543[ebp]
	push	eax
	lea	ecx, DWORD PTR __Groups$141542[ebp]
	call	??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAADI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::operator[]
	movsx	ecx, BYTE PTR [eax]
...
; 776  : 						++_Groups[_Group];
	...
	mov	edx, DWORD PTR __Group$141543[ebp]
	push	edx
	lea	ecx, DWORD PTR __Groups$141542[ebp]
	call	??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAADI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::operator[]
...
; 780  : 					|| *_First != _Kseparator)
	...
	movsx	edx, BYTE PTR __Kseparator$141539[ebp]
	test	edx, edx
	je	SHORT $LN42@Getffld
	mov	ecx, DWORD PTR __First$[ebp]
	call	??D?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@QBEDXZ ; std::istreambuf_iterator<char,std::char_traits<char> >::operator*
	movsx	eax, al
	movsx	ecx, BYTE PTR __Kseparator$141539[ebp]
	cmp	eax, ecx
...
; 785  : 					++_Group;
	...
	mov	edx, DWORD PTR __Group$141543[ebp]
	add	edx, 1
	mov	DWORD PTR __Group$141543[ebp], edx
$LN44@Getffld:
...
; 787  : 			if (_Group == 0)
	...
	cmp	DWORD PTR __Group$141543[ebp], 0
...
; 794  : 			for (const char *_Pg = _Grouping.c_str();
	...
	lea	ecx, DWORD PTR __Grouping$[ebp]
	call	?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::c_str
	mov	DWORD PTR __Pg$141564[ebp], eax
$LN36@Getffld:
...
; 796  : 				if (*_Pg == CHAR_MAX)
	...
	mov	ecx, DWORD PTR __Pg$141564[ebp]
	movsx	edx, BYTE PTR [ecx]
	cmp	edx, 127				; 0000007fH
...
; 799  : 					|| 0 == _Group && *_Pg < _Groups[_Group])
	...
	mov	eax, DWORD PTR __Group$141543[ebp]
	sub	eax, 1
	mov	DWORD PTR __Group$141543[ebp], eax
...
; 802  : 					++_Pg;	// group size okay, advance to next test
	...
	mov	eax, DWORD PTR __Pg$141564[ebp]
	add	eax, 1
	mov	DWORD PTR __Pg$141564[ebp], eax
$LN33@Getffld:
...
; 859  : 		return (_Pten);
	...
	mov	ecx, DWORD PTR __Pten$[ebp]
	mov	DWORD PTR $T148018[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Grouping$[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T148018[ebp]
$LN70@Getffld:
...
; 84   : 		return (do_falsename());
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	ecx, DWORD PTR $T148035[ebp]
	or	ecx, 1
	mov	DWORD PTR $T148035[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 89   : 		return (do_truename());
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	ecx, DWORD PTR $T148040[ebp]
	or	ecx, 1
	mov	DWORD PTR $T148040[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
PUBLIC	??_C@_1GC@JMFDFLPA@?$AAD?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAV?$AAS?$AA2?$AA0?$AA1?$AA0?$AA?2?$AAV?$AAC@ ; `string'
...
CONST	ENDS
;	COMDAT ??_C@_1GC@JMFDFLPA@?$AAD?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAV?$AAS?$AA2?$AA0?$AA1?$AA0?$AA?2?$AAV?$AAC@
CONST	SEGMENT
??_C@_1GC@JMFDFLPA@?$AAD?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAV?$AAS?$AA2?$AA0?$AA1?$AA0?$AA?2?$AAV?$AAC@ DB 'D'
	DB	00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H, 'g', 00H
	DB	'r', 00H, 'a', 00H, 'm', 00H, ' ', 00H, 'F', 00H, 'i', 00H, 'l'
	DB	00H, 'e', 00H, 's', 00H, ' ', 00H, '(', 00H, 'x', 00H, '8', 00H
	DB	'6', 00H, ')', 00H, '\', 00H, 'V', 00H, 'S', 00H, '2', 00H, '0'
...
; 1441 : 			_DEBUG_ERROR("string subscript out of range");
	...
	push	1441					; 000005a1H
	push	OFFSET ??_C@_1GC@JMFDFLPA@?$AAD?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAV?$AAS?$AA2?$AA0?$AA1?$AA0?$AA?2?$AAV?$AAC@
...
$T148076 = -148						; size = 4
$T148073 = -144						; size = 4
__Pg$141900 = -140					; size = 4
__Group$141880 = -136					; size = 4
__Groups$141879 = -128					; size = 32
__Kseparator$141876 = -89				; size = 1
__Phex$ = -88						; size = 4
...
$LN78@Getffldx:
	...
	mov	BYTE PTR __Kseparator$141876[ebp], cl

; 928  : 			string _Groups((size_t)1, '\0');

	push	0
	push	1
	lea	ecx, DWORD PTR __Groups$141879[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ID@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	BYTE PTR __$EHRec$[ebp+8], 2

; 929  : 			size_t _Group = 0;

	mov	DWORD PTR __Group$141880[ebp], 0
...
; 944  : 					if (_Groups[_Group] != CHAR_MAX)
	...
	mov	eax, DWORD PTR __Group$141880[ebp]
	push	eax
	lea	ecx, DWORD PTR __Groups$141879[ebp]
	call	??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAADI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::operator[]
	movsx	ecx, BYTE PTR [eax]
...
; 945  : 						++_Groups[_Group];
	...
	mov	edx, DWORD PTR __Group$141880[ebp]
	push	edx
	lea	ecx, DWORD PTR __Groups$141879[ebp]
	call	??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAADI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::operator[]
...
; 949  : 					|| *_First != _Kseparator)
	...
	movsx	edx, BYTE PTR __Kseparator$141876[ebp]
	test	edx, edx
	je	SHORT $LN42@Getffldx
	mov	ecx, DWORD PTR __First$[ebp]
	call	??D?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@QBEDXZ ; std::istreambuf_iterator<char,std::char_traits<char> >::operator*
	movsx	eax, al
	movsx	ecx, BYTE PTR __Kseparator$141876[ebp]
	cmp	eax, ecx
...
; 954  : 					++_Group;
	...
	mov	edx, DWORD PTR __Group$141880[ebp]
	add	edx, 1
	mov	DWORD PTR __Group$141880[ebp], edx
$LN44@Getffldx:
...
; 956  : 			if (_Group == 0)
	...
	cmp	DWORD PTR __Group$141880[ebp], 0
...
; 963  : 			for (const char *_Pg = _Grouping.c_str();
	...
	lea	ecx, DWORD PTR __Grouping$[ebp]
	call	?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::c_str
	mov	DWORD PTR __Pg$141900[ebp], eax
$LN36@Getffldx:
...
; 965  : 				if (*_Pg == CHAR_MAX)
	...
	mov	ecx, DWORD PTR __Pg$141900[ebp]
	movsx	edx, BYTE PTR [ecx]
	cmp	edx, 127				; 0000007fH
...
; 968  : 					|| 0 == _Group && *_Pg < _Groups[_Group])
	...
	mov	eax, DWORD PTR __Group$141880[ebp]
	sub	eax, 1
	mov	DWORD PTR __Group$141880[ebp], eax
...
; 971  : 					++_Pg;	// group size okay, advance to next test
	...
	mov	eax, DWORD PTR __Pg$141900[ebp]
	add	eax, 1
	mov	DWORD PTR __Pg$141900[ebp], eax
$LN33@Getffldx:
...
; 1029 : 		return (0);	// power of 10 multiplier
	...
	mov	DWORD PTR $T148076[ebp], 0
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Grouping$[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T148076[ebp]
...
PUBLIC	??_C@_1GG@ONGLJPGO@?$AAD?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAV?$AAS?$AA2?$AA0?$AA1?$AA0?$AA?2?$AAV?$AAC@ ; `string'
...
CONST	ENDS
;	COMDAT ??_C@_1GG@ONGLJPGO@?$AAD?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAV?$AAS?$AA2?$AA0?$AA1?$AA0?$AA?2?$AAV?$AAC@
CONST	SEGMENT
??_C@_1GG@ONGLJPGO@?$AAD?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAV?$AAS?$AA2?$AA0?$AA1?$AA0?$AA?2?$AAV?$AAC@ DB 'D'
	DB	00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H, 'g', 00H
	DB	'r', 00H, 'a', 00H, 'm', 00H, ' ', 00H, 'F', 00H, 'i', 00H, 'l'
	DB	00H, 'e', 00H, 's', 00H, ' ', 00H, '(', 00H, 'x', 00H, '8', 00H
	DB	'6', 00H, ')', 00H, '\', 00H, 'V', 00H, 'S', 00H, '2', 00H, '0'
	DB	00H, '1', 00H, '0', 00H, '\', 00H, 'V', 00H, 'C', 00H, '\', 00H
	DB	'i', 00H, 'n', 00H, 'c', 00H, 'l', 00H, 'u', 00H, 'd', 00H, 'e'
	DB	00H, '\', 00H, 's', 00H, 't', 00H, 'r', 00H, 'e', 00H, 'a', 00H
	DB	'm', 00H, 'b', 00H, 'u', 00H, 'f', 00H, 00H, 00H ; `string'
; Function compile flags: /Odtp /RTCsu
CONST	ENDS
...
; 507  : 			_DEBUG_ERROR("istreambuf_iterator is not dereferencable");
	...
	push	507					; 000001fbH
	push	OFFSET ??_C@_1GG@ONGLJPGO@?$AAD?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAV?$AAS?$AA2?$AA0?$AA1?$AA0?$AA?2?$AAV?$AAC@
...
; 79   : 		return (do_grouping());
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	ecx, DWORD PTR $T148101[ebp]
	or	ecx, 1
	mov	DWORD PTR $T148101[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 548  : 				_Strbuf->sbumpc()))
	...
	mov	ecx, DWORD PTR [ecx]
	call	?sbumpc@?$basic_streambuf@DU?$char_traits@D@std@@@std@@QAEHXZ ; std::basic_streambuf<char,std::char_traits<char> >::sbumpc
	mov	DWORD PTR $T148117[ebp], eax
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T148118[ebp], eax
	lea	edx, DWORD PTR $T148117[ebp]
	push	edx
	lea	eax, DWORD PTR $T148118[ebp]
	push	eax
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	ecx, al
...
; 559  : 				_Meta = _Strbuf->sgetc()))
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T148121[ebp], eax
	lea	edx, DWORD PTR __Meta$[ebp]
	push	edx
	lea	eax, DWORD PTR $T148121[ebp]
	push	eax
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	ecx, al
...
$T148130 = -64						; size = 4
$T148129 = -60						; size = 12
__Pfmod$142986 = -48					; size = 4
__Pf$142975 = -44					; size = 4
__Id$142974 = -40					; size = 4
__Psave$142962 = -32					; size = 4
__Lock$142961 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$142961[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$142962[ebp], eax
...
; 509  : 		size_t _Id = _Facet::id;
	...
	call	??Bid@locale@std@@QAEIXZ		; std::locale::id::operator unsigned int
	mov	DWORD PTR __Id$142974[ebp], eax

; 510  : 		const locale::facet *_Pf = _Loc._Getfacet(_Id);

	mov	ecx, DWORD PTR __Id$142974[ebp]
	push	ecx
	mov	ecx, DWORD PTR __Loc$[ebp]
	call	?_Getfacet@locale@std@@QBEPBVfacet@12@I@Z ; std::locale::_Getfacet
	mov	DWORD PTR __Pf$142975[ebp], eax

; 511  : 
; 512  : 		if (_Pf != 0)

	cmp	DWORD PTR __Pf$142975[ebp], 0
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$142962[ebp], 0
	je	SHORT $LN4@use_facet@3

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	edx, DWORD PTR __Psave$142962[ebp]
	mov	DWORD PTR __Pf$142975[ebp], edx
	jmp	SHORT $LN5@use_facet@3
$LN4@use_facet@3:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	mov	eax, DWORD PTR __Loc$[ebp]
	push	eax
	lea	ecx, DWORD PTR __Psave$142962[ebp]
	push	ecx
...
; 520  : 			_THROW_NCEE(bad_cast, _EMPTY_ARGUMENT);	// lazy disallowed
	...
	push	OFFSET ??_C@_08EPJLHIJG@bad?5cast?$AA@
	lea	ecx, DWORD PTR $T148129[ebp]
	call	??0bad_cast@std@@QAE@PBD@Z		; std::bad_cast::bad_cast
	push	OFFSET __TI2?AVbad_cast@std@@
	lea	edx, DWORD PTR $T148129[ebp]
	push	edx
	call	__CxxThrowException@8
...
; 528  : 			_Pf = _Psave;
	...
	mov	eax, DWORD PTR __Psave$142962[ebp]
	mov	DWORD PTR __Pf$142975[ebp], eax

; 529  : 			_Facetptr<_Facet>::_Psave = _Psave;

	mov	ecx, DWORD PTR __Psave$142962[ebp]
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	edx, DWORD PTR __Psave$142962[ebp]
	mov	DWORD PTR __Pfmod$142986[ebp], edx

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$142986[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$142975[ebp]
	mov	DWORD PTR $T148130[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$142961[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T148130[ebp]
$LN8@use_facet@3:
...
; 728  : 	_Debug_range2(_First, _Last, _File, _Line, _Iter_cat(_First));
	...
	add	esp, 4
	mov	BYTE PTR $T148145[ebp], al
	movzx	ecx, BYTE PTR $T148145[ebp]
	push	ecx
...
tv144 = -88						; size = 4
$T148153 = -84						; size = 4
__Field$143042 = -80					; size = 4
__Off$143041 = -76					; size = 4
__Prefix$143040 = -69					; size = 1
__Column$143036 = -68					; size = 4
__Ans$ = -64						; size = 4
__Str$ = -56						; size = 32
__Off$143028 = -20					; size = 4
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
__First$ = 8						; size = 4
__Last$ = 12						; size = 4
...
; 546  : 	for (size_t _Off = 0; _Ptr[_Off] != (_Elem)0; ++_Off)
	...
	mov	DWORD PTR __Off$143028[ebp], 0
	jmp	SHORT $LN23@Getloctxt
$LN22@Getloctxt:
	mov	eax, DWORD PTR __Off$143028[ebp]
	add	eax, 1
	mov	DWORD PTR __Off$143028[ebp], eax
$LN23@Getloctxt:
	mov	ecx, DWORD PTR __Ptr$[ebp]
	add	ecx, DWORD PTR __Off$143028[ebp]
	movsx	edx, BYTE PTR [ecx]
	test	edx, edx
...
; 547  : 		if (_Ptr[_Off] == _Ptr[0])
	...
	mov	eax, DWORD PTR __Ptr$[ebp]
	add	eax, DWORD PTR __Off$143028[ebp]
	movsx	ecx, BYTE PTR [eax]
	mov	edx, DWORD PTR __Ptr$[ebp]
...
; 552  : 	for (size_t _Column = 1; ; ++_Column, ++_First, _Ans = -1)
	...
	mov	DWORD PTR __Column$143036[ebp], 1
	jmp	SHORT $LN19@Getloctxt
$LN18@Getloctxt:
	mov	eax, DWORD PTR __Column$143036[ebp]
	add	eax, 1
	mov	DWORD PTR __Column$143036[ebp], eax
	mov	ecx, DWORD PTR __First$[ebp]
	call	??E?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@QAEAAV01@XZ ; std::istreambuf_iterator<char,std::char_traits<char> >::operator++
	mov	DWORD PTR __Ans$[ebp], -1
$LN19@Getloctxt:
...
; 554  : 		bool _Prefix = false;	// seen at least one valid prefix
	...
	mov	BYTE PTR __Prefix$143040[ebp], 0

; 555  : 		size_t _Off = 0;	// offset into fields

	mov	DWORD PTR __Off$143041[ebp], 0

; 556  : 		size_t _Field = 0;	// current field number

	mov	DWORD PTR __Field$143042[ebp], 0
...
$LN15@Getloctxt:
	mov	ecx, DWORD PTR __Field$143042[ebp]
	add	ecx, 1
	mov	DWORD PTR __Field$143042[ebp], ecx
$LN16@Getloctxt:
	mov	edx, DWORD PTR __Field$143042[ebp]
...
$LN12@Getloctxt:
	mov	eax, DWORD PTR __Off$143041[ebp]
	add	eax, 1
	mov	DWORD PTR __Off$143041[ebp], eax
$LN13@Getloctxt:
	mov	ecx, DWORD PTR __Ptr$[ebp]
	add	ecx, DWORD PTR __Off$143041[ebp]
	movsx	edx, BYTE PTR [ecx]
	test	edx, edx
	je	SHORT $LN11@Getloctxt
	mov	eax, DWORD PTR __Ptr$[ebp]
	add	eax, DWORD PTR __Off$143041[ebp]
	movsx	ecx, BYTE PTR [eax]
	mov	edx, DWORD PTR __Ptr$[ebp]
	movsx	eax, BYTE PTR [edx]
	cmp	ecx, eax
...
; 564  : 				_Off += _Str[_Field];	// skip tested columns in field
	...
	mov	eax, DWORD PTR __Field$143042[ebp]
	push	eax
	lea	ecx, DWORD PTR __Str$[ebp]
	call	??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAADI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::operator[]
	movsx	ecx, BYTE PTR [eax]
	add	ecx, DWORD PTR __Off$143041[ebp]
	mov	DWORD PTR __Off$143041[ebp], ecx
...
; 566  : 				|| _Ptr[_Off] == (_Elem)0)
	...
	mov	edx, DWORD PTR __Off$143041[ebp]
	add	edx, DWORD PTR __Column$143036[ebp]
	mov	DWORD PTR __Off$143041[ebp], edx
	mov	eax, DWORD PTR __Ptr$[ebp]
	add	eax, DWORD PTR __Off$143041[ebp]
	movsx	ecx, BYTE PTR [eax]
	mov	edx, DWORD PTR __Ptr$[ebp]
...
; 569  : 					? _Column : 127);	// save skip count if small enough
	...
	cmp	DWORD PTR __Column$143036[ebp], 127	; 0000007fH
...
; 576  : 				_Prefix = true;	// still a valid prefix
	...
	mov	BYTE PTR __Prefix$143040[ebp], 1
$LN9@Getloctxt:
...
; 579  : 		if (!_Prefix || _First == _Last)
	...
	movzx	eax, BYTE PTR __Prefix$143040[ebp]
	test	eax, eax
...
; 582  : 	return (_Ans);	// return field number or negative value on failure
	...
	mov	ecx, DWORD PTR __Ans$[ebp]
	mov	DWORD PTR $T148153[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T148153[ebp]
...
; 114  : 				_Locinfo(_Ploc->c_str()), 0, true);
	...
	call	?_DebugHeapTag_func@std@@YAABU_DebugHeapTag_t@1@XZ ; std::_DebugHeapTag_func
	mov	DWORD PTR $T148185[ebp], eax
	push	113					; 00000071H
	push	OFFSET ??_C@_0DB@KEDEGPLJ@D?3?2Program?5Files?5?$CIx86?$CJ?2VS2010?2VC@
	mov	ecx, DWORD PTR $T148185[ebp]
	push	ecx
	push	24					; 00000018H
	call	??2facet@locale@std@@SAPAXIABU_DebugHeapTag_t@2@PADH@Z ; std::locale::facet::operator new
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T148184[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T148184[ebp], 0
	...
	call	?c_str@locale@std@@QBEPBDXZ		; std::locale::c_str
	push	eax
	lea	ecx, DWORD PTR $T148186[ebp]
	call	??0_Locinfo@std@@QAE@PBD@Z		; std::_Locinfo::_Locinfo
	mov	DWORD PTR tv139[ebp], eax
	mov	edx, DWORD PTR tv139[ebp]
	mov	DWORD PTR tv134[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	mov	eax, DWORD PTR $T148190[ebp]
	or	eax, 1
	mov	DWORD PTR $T148190[ebp], eax
	mov	ecx, DWORD PTR tv134[ebp]
	push	ecx
	mov	ecx, DWORD PTR $T148184[ebp]
...
$LN5@Getcat@3:
	...
	mov	DWORD PTR $T148183[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR __Ppf$[ebp]
	mov	ecx, DWORD PTR $T148183[ebp]
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T148190[ebp]
	and	edx, 1
	je	SHORT $LN1@Getcat@3
	and	DWORD PTR $T148190[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T148186[ebp]
	call	??1_Locinfo@std@@QAE@XZ			; std::_Locinfo::~_Locinfo
$LN1@Getcat@3:
...
; 174  : 		return (string(_Grouping));
	...
	mov	edx, DWORD PTR $T148216[ebp]
	or	edx, 1
	mov	DWORD PTR $T148216[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 184  : 		return (string_type(_Truename));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	edx, DWORD PTR $T148242[ebp]
	or	edx, 1
	mov	DWORD PTR $T148242[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 1118 : 			size_type _Newsize = this->_Mysize - _Count;
	...
	mov	eax, DWORD PTR [edx+20]
	sub	eax, DWORD PTR __Count$[ebp]
	mov	DWORD PTR __Newsize$139785[ebp], eax

; 1119 : 			_Eos(_Newsize);

	mov	ecx, DWORD PTR __Newsize$139785[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase:
...
; 123  : 		return (::_Getcvt());
	...
	call	__Getcvt
	mov	DWORD PTR $T148274[ebp], eax
	mov	DWORD PTR $T148274[ebp+4], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	mov	ecx, DWORD PTR $T148274[ebp]
	mov	DWORD PTR [eax], ecx
	mov	edx, DWORD PTR $T148274[ebp+4]
	mov	DWORD PTR [eax+4], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
_TEXT	ENDS
PUBLIC	??$_Debug_range2@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@0PB_WIUrandom_access_iterator_tag@0@@Z ; std::_Debug_range2<std::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > > >
PUBLIC	??$_Iter_cat@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YA?AUrandom_access_iterator_tag@0@ABV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@@Z ; std::_Iter_cat<std::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > > >
;	COMDAT xdata$x
xdata$x	SEGMENT
__unwindtable$??$_Debug_range@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@0PB_WI@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$??$_Debug_range@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@0PB_WI@Z$0
	DD	00H
	DD	FLAT:__unwindfunclet$??$_Debug_range@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@0PB_WI@Z$1
	DD	01H
	DD	FLAT:__unwindfunclet$??$_Debug_range@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@0PB_WI@Z$2
__ehfuncinfo$??$_Debug_range@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@0PB_WI@Z DD 019930522H
	DD	03H
	DD	FLAT:__unwindtable$??$_Debug_range@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@0PB_WI@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
; Function compile flags: /Odtp /RTCsu
xdata$x	ENDS
;	COMDAT ??$_Debug_range@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@0PB_WI@Z
_TEXT	SEGMENT
tv140 = -36						; size = 4
tv137 = -32						; size = 4
tv143 = -28						; size = 4
...
__File$ = 32						; size = 4
__Line$ = 36						; size = 4
??$_Debug_range@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@0PB_WI@Z PROC ; std::_Debug_range<std::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > > >, COMDAT
...
; 727  : 	{	// test iterator pair for valid range
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$??$_Debug_range@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@0PB_WI@Z
	mov	eax, DWORD PTR fs:0
	push	eax
	sub	esp, 24					; 00000018H
	mov	eax, -858993460				; ccccccccH
...
; 728  : 	_Debug_range2(_First, _Last, _File, _Line, _Iter_cat(_First));
	...
	push	ecx
	call	??$_Iter_cat@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YA?AUrandom_access_iterator_tag@0@ABV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@@Z ; std::_Iter_cat<std::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > > >
	add	esp, 8
	movzx	edx, BYTE PTR [eax]
	push	edx
	mov	eax, DWORD PTR __Line$[ebp]
	...
	sub	esp, 12					; 0000000cH
	mov	ecx, esp
	mov	DWORD PTR $T148316[ebp], esp
	lea	edx, DWORD PTR __First$[ebp]
	push	edx
	call	??0?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAE@ABV01@@Z
	mov	DWORD PTR tv140[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	call	??$_Debug_range2@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@0PB_WIUrandom_access_iterator_tag@0@@Z ; std::_Debug_range2<std::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > > >
	add	esp, 36					; 00000024H
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$??$_Debug_range@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@0PB_WI@Z$0:
	lea	ecx, DWORD PTR __Last$[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAE@XZ
__unwindfunclet$??$_Debug_range@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@0PB_WI@Z$1:
	lea	ecx, DWORD PTR __First$[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAE@XZ
__unwindfunclet$??$_Debug_range@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@0PB_WI@Z$2:
	mov	ecx, DWORD PTR $T148315[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAE@XZ
__ehhandler$??$_Debug_range@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@0PB_WI@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-28]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$??$_Debug_range@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@0PB_WI@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
??$_Debug_range@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@0PB_WI@Z ENDP ; std::_Debug_range<std::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > > >
PUBLIC	?_Unchecked@?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QBEPAIXZ ; std::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > >::_Unchecked
;	COMDAT xdata$x
; File d:\program files (x86)\vs2010\vc\include\vector
xdata$x	SEGMENT
__unwindtable$??$_Unchecked@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@YAPAIV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$??$_Unchecked@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@YAPAIV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@@Z$0
__ehfuncinfo$??$_Unchecked@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@YAPAIV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@@Z DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$??$_Unchecked@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@YAPAIV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
; Function compile flags: /Odtp /RTCsu
xdata$x	ENDS
;	COMDAT ??$_Unchecked@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@YAPAIV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@@Z
_TEXT	SEGMENT
$T148329 = -16						; size = 4
__$EHRec$ = -12						; size = 12
__Iter$ = 8						; size = 12
??$_Unchecked@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@YAPAIV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@@Z PROC ; std::_Unchecked<std::_Vector_val<unsigned int,std::allocator<unsigned int> > >, COMDAT
...
; 393  : 	{	// convert to unchecked
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$??$_Unchecked@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@YAPAIV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@@Z
	mov	eax, DWORD PTR fs:0
	push	eax
	push	ecx
	mov	DWORD PTR [ebp-16], -858993460		; ccccccccH
...
; 394  : 	return (_Iter._Unchecked());
	...
	call	?_Unchecked@?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QBEPAIXZ ; std::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > >::_Unchecked
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$??$_Unchecked@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@YAPAIV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@@Z$0:
	lea	ecx, DWORD PTR __Iter$[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAE@XZ
__ehhandler$??$_Unchecked@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@YAPAIV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-8]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$??$_Unchecked@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@YAPAIV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
??$_Unchecked@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@YAPAIV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@@Z ENDP ; std::_Unchecked<std::_Vector_val<unsigned int,std::allocator<unsigned int> > >
; Function compile flags: /Odtp /RTCsu
; File d:\program files (x86)\vs2010\vc\include\algorithm
;	COMDAT ??$_Find@PAII@std@@YAPAIPAI0ABI@Z
_TEXT	SEGMENT
__First$ = 8						; size = 4
__Last$ = 12						; size = 4
__Val$ = 16						; size = 4
??$_Find@PAII@std@@YAPAIPAI0ABI@Z PROC			; std::_Find<unsigned int *,unsigned int>, COMDAT
...
; 44   : 	}
	...
	pop	ebp
	ret	0
??$_Find@PAII@std@@YAPAIPAI0ABI@Z ENDP			; std::_Find<unsigned int *,unsigned int>
_TEXT	ENDS
PUBLIC	?_Rechecked@?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAEAAV12@PAI@Z ; std::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > >::_Rechecked
; Function compile flags: /Odtp /RTCsu
; File d:\program files (x86)\vs2010\vc\include\vector
;	COMDAT ??$_Rechecked@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@YAAAV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@AAV10@PAI@Z
_TEXT	SEGMENT
__Iter$ = 8						; size = 4
__Right$ = 12						; size = 4
??$_Rechecked@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@YAAAV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@AAV10@PAI@Z PROC ; std::_Rechecked<std::_Vector_val<unsigned int,std::allocator<unsigned int> > >, COMDAT
...
; 403  : 	return (_Iter._Rechecked(_Right));
	...
	call	?_Rechecked@?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAEAAV12@PAI@Z ; std::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > >::_Rechecked
...
; 404  : 	}
	...
	pop	ebp
	ret	0
??$_Rechecked@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@YAAAV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@AAV10@PAI@Z ENDP ; std::_Rechecked<std::_Vector_val<unsigned int,std::allocator<unsigned int> > >
; Function compile flags: /Odtp /RTCsu
; File d:\program files (x86)\vs2010\vc\include\utility
_TEXT	ENDS
...
; File d:\program files (x86)\vs2010\vc\include\xmemory
xdata$x	SEGMENT
__unwindtable$??$construct@AAI@?$allocator@I@std@@QAEXPAIAAI@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$??$construct@AAI@?$allocator@I@std@@QAEXPAIAAI@Z$0
__ehfuncinfo$??$construct@AAI@?$allocator@I@std@@QAEXPAIAAI@Z DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$??$construct@AAI@?$allocator@I@std@@QAEXPAIAAI@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
; Function compile flags: /Odtp /RTCsu
xdata$x	ENDS
;	COMDAT ??$construct@AAI@?$allocator@I@std@@QAEXPAIAAI@Z
_TEXT	SEGMENT
tv73 = -28						; size = 4
$T148346 = -24						; size = 4
$T148345 = -20						; size = 4
...
__Ptr$ = 8						; size = 4
__Val$ = 12						; size = 4
??$construct@AAI@?$allocator@I@std@@QAEXPAIAAI@Z PROC	; std::allocator<unsigned int>::construct<unsigned int &>, COMDAT
; _this$ = ecx
...
; 206  : 		void construct(pointer _Ptr, _Other&& _Val)
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$??$construct@AAI@?$allocator@I@std@@QAEXPAIAAI@Z
	mov	eax, DWORD PTR fs:0
	push	eax
	sub	esp, 16					; 00000010H
	mov	eax, -858993460				; ccccccccH
...
; 208  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Other>(_Val));
	...
	call	??2@YAPAXIPAX@Z				; operator new
	add	esp, 8
	mov	DWORD PTR $T148346[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T148346[ebp], 0
	je	SHORT $LN3@construct@2
	mov	ecx, DWORD PTR __Val$[ebp]
	push	ecx
	call	??$forward@AAI@std@@YAAAIAAI@Z		; std::forward<unsigned int &>
	add	esp, 4
	mov	edx, DWORD PTR $T148346[ebp]
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$??$construct@AAI@?$allocator@I@std@@QAEXPAIAAI@Z$0:
	mov	eax, DWORD PTR __Ptr$[ebp]
	push	eax
	mov	ecx, DWORD PTR $T148346[ebp]
	push	ecx
	...
	add	esp, 8
	ret	0
__ehhandler$??$construct@AAI@?$allocator@I@std@@QAEXPAIAAI@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-20]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$??$construct@AAI@?$allocator@I@std@@QAEXPAIAAI@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
??$construct@AAI@?$allocator@I@std@@QAEXPAIAAI@Z ENDP	; std::allocator<unsigned int>::construct<unsigned int &>
; Function compile flags: /Odtp /RTCsu
; File d:\program files (x86)\vs2010\vc\include\utility
...
; Function compile flags: /Odtp /RTCsu
; File d:\program files (x86)\vs2010\vc\include\memory
...
; 471  : 		_Val_type(_First), _Ptr_cat(_First, _Dest)));
	...
	call	??$_Ptr_cat@II@std@@YA?AU_Scalar_ptr_iterator_tag@0@PAI0@Z ; std::_Ptr_cat<unsigned int,unsigned int>
	add	esp, 8
	mov	BYTE PTR $T148369[ebp], al
	movzx	edx, BYTE PTR $T148369[ebp]
	push	edx
	mov	eax, DWORD PTR __First$[ebp]
	push	eax
...
; 48   : 	::new (_Vptr) _Ty1(_STD forward<_Ty2>(_Val));
	...
	call	??2@YAPAXIPAX@Z				; operator new
	add	esp, 8
	mov	DWORD PTR $T148380[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T148380[ebp], 0
	je	SHORT $LN3@Construct
	mov	edx, DWORD PTR __Val$[ebp]
	push	edx
	call	??$forward@ABI@std@@YAABIABI@Z		; std::forward<unsigned int const &>
	add	esp, 4
	mov	ecx, DWORD PTR $T148380[ebp]
	mov	edx, DWORD PTR [eax]
	mov	DWORD PTR [ecx], edx
...
; 660  : 	_Elem *_Ptrdest = _NEW_CRT _Elem[_Count];
	...
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T148394[ebp], eax
	mov	edx, DWORD PTR $T148394[ebp]
...
; 664  : 	for (_Elem *_Ptrnext = _Ptrdest; 0 < _Count; --_Count, ++_Ptrnext, ++_Ptr)
	...
	mov	DWORD PTR __Ptrnext$144216[ebp], eax
	jmp	SHORT $LN3@Maklocstr
$LN2@Maklocstr:
	mov	ecx, DWORD PTR __Count$[ebp]
	sub	ecx, 1
	mov	DWORD PTR __Count$[ebp], ecx
	mov	edx, DWORD PTR __Ptrnext$144216[ebp]
	add	edx, 1
	mov	DWORD PTR __Ptrnext$144216[ebp], edx
	mov	eax, DWORD PTR __Ptr$[ebp]
	add	eax, 1
	mov	DWORD PTR __Ptr$[ebp], eax
$LN3@Maklocstr:
...
; 665  : 		*_Ptrnext = (_Elem)(unsigned char)*_Ptr;
	...
	mov	ecx, DWORD PTR __Ptrnext$144216[ebp]
	mov	edx, DWORD PTR __Ptr$[ebp]
	mov	al, BYTE PTR [edx]
	mov	BYTE PTR [ecx], al
...
; File d:\program files (x86)\vs2010\vc\include\vector
_TEXT	ENDS
;	COMDAT ?_Rechecked@?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAEAAV12@PAI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
__Right$ = 8						; size = 4
?_Rechecked@?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAEAAV12@PAI@Z PROC ; std::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > >::_Rechecked, COMDAT
; _this$ = ecx
...
; 313  : 		}
	...
	pop	ebp
	ret	4
?_Rechecked@?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAEAAV12@PAI@Z ENDP ; std::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > >::_Rechecked
; Function compile flags: /Odtp /RTCsu
_TEXT	ENDS
;	COMDAT ?_Unchecked@?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QBEPAIXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?_Unchecked@?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QBEPAIXZ PROC ; std::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > >::_Unchecked, COMDAT
; _this$ = ecx
...
; 318  : 		}
	...
	pop	ebp
	ret	0
?_Unchecked@?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QBEPAIXZ ENDP ; std::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > >::_Unchecked
; Function compile flags: /Odtp /RTCsu
; File d:\program files (x86)\vs2010\vc\include\xutility
_TEXT	ENDS
;	COMDAT ??$_Iter_cat@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YA?AUrandom_access_iterator_tag@0@ABV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@@Z
_TEXT	SEGMENT
__Cat$ = -5						; size = 1
___$ReturnUdt$ = 8					; size = 4
___formal$ = 12						; size = 4
??$_Iter_cat@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YA?AUrandom_access_iterator_tag@0@ABV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@@Z PROC ; std::_Iter_cat<std::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > > >, COMDAT
...
$LN3@Iter_cat@3:
	...
	DB	116					; 00000074H
	DB	0
??$_Iter_cat@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YA?AUrandom_access_iterator_tag@0@ABV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@@Z ENDP ; std::_Iter_cat<std::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > > >
_TEXT	ENDS
...
PUBLIC	??$_Debug_pointer@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXAAV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@PB_WI@Z ; std::_Debug_pointer<std::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > > >
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__unwindtable$??$_Debug_range2@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@0PB_WIUrandom_access_iterator_tag@0@@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$??$_Debug_range2@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@0PB_WIUrandom_access_iterator_tag@0@@Z$0
	DD	00H
	DD	FLAT:__unwindfunclet$??$_Debug_range2@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@0PB_WIUrandom_access_iterator_tag@0@@Z$1
__ehfuncinfo$??$_Debug_range2@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@0PB_WIUrandom_access_iterator_tag@0@@Z DD 019930522H
	DD	02H
	DD	FLAT:__unwindtable$??$_Debug_range2@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@0PB_WIUrandom_access_iterator_tag@0@@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
; Function compile flags: /Odtp /RTCsu
xdata$x	ENDS
;	COMDAT ??$_Debug_range2@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@0PB_WIUrandom_access_iterator_tag@0@@Z
_TEXT	SEGMENT
__$EHRec$ = -12						; size = 12
__First$ = 8						; size = 12
__Last$ = 20						; size = 12
...
__Line$ = 36						; size = 4
___formal$ = 40						; size = 1
??$_Debug_range2@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@0PB_WIUrandom_access_iterator_tag@0@@Z PROC ; std::_Debug_range2<std::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > > >, COMDAT
...
; 714  : 	{	// test iterator pair for valid range, random-access iterators
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$??$_Debug_range2@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@0PB_WIUrandom_access_iterator_tag@0@@Z
	mov	eax, DWORD PTR fs:0
	push	eax
	mov	eax, DWORD PTR ___security_cookie
	xor	eax, ebp
...
; 717  : 		_DEBUG_POINTER2(_First, _File, _Line);
	...
	lea	ecx, DWORD PTR __First$[ebp]
	push	ecx
	call	??$_Debug_pointer@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXAAV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@PB_WI@Z ; std::_Debug_pointer<std::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > > >
	add	esp, 12					; 0000000cH
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$??$_Debug_range2@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@0PB_WIUrandom_access_iterator_tag@0@@Z$0:
	lea	ecx, DWORD PTR __Last$[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAE@XZ
__unwindfunclet$??$_Debug_range2@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@0PB_WIUrandom_access_iterator_tag@0@@Z$1:
	lea	ecx, DWORD PTR __First$[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAE@XZ
__ehhandler$??$_Debug_range2@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@0PB_WIUrandom_access_iterator_tag@0@@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-4]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$??$_Debug_range2@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@0PB_WIUrandom_access_iterator_tag@0@@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
??$_Debug_range2@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@0PB_WIUrandom_access_iterator_tag@0@@Z ENDP ; std::_Debug_range2<std::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > > >
; Function compile flags: /Odtp /RTCsu
...
PUBLIC	??_C@_1GA@OLNECLCF@?$AAD?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAV?$AAS?$AA2?$AA0?$AA1?$AA0?$AA?2?$AAV?$AAC@ ; `string'
;	COMDAT ??_C@_1GA@OLNECLCF@?$AAD?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAV?$AAS?$AA2?$AA0?$AA1?$AA0?$AA?2?$AAV?$AAC@
; File d:\program files (x86)\vs2010\vc\include\memory
CONST	SEGMENT
??_C@_1GA@OLNECLCF@?$AAD?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAV?$AAS?$AA2?$AA0?$AA1?$AA0?$AA?2?$AAV?$AAC@ DB 'D'
	DB	00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H, 'g', 00H
	DB	'r', 00H, 'a', 00H, 'm', 00H, ' ', 00H, 'F', 00H, 'i', 00H, 'l'
	DB	00H, 'e', 00H, 's', 00H, ' ', 00H, '(', 00H, 'x', 00H, '8', 00H
	DB	'6', 00H, ')', 00H, '\', 00H, 'V', 00H, 'S', 00H, '2', 00H, '0'
...
; 457  : 	_DEBUG_RANGE(_First, _Last);
	...
	push	457					; 000001c9H
	push	OFFSET ??_C@_1GA@OLNECLCF@?$AAD?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAV?$AAS?$AA2?$AA0?$AA1?$AA0?$AA?2?$AAV?$AAC@
	mov	eax, DWORD PTR __Last$[ebp]
	push	eax
	mov	ecx, DWORD PTR __First$[ebp]
	push	ecx
...
; File d:\program files (x86)\vs2010\vc\include\xutility
_TEXT	ENDS
;	COMDAT ??$_Debug_pointer@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXAAV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@PB_WI@Z
_TEXT	SEGMENT
___formal$ = 8						; size = 4
___formal$ = 12						; size = 4
___formal$ = 16						; size = 4
??$_Debug_pointer@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXAAV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@PB_WI@Z PROC ; std::_Debug_pointer<std::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > > >, COMDAT
...
; 685  : 	}
	...
	pop	ebp
	ret	0
??$_Debug_pointer@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@@std@@YAXAAV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@PB_WI@Z ENDP ; std::_Debug_pointer<std::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > > >
; Function compile flags: /Odtp /RTCsu
_TEXT	ENDS
