...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UGBW_HitBoxComponent_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UGBW_HitBoxComponent_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UGBW_HitBoxComponent()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UGBW_HitBoxComponent_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UGBW_HitBoxComponent, 3284829726);
	template<> GBWPOWERFULHIT_API UClass* StaticClass<UGBW_HitBoxComponent>()
	{
		return UGBW_HitBoxComponent::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UGBW_HitBoxComponent(Z_Construct_UClass_UGBW_HitBoxComponent, &UGBW_HitBoxComponent::StaticClass, TEXT("/Script/GBWPowerfulHit"), TEXT("UGBW_HitBoxComponent"), false, nullptr, nullptr, nullptr);
